...
deferred class GSL_VECTOR_EXTERNALS_32
feature {NONE} -- External calls
	gsl_vector_float_alloc (a_n: INTEGER): POINTER is
		external "C use <gsl/gsl_vector.h>"
		end

	gsl_vector_float_calloc (a_n: INTEGER): POINTER is
		external "C use <gsl/gsl_vector.h>"
		end

	gsl_vector_float_free (v: POINTER) is
		external "C use <gsl/gsl_vector.h>"
		end

	gsl_vector_float_get (v: POINTER; a_i: INTEGER): REAL_32 is
		external "C use <gsl/gsl_vector.h>"
		end

	gsl_vector_float_set (v: POINTER; a_i: INTEGER; x: REAL_32) is
		external "C use <gsl/gsl_vector.h>"
		end
