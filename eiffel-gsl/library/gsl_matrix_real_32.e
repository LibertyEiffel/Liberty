...
feature {NONE} -- External calls
	...
	gsl_matrix_alloc (a_n1, a_n2: INTEGER): POINTER is
		external "C use <gsl/gsl_matrix_float.h>"
		alias "gsl_matrix_float_alloc"
		end
	
	gsl_matrix_calloc (n1,n2: INTEGER): POINTER is
		external "C use <gsl/gsl_matrix_float.h>"
		alias "gsl_matrix_float_calloc"
		end
	
	gsl_matrix_free (a_gsl_matrix: POINTER) is
		external "C use <gsl/gsl_matrix_float.h>"
		alias "gsl_matrix_float_free"
		end

	gsl_matrix_get (a_gsl_matrix: POINTER; a_i, a_j: INTEGER): REAL_32 is
		external "C use <gsl/gsl_matrix_float.h>"
		alias "gsl_matrix_float_get"
		end

	gsl_matrix_set (a_gsl_matrix: POINTER; a_i, a_j: INTEGER; an_x: REAL_32) is
		external "C use <gsl/gsl_matrix_float.h>"
		alias "gsl_matrix_float_set"
		end

	gsl_matrix_ptr (a_gsl_matrix: POINTER; a_i, a_j: INTEGER): POINTER  is
		external "C use <gsl/gsl_matrix_float.h>"
		alias "gsl_matrix_float_ptr"
		end

	gsl_matrix_set_all (a_gsl_matrix: POINTER; an_x: REAL_32) is
		external "C use <gsl/gsl_matrix_float.h>"
		alias "gsl_matrix_float_set_all"
		end

	gsl_matrix_set_zero (a_gsl_matrix: POINTER)  is
		external "C use <gsl/gsl_matrix_float.h>"
		alias "gsl_matrix_float_set_zero"
		end

	gsl_matrix_set_identity (a_gsl_matrix: POINTER)  is
		external "C use <gsl/gsl_matrix_float.h>"
		alias "gsl_matrix_float_set_identity"
		end

	gsl_matrix_fwrite (a_stream, a_gsl_matrix: POINTER): INTEGER  is
		external "C use <gsl/gsl_matrix_float.h>"
		alias "gsl_matrix_float_fwrite"
		end

	gsl_matrix_fread (a_stream, a_gsl_matrix: POINTER): INTEGER  is
		external "C use <gsl/gsl_matrix_float.h>"
		alias "gsl_matrix_float_fread"
		end

	gsl_matrix_fprintf (a_stream, a_gsl_matrix, a_format: POINTER): INTEGER  is
		external "C use <gsl/gsl_matrix_float.h>"
		alias "gsl_matrix_float_fprintf"
		end
	
	gsl_matrix_fscanf (a_stream, a_gsl_matrix: POINTER): INTEGER  is
		external "C use <gsl/gsl_matrix_float.h>"
		alias "gsl_matrix_float_fscanf"
		end
...
feature {NONE} -- Accessing gsl_matrix struct
	...
	get_size1 (a_matrix: POINTER): INTEGER is
		external "C struct gsl_matrix_float get size1 use <gsl/gsl_matrix_float.h>"
		end

	get_size2 (a_matrix: POINTER): INTEGER is
		external "C struct gsl_matrix_float get size2 use <gsl/gsl_matrix_float.h>"
		end

	get_tda (a_matrix: POINTER): INTEGER is
		external "C struct gsl_matrix_float get  use <gsl/gsl_matrix_float.h>"
		end
