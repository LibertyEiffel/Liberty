...
inherit
	SHARED_C_STRUCT
		redefine
			from_external_pointer, dispose, store_eiffel_wrapper, unstore_eiffel_wrapper, is_eiffel_wrapper_stored
		end
...
feature {AV_FORMAT_CONTEXT} -- Disposing
		-- Don't use the shared wrapper dictionary, at all, please.
