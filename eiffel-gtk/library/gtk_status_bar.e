...
class GTK_STATUS_BAR
	...
	-- message. This context_id can be generated by `new_context_id',
	...
	-- message to display, the stack structure is adhered to,
...
feature -- Stack like behaviour
	...
	last_pushed: INTEGER
			-- Message id for the last message pushed on the stack

	pop (context_id: INTEGER) is
			-- Pop last message with current context id.
		do
