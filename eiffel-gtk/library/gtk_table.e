...
Details
 ...
 typedef struct _GtkTable GtkTable;
   ...
   default spacing and expansion details for the GtkTable's rows and columns,
   respectively.

   nrows and ncols are 16bit integers storing the number of rows and columns
   the table has.
 ...
 GtkWidget*  gtk_table_new                   (guint rows,
   ...
   can be changed later with gtk_table_resize(). rows and columns must both
 ...
 void        gtk_table_attach_defaults       (GtkTable *table,
   ...
   bottom_attach : The row number to attach the bottom of the child widget
                   to.
 ...
 void        gtk_table_set_row_spacings      (GtkTable *table,
   ...
   table :   a GtkTable.
   spacing : the number of pixels of space to place between every row in the
             table.
 ...
 void        gtk_table_set_col_spacings      (GtkTable *table,
   ...
   table :   a GtkTable.
   spacing : the number of pixels of space to place between every column in
             the table.
