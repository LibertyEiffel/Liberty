...
feature {}
   ...
   character_examples is
      ...
      do
         ...
         check -- The At-sign  (just in case you have a strange keyboard ;-)
            '@' = '%A'
         end
         ...
         check -- Circumflex (just in case you have a strange keyboard ;-)
            '^' = '%C'
         end

         check -- The dollar sign (just in case you have a strange keyboard ;-)
            '$' = '%D'
         end
         ...
         check -- The backslasH (just in case you have a strange keyboard ;-)
            '\' = '%H'
         end

         check -- The tiLda (just in case you have a strange keyboard ;-)
            '~' = '%L'
         end

         check -- The back Quote
            '`' = '%Q'
         end
         ...
         check -- The Sharp (just in case you have a strange keyboard ;-)
            '#' = '%S'
         end

         check -- The Vertical bar (just in case you have a strange keyboard ;-)
            '|' = '%V'
         end

         check -- The opening bracket (just in case you have a strange keyboard ;-)
            '[' = '%('
         end

         check -- The closing bracket (just in case you have a strange keyboard ;-)
            ']' = '%)'
         end

         check -- The opening brace (just in case you have a strange keyboard ;-)
            '{' = '%<'
         end

         check -- The closing brace (just in case you have a strange keyboard ;-)
            '}' = '%>'
         end
         ...
         character := '%/0/' -- is equivalent to '%U' (which is the default initialization value)
   ...
   ring_array_examples is
      local
         ring_array_of_character: RING_ARRAY[CHARACTER]
         ring_array_of_integer: RING_ARRAY[INTEGER]
      do
   ...
   set_examples is
      local
         set_of_character: SET[CHARACTER]
         set_of_integer: SET[INTEGER]
      do
   ...
   native_array_examples is
      local
         native_array_character: NATIVE_ARRAY[CHARACTER]
         native_array_integer_8: NATIVE_ARRAY[INTEGER_8]
      do
