...
feature {LIBERTY_INTERPRETER}
   new_array (type: like array_type; a_capacity: INTEGER; a_position: like position): LIBERTY_INTERPRETER_NATIVE_ARRAY
      do
         array_type := type
         capacity := a_capacity
         position := a_position
   ...
   from_external (type: like array_type; a_capacity: INTEGER; a_elements: POINTER; a_position: like position): LIBERTY_INTERPRETER_NATIVE_ARRAY
      do
         array_type := type
         capacity := a_capacity
         position := a_position
