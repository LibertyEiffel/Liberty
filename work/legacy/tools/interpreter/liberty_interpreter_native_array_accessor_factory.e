...
create {LIBERTY_INTERPRETER_NATIVE_ARRAY}
   make

feature {LIBERTY_INTERPRETER_NATIVE_ARRAY}
   accessor (a_interpreter: like interpreter; a_type: LIBERTY_ACTUAL_TYPE; a_position: like position): LIBERTY_INTERPRETER_NATIVE_ARRAY_ACCESSOR
      do
...
feature {} -- The retrievers
   retrieve_any (item: LIBERTY_INTERPRETER_OBJECT; a_position: like position): LIBERTY_INTERPRETER_OBJECT
      do
         Result := item
      end

   retrieve_pointer (item: POINTER; a_position: like position): LIBERTY_INTERPRETER_OBJECT
      do
   ...
   retrieve_integer_64 (item: INTEGER_64; a_position: like position): LIBERTY_INTERPRETER_OBJECT
      do
   ...
   retrieve_integer_32 (item: INTEGER_64; a_position: like position): LIBERTY_INTERPRETER_OBJECT
      do
   ...
   retrieve_integer_16 (item: INTEGER_64; a_position: like position): LIBERTY_INTERPRETER_OBJECT
      do
   ...
   retrieve_integer_8 (item: INTEGER_64; a_position: like position): LIBERTY_INTERPRETER_OBJECT
      do
   ...
   retrieve_real_64 (item: REAL_128; a_position: like position): LIBERTY_INTERPRETER_OBJECT
      do
   ...
   retrieve_real_32 (item: REAL_128; a_position: like position): LIBERTY_INTERPRETER_OBJECT
      do
   ...
   retrieve_real_80 (item: REAL_128; a_position: like position): LIBERTY_INTERPRETER_OBJECT
      do
   ...
   retrieve_real_128 (item: REAL_128; a_position: like position): LIBERTY_INTERPRETER_OBJECT
      do
   ...
   retrieve_character (item: CHARACTER; a_position: like position): LIBERTY_INTERPRETER_OBJECT
      do
   ...
   retrieve_boolean (item: BOOLEAN; a_position: like position): LIBERTY_INTERPRETER_OBJECT
      do
         create {LIBERTY_INTERPRETER_OBJECT_BOOLEAN} Result.with_item(interpreter, interpreter.universe.type_boolean, item, a_position)
      end

   retrieve_tuple (item: LIBERTY_INTERPRETER_OBJECT; a_position: like position): LIBERTY_INTERPRETER_OBJECT
      do
         Result := item
      end

   retrieve_routine (item: LIBERTY_INTERPRETER_AGENT; a_position: like position): LIBERTY_INTERPRETER_OBJECT
      do
         Result := item
      end

   retrieve_procedure (item: LIBERTY_INTERPRETER_AGENT; a_position: like position): LIBERTY_INTERPRETER_OBJECT
      do
         Result := item
      end

   retrieve_function (item: LIBERTY_INTERPRETER_AGENT; a_position: like position): LIBERTY_INTERPRETER_OBJECT
      do
         Result := item
      end

   retrieve_predicate (item: LIBERTY_INTERPRETER_AGENT; a_position: like position): LIBERTY_INTERPRETER_OBJECT
      do
         Result := item
      end

   retrieve_user_type (item: LIBERTY_INTERPRETER_OBJECT; a_type: LIBERTY_ACTUAL_TYPE; a_position: like position): LIBERTY_INTERPRETER_OBJECT
      do
         Result := item
         if Result = Void then
...
feature {} -- The storers
   store_any (item: LIBERTY_INTERPRETER_OBJECT): LIBERTY_INTERPRETER_OBJECT
      do
         Result := item
      end

   store_pointer (item: LIBERTY_INTERPRETER_OBJECT): POINTER
      local
   ...
   store_integer_64 (item: LIBERTY_INTERPRETER_OBJECT): INTEGER_64
      local
   ...
   store_integer_32 (item: LIBERTY_INTERPRETER_OBJECT): INTEGER_64
      local
         o: LIBERTY_INTERPRETER_OBJECT_HASHABLE[INTEGER_64]
      do
         o ::= item
   ...
   store_integer_16 (item: LIBERTY_INTERPRETER_OBJECT): INTEGER_64
      local
         o: LIBERTY_INTERPRETER_OBJECT_HASHABLE[INTEGER_64]
      do
         o ::= item
   ...
   store_integer_8 (item: LIBERTY_INTERPRETER_OBJECT): INTEGER_64
      local
         o: LIBERTY_INTERPRETER_OBJECT_HASHABLE[INTEGER_64]
      do
         o ::= item
   ...
   store_real_64 (item: LIBERTY_INTERPRETER_OBJECT): REAL_128
      local
   ...
   store_real_32 (item: LIBERTY_INTERPRETER_OBJECT): REAL_128
      local
         o: LIBERTY_INTERPRETER_OBJECT_HASHABLE[REAL_128]
      do
         o ::= item
   ...
   store_real_80 (item: LIBERTY_INTERPRETER_OBJECT): REAL_128
      local
         o: LIBERTY_INTERPRETER_OBJECT_HASHABLE[REAL_128]
      do
         o ::= item
   ...
   store_real_128 (item: LIBERTY_INTERPRETER_OBJECT): REAL_128
      local
         o: LIBERTY_INTERPRETER_OBJECT_HASHABLE[REAL_128]
      do
         o ::= item
   ...
   store_character (item: LIBERTY_INTERPRETER_OBJECT): CHARACTER
      local
   ...
   store_boolean (item: LIBERTY_INTERPRETER_OBJECT): BOOLEAN
      local
   ...
   store_tuple (item: LIBERTY_INTERPRETER_OBJECT): LIBERTY_INTERPRETER_OBJECT
      do
         Result := item
      end

   store_routine (item: LIBERTY_INTERPRETER_OBJECT): LIBERTY_INTERPRETER_AGENT
      do
         Result ::= item
      end

   store_procedure (item: LIBERTY_INTERPRETER_OBJECT): LIBERTY_INTERPRETER_AGENT
      do
         Result ::= item
      end

   store_function (item: LIBERTY_INTERPRETER_OBJECT): LIBERTY_INTERPRETER_AGENT
      do
         Result ::= item
      end

   store_predicate (item: LIBERTY_INTERPRETER_OBJECT): LIBERTY_INTERPRETER_AGENT
      do
         Result ::= item
      end

   store_user_type (item: LIBERTY_INTERPRETER_OBJECT): LIBERTY_INTERPRETER_OBJECT
      do
         Result := item
      end
