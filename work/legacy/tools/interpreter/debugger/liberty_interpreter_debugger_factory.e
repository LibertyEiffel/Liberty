...
feature {}
   action_entry: PROCEDURE[TUPLE[LIBERTY_INTERPRETER_DEBUGGER_VISITOR, LIBERTY_INTERPRETER_DEBUGGER_NON_TERMINAL_NODE]]
      once
         Result := agent {LIBERTY_INTERPRETER_DEBUGGER_VISITOR}.visit_entry
      end

   action_show: PROCEDURE[TUPLE[LIBERTY_INTERPRETER_DEBUGGER_VISITOR, LIBERTY_INTERPRETER_DEBUGGER_NON_TERMINAL_NODE]]
      once
         Result := agent {LIBERTY_INTERPRETER_DEBUGGER_VISITOR}.visit_show
      end

   action_step: PROCEDURE[TUPLE[LIBERTY_INTERPRETER_DEBUGGER_VISITOR, LIBERTY_INTERPRETER_DEBUGGER_NON_TERMINAL_NODE]]
      once
         Result := agent {LIBERTY_INTERPRETER_DEBUGGER_VISITOR}.visit_step
      end

   action_up: PROCEDURE[TUPLE[LIBERTY_INTERPRETER_DEBUGGER_VISITOR, LIBERTY_INTERPRETER_DEBUGGER_NON_TERMINAL_NODE]]
      once
         Result := agent {LIBERTY_INTERPRETER_DEBUGGER_VISITOR}.visit_up
      end

   action_down: PROCEDURE[TUPLE[LIBERTY_INTERPRETER_DEBUGGER_VISITOR, LIBERTY_INTERPRETER_DEBUGGER_NON_TERMINAL_NODE]]
      once
