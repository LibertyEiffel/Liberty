...
T0* se_manifest_args1063(T0*c,int i0,int argc,...){
/*ARRAY[ARRAY[INTEGER_8]]*/
T1063*C=(T1063*)c;
va_list pa;
int i=i0;
...
T0* se_manifest922(T2 initial_lower,int argc){
/*ARRAY[TYPE_MARK]*/
T922*C;
C=se_malloc(sizeof(T922/*niiii*/));
*C=M922;
r922manifest_make(C,argc,initial_lower);
return ((T0*)C);
}/*--*/

T0* se_manifest_args922(T0*c,int i0,int argc,...){
/*ARRAY[TYPE_MARK]*/
T922*C=(T922*)c;
va_list pa;
int i=i0;
...
while (i < imax) {
T0* element=((T0*)(va_arg(pa,T0*)));
r922manifest_put(C,i++,element);
}
va_end(pa);
return c;
}/*--*/

T0* se_manifest983(T2 initial_lower,int argc){
/*ARRAY[DECLARATION]*/
T983*C;
C=se_malloc(sizeof(T983/*niiii*/));
*C=M983;
r983manifest_make(C,argc,initial_lower);
return ((T0*)C);
}/*--*/

T0* se_manifest_args983(T0*c,int i0,int argc,...){
/*ARRAY[DECLARATION]*/
T983*C=(T983*)c;
va_list pa;
int i=i0;
...
/*FAST_ARRAY[CODE]*/
T1051*C;
C=se_malloc(sizeof(T1051/*niii*/));
*C=M1051;
r1051manifest_make(C,argc);
return ((T0*)C);
}/*--*/

T0* se_manifest_args1051(T0*c,int i0,int argc,...){
/*FAST_ARRAY[CODE]*/
T1051*C=(T1051*)c;
va_list pa;
int i=i0;
...
T0* se_manifest908(int argc){
/*FAST_ARRAY[STRING]*/
T908*C;
C=se_malloc(sizeof(T908/*Tniii*/));
*C=M908;
r908manifest_make(C,argc);
return ((T0*)C);
}/*--*/

T0* se_manifest_args908(T0*c,int i0,int argc,...){
/*FAST_ARRAY[STRING]*/
T908*C=(T908*)c;
va_list pa;
int i=i0;
...
while (i < imax) {
T0* element=((T0*)(va_arg(pa,T0*)));
r908manifest_put(C,i++,element);
}
va_end(pa);
return c;
}/*--*/

T0* se_manifest1360(int argc){
/*FAST_ARRAY[POINTER]*/
T1360*C;
C=se_malloc(sizeof(T1360/*niii*/));
*C=M1360;
r1360manifest_make(C,argc);
return ((T0*)C);
}/*--*/

T0* se_manifest_args1360(T0*c,int i0,int argc,...){
/*FAST_ARRAY[POINTER]*/
T1360*C=(T1360*)c;
va_list pa;
int i=i0;
...
T0* se_manifest930(int argc){
/*HASHED_SET[HASHED_STRING]*/
T930*C;
C=se_malloc(sizeof(T930/*pniiii*/));
*C=M930;
r930manifest_make(C,argc);
return ((T0*)C);
}/*--*/

T0* se_manifest_args930(T0*c,int i0,int argc,...){
/*HASHED_SET[HASHED_STRING]*/
T930*C=(T930*)c;
va_list pa;
int i=i0;
...
/*HASHED_SET[STRING]*/
T1035*C;
C=se_malloc(sizeof(T1035/*pniiii*/));
*C=M1035;
r1035manifest_make(C,argc);
return ((T0*)C);
}/*--*/

T0* se_manifest_args1035(T0*c,int i0,int argc,...){
/*HASHED_SET[STRING]*/
T1035*C=(T1035*)c;
va_list pa;
int i=i0;
