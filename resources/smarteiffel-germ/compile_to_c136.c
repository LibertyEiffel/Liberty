...
T0* se_manifest921(T2 initial_lower,int argc){
/*ARRAY[TYPE_MARK]*/
T921*C;
C=se_malloc(sizeof(T921/*niiii*/));
*C=M921;
r921manifest_make(C,argc,initial_lower);
return ((T0*)C);
}/*--*/

T0* se_manifest_args921(T0*c,int i,int argc,...){
/*ARRAY[TYPE_MARK]*/
T921*C=(T921*)c;
va_list pa;
int imax;
...
while (i < imax) {
T0* element=((T0*)(va_arg(pa,T0*)));
r921manifest_put(C,i++,element);
}
va_end(pa);
return c;
}/*--*/

T0* se_manifest982(T2 initial_lower,int argc){
/*ARRAY[DECLARATION]*/
T982*C;
C=se_malloc(sizeof(T982/*niiii*/));
*C=M982;
r982manifest_make(C,argc,initial_lower);
return ((T0*)C);
}/*--*/

T0* se_manifest_args982(T0*c,int i,int argc,...){
/*ARRAY[DECLARATION]*/
T982*C=(T982*)c;
va_list pa;
int imax;
...
/*FAST_ARRAY[CODE]*/
T1050*C;
C=se_malloc(sizeof(T1050/*niii*/));
*C=M1050;
r1050manifest_make(C,argc);
return ((T0*)C);
}/*--*/

T0* se_manifest_args1050(T0*c,int i,int argc,...){
/*FAST_ARRAY[CODE]*/
T1050*C=(T1050*)c;
va_list pa;
int imax;
...
/*HASHED_SET[STRING]*/
T1034*C;
C=se_malloc(sizeof(T1034/*pniiii*/));
*C=M1034;
r1034manifest_make(C,argc);
return ((T0*)C);
}/*--*/

T0* se_manifest_args1034(T0*c,int i,int argc,...){
/*HASHED_SET[STRING]*/
T1034*C=(T1034*)c;
va_list pa;
int imax;
...
int can_assign_to825_from704(T0* expression){
/* LOADPATH ?:= CLASSES */
if (expression == NULL) return 1;
switch (expression->id) {
