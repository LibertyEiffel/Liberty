...
/*C_PLUGIN_FACTORY*/T1016*create1016(void){
/*[INTERNAL_C_LOCAL list*/
T0* tmp0;
/*INTERNAL_C_LOCAL list]*/
tmp0/*new*/=/*alloc*/((T0*)(se_malloc(1)));
return ((T1016*)tmp0/*new*/);
/*tmp0.unlock*/
}/*--*/

/*C_PLUGIN_FACTORY*/T0*r1016new(T351 a1,T0*a2,T0*a3){
/*[INTERNAL_C_LOCAL list*/
T0* tmp0;
/*INTERNAL_C_LOCAL list]*/
T0* R=(void*)0;
tmp0/*new*/=/*alloc*/((T0*)(se_malloc(sizeof(T1017/*10pipppp2pi*/))));
*((T1017*)tmp0/*new*/)=M1017;
r351default_create(&(((T1017*)tmp0/*new*/)->_start_position));
/*RF3:make*/r1017make(((T1017*)tmp0/*new*/),/*`position'*/a1,/*`a_name'*/a2,/*`a_path'*/a3);
/*:RF3*/R=tmp0/*new*/;
/*tmp0.unlock*/
return R;
}/*--*/
