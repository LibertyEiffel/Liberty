...
/*C_PLUGIN_FACTORY*/T902*create902(void){
/*[INTERNAL_C_LOCAL list*/
T0* tmp0;
/*INTERNAL_C_LOCAL list]*/
tmp0/*new*/=/*alloc*/((T0*)(se_malloc(1)));
return ((T902*)tmp0/*new*/);
/*tmp0.unlock*/
}/*--*/

/*C_PLUGIN_FACTORY*/T0*r902new(T351 a1,T0*a2,T0*a3){
/*[INTERNAL_C_LOCAL list*/
T0* tmp0;
/*INTERNAL_C_LOCAL list]*/
T0* R=(void*)0;
tmp0/*new*/=/*alloc*/((T0*)(se_malloc(sizeof(T903/*10pipppp2pi*/))));
*((T903*)tmp0/*new*/)=M903;
r351default_create(&(((T903*)tmp0/*new*/)->_start_position));
/*RF3:make*/r903make(((T903*)tmp0/*new*/),/*`position'*/a1,/*`a_name'*/a2,/*`a_path'*/a3);
/*:RF3*/R=tmp0/*new*/;
/*tmp0.unlock*/
return R;
}/*--*/
