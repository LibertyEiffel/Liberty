...
T0* se_manifest980(T2 initial_lower,int argc){
/*ARRAY[DECLARATION]*/
T980*C;
C=se_malloc(sizeof(T980/*niiii*/));
*C=M980;
r980manifest_make(C,argc,initial_lower);
return ((T0*)C);
}/*--*/

T0* se_manifest_args980(T0*c,int i0,int argc,...){
/*ARRAY[DECLARATION]*/
T980*C=(T980*)c;
va_list pa;
int i=i0;
