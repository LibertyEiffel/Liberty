...
T0* se_manifest1173(T2 initial_lower,int argc,...){
...
int imax;
va_start(pa,argc);
C=se_malloc(sizeof(T1173));
*C=M1173;
r1173manifest_make(C,argc,initial_lower);
imax=argc;
while (i < imax) {
T0* element=((T0*)(va_arg(pa,T0*)));
r1173manifest_put(C,i++,element);
}
va_end(pa);
return ((T0*)C);
}/*--*/

T0* se_manifest1037(T2 initial_lower,int argc,...){
/*ARRAY[TYPE_MARK]*/
T1037*C;
va_list pa;
int i=0;
int imax;
va_start(pa,argc);
C=se_malloc(sizeof(T1037));
*C=M1037;
r1037manifest_make(C,argc,initial_lower);
imax=argc;
while (i < imax) {
T0* element=((T0*)(va_arg(pa,T0*)));
r1037manifest_put(C,i++,element);
}
va_end(pa);
return ((T0*)C);
}/*--*/

T0* se_manifest1094(T2 initial_lower,int argc,...){
/*ARRAY[DECLARATION]*/
T1094*C;
va_list pa;
int i=0;
int imax;
va_start(pa,argc);
C=se_malloc(sizeof(T1094));
*C=M1094;
r1094manifest_make(C,argc,initial_lower);
imax=argc;
while (i < imax) {
T0* element=((T0*)(va_arg(pa,T0*)));
r1094manifest_put(C,i++,element);
}
va_end(pa);
return ((T0*)C);
}/*--*/

T0* se_manifest1024(int argc,...){
/*FAST_ARRAY[STRING]*/
T1024*C;
va_list pa;
int i=0;
int imax;
va_start(pa,argc);
C=se_malloc(sizeof(T1024));
*C=M1024;
r1024manifest_make(C,argc);
imax=argc;
while (i < imax) {
T0* element=((T0*)(va_arg(pa,T0*)));
r1024manifest_put(C,i++,element);
}
va_end(pa);
return ((T0*)C);
}/*--*/

T0* se_manifest1475(int argc,...){
/*FAST_ARRAY[POINTER]*/
T1475*C;
va_list pa;
int i=0;
int imax;
va_start(pa,argc);
C=se_malloc(sizeof(T1475));
*C=M1475;
r1475manifest_make(C,argc);
imax=argc;
while (i < imax) {
T8 element=((T8)(va_arg(pa,T8)));
r1475manifest_put(C,i++,element);
}
va_end(pa);
return ((T0*)C);
}/*--*/
...
int imax;
va_start(pa,argc);
C=se_malloc(sizeof(T1046));
*C=M1046;
r1046manifest_make(C,argc);
imax=argc;
while (i < imax) {
T0* element=((T0*)(va_arg(pa,T0*)));
r1046manifest_put(C,i++,element);
}
va_end(pa);
return ((T0*)C);
}/*--*/
...
int can_assign_to805_from690(T0* expression){
/* LOADPATH ?:= CLASSES */
if (expression == NULL) return 1;
switch (expression->id) {
case 805/*LOADPATH*/: return 1;
}
return 0;
}/*--*/
