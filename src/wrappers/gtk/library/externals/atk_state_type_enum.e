...
feature -- Queries
	...
	is_manages_descendants: BOOLEAN is
		do
	...
	is_invalid_entry: BOOLEAN is
		do
			Result := (value=invalid_entry_low_level)
		end

	is_supports_autocompletion: BOOLEAN is
		do
			Result := (value=supports_autocompletion_low_level)
		end

	is_selectable_text: BOOLEAN is
		do
