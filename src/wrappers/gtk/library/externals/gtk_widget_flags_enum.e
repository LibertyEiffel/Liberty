...
feature -- Setters
	...
	set_no_reparent is
		do
			value := value.bit_or(no_reparent_low_level)
		end

	unset_no_reparent is
		do
			value := value.bit_xor(no_reparent_low_level)
		end
...
feature -- Queries
	...
	is_no_reparent: BOOLEAN is
		do
			Result := (value=no_reparent_low_level)
		end
...
feature {WRAPPER, WRAPPER_HANDLER} -- Low level values
	...
	no_reparent_low_level: INTEGER is
		external "plug_in"
 		alias "{
 			location: "."
 			module: "plugin"
 			feature_name: "GTK_NO_REPARENT"
 			}"
 		end
