...
feature -- Queries
	is_logical_positions: BOOLEAN is
		do
			Result := (value=logical_positions_low_level)
		end

	is_visual_positions: BOOLEAN is
		do
	...
	is_display_lines: BOOLEAN is
		do
			Result := (value=display_lines_low_level)
		end

	is_display_line_ends: BOOLEAN is
		do
			Result := (value=display_line_ends_low_level)
		end

	is_paragraphs: BOOLEAN is
		do
			Result := (value=paragraphs_low_level)
		end

	is_paragraph_ends: BOOLEAN is
		do
	...
	is_buffer_ends: BOOLEAN is
		do
			Result := (value=buffer_ends_low_level)
		end

	is_horizontal_pages: BOOLEAN is
		do
