...
feature {} -- External calls
	...
	gtk_text_buffer_get_char_count (a_buffer: POINTER): INTEGER_32 is
 		-- gtk_text_buffer_get_char_count (node at line 164)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_get_text (a_buffer: POINTER; a_start: POINTER; an_end_external: POINTER; an_include_hidden_chars: INTEGER_32): POINTER is
 		-- gtk_text_buffer_get_text (node at line 1155)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_delete_mark (a_buffer: POINTER; a_mark: POINTER) is
 		-- gtk_text_buffer_delete_mark (node at line 1310)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_create_mark (a_buffer: POINTER; a_mark_name: POINTER; a_where: POINTER; a_left_gravity: INTEGER_32): POINTER is
 		-- gtk_text_buffer_create_mark (node at line 1322)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_insert_child_anchor (a_buffer: POINTER; an_iter: POINTER; an_anchor: POINTER) is
 		-- gtk_text_buffer_insert_child_anchor (node at line 2813)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_insert (a_buffer: POINTER; an_iter: POINTER; a_text: POINTER; a_len: INTEGER_32) is
 		-- gtk_text_buffer_insert (node at line 3469)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_get_iter_at_line_offset (a_buffer: POINTER; an_iter: POINTER; a_line_number: INTEGER_32; a_char_offset: INTEGER_32) is
 		-- gtk_text_buffer_get_iter_at_line_offset (node at line 3581)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_begin_user_action (a_buffer: POINTER) is
 		-- gtk_text_buffer_begin_user_action (node at line 5636)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_get_selection_bounds (a_buffer: POINTER; a_start: POINTER; an_end_external: POINTER): INTEGER_32 is
 		-- gtk_text_buffer_get_selection_bounds (node at line 7082)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_get_mark (a_buffer: POINTER; a_name: POINTER): POINTER is
 		-- gtk_text_buffer_get_mark (node at line 7587)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_get_copy_target_list (a_buffer: POINTER): POINTER is
 		-- gtk_text_buffer_get_copy_target_list (node at line 7852)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_remove_tag (a_buffer: POINTER; a_tag: POINTER; a_start: POINTER; an_end_external: POINTER) is
 		-- gtk_text_buffer_remove_tag (node at line 8737)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_delete (a_buffer: POINTER; a_start: POINTER; an_end_external: POINTER) is
 		-- gtk_text_buffer_delete (node at line 10401)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_get_iter_at_child_anchor (a_buffer: POINTER; an_iter: POINTER; an_anchor: POINTER) is
 		-- gtk_text_buffer_get_iter_at_child_anchor (node at line 10595)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_create_tag (a_buffer: POINTER; a_tag_name: POINTER; a_first_property_name: POINTER): POINTER is
 		-- gtk_text_buffer_create_tag (variadic call)  (node at line 10622)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_end_user_action (a_buffer: POINTER) is
 		-- gtk_text_buffer_end_user_action (node at line 11710)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_apply_tag (a_buffer: POINTER; a_tag: POINTER; a_start: POINTER; an_end_external: POINTER) is
 		-- gtk_text_buffer_apply_tag (node at line 11767)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_move_mark (a_buffer: POINTER; a_mark: POINTER; a_where: POINTER) is
 		-- gtk_text_buffer_move_mark (node at line 13156)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_insert_at_cursor (a_buffer: POINTER; a_text: POINTER; a_len: INTEGER_32) is
 		-- gtk_text_buffer_insert_at_cursor (node at line 13211)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_insert_with_tags_by_name (a_buffer: POINTER; an_iter: POINTER; a_text: POINTER; a_len: INTEGER_32; a_first_tag_name: POINTER) is
 		-- gtk_text_buffer_insert_with_tags_by_name (variadic call)  (node at line 13628)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_get_slice (a_buffer: POINTER; a_start: POINTER; an_end_external: POINTER; an_include_hidden_chars: INTEGER_32): POINTER is
 		-- gtk_text_buffer_get_slice (node at line 14206)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_new (a_table: POINTER): POINTER is
 		-- gtk_text_buffer_new (node at line 14583)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_get_has_selection (a_buffer: POINTER): INTEGER_32 is
 		-- gtk_text_buffer_get_has_selection (node at line 14777)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_delete_interactive (a_buffer: POINTER; a_start_iter: POINTER; an_end_iter: POINTER; a_default_editable: INTEGER_32): INTEGER_32 is
 		-- gtk_text_buffer_delete_interactive (node at line 15542)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_insert_pixbuf (a_buffer: POINTER; an_iter: POINTER; a_pixbuf: POINTER) is
 		-- gtk_text_buffer_insert_pixbuf (node at line 17272)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_select_range (a_buffer: POINTER; an_ins: POINTER; a_bound: POINTER) is
 		-- gtk_text_buffer_select_range (node at line 17797)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_move_mark_by_name (a_buffer: POINTER; a_name: POINTER; a_where: POINTER) is
 		-- gtk_text_buffer_move_mark_by_name (node at line 18439)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_remove_all_tags (a_buffer: POINTER; a_start: POINTER; an_end_external: POINTER) is
 		-- gtk_text_buffer_remove_all_tags (node at line 18468)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_insert_interactive (a_buffer: POINTER; an_iter: POINTER; a_text: POINTER; a_len: INTEGER_32; a_default_editable: INTEGER_32): INTEGER_32 is
 		-- gtk_text_buffer_insert_interactive (node at line 18473)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_get_paste_target_list (a_buffer: POINTER): POINTER is
 		-- gtk_text_buffer_get_paste_target_list (node at line 18784)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_set_text (a_buffer: POINTER; a_text: POINTER; a_len: INTEGER_32) is
 		-- gtk_text_buffer_set_text (node at line 19016)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_remove_selection_clipboard (a_buffer: POINTER; a_clipboard: POINTER) is
 		-- gtk_text_buffer_remove_selection_clipboard (node at line 21202)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_get_iter_at_line_index (a_buffer: POINTER; an_iter: POINTER; a_line_number: INTEGER_32; a_byte_index: INTEGER_32) is
 		-- gtk_text_buffer_get_iter_at_line_index (node at line 21260)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_delete_selection (a_buffer: POINTER; an_interactive: INTEGER_32; a_default_editable: INTEGER_32): INTEGER_32 is
 		-- gtk_text_buffer_delete_selection (node at line 21841)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_get_end_iter (a_buffer: POINTER; an_iter: POINTER) is
 		-- gtk_text_buffer_get_end_iter (node at line 23157)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_get_insert (a_buffer: POINTER): POINTER is
 		-- gtk_text_buffer_get_insert (node at line 23726)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_backspace (a_buffer: POINTER; an_iter: POINTER; an_interactive: INTEGER_32; a_default_editable: INTEGER_32): INTEGER_32 is
 		-- gtk_text_buffer_backspace (node at line 23979)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_cut_clipboard (a_buffer: POINTER; a_clipboard: POINTER; a_default_editable: INTEGER_32) is
 		-- gtk_text_buffer_cut_clipboard (node at line 24562)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_paste_clipboard (a_buffer: POINTER; a_clipboard: POINTER; an_override_location: POINTER; a_default_editable: INTEGER_32) is
 		-- gtk_text_buffer_paste_clipboard (node at line 24594)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_insert_range_interactive (a_buffer: POINTER; an_iter: POINTER; a_start: POINTER; an_end_external: POINTER; a_default_editable: INTEGER_32): INTEGER_32 is
 		-- gtk_text_buffer_insert_range_interactive (node at line 25857)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_remove_tag_by_name (a_buffer: POINTER; a_name: POINTER; a_start: POINTER; an_end_external: POINTER) is
 		-- gtk_text_buffer_remove_tag_by_name (node at line 26027)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_apply_tag_by_name (a_buffer: POINTER; a_name: POINTER; a_start: POINTER; an_end_external: POINTER) is
 		-- gtk_text_buffer_apply_tag_by_name (node at line 26080)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_get_tag_table (a_buffer: POINTER): POINTER is
 		-- gtk_text_buffer_get_tag_table (node at line 27157)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_delete_mark_by_name (a_buffer: POINTER; a_name: POINTER) is
 		-- gtk_text_buffer_delete_mark_by_name (node at line 27161)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_insert_interactive_at_cursor (a_buffer: POINTER; a_text: POINTER; a_len: INTEGER_32; a_default_editable: INTEGER_32): INTEGER_32 is
 		-- gtk_text_buffer_insert_interactive_at_cursor (node at line 28793)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_add_mark (a_buffer: POINTER; a_mark: POINTER; a_where: POINTER) is
 		-- gtk_text_buffer_add_mark (node at line 29108)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_add_selection_clipboard (a_buffer: POINTER; a_clipboard: POINTER) is
 		-- gtk_text_buffer_add_selection_clipboard (node at line 30443)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_insert_range (a_buffer: POINTER; an_iter: POINTER; a_start: POINTER; an_end_external: POINTER) is
 		-- gtk_text_buffer_insert_range (node at line 31855)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_insert_with_tags (a_buffer: POINTER; an_iter: POINTER; a_text: POINTER; a_len: INTEGER_32; a_first_tag: POINTER) is
 		-- gtk_text_buffer_insert_with_tags (variadic call)  (node at line 32165)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_get_selection_bound (a_buffer: POINTER): POINTER is
 		-- gtk_text_buffer_get_selection_bound (node at line 32925)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_set_modified (a_buffer: POINTER; a_setting: INTEGER_32) is
 		-- gtk_text_buffer_set_modified (node at line 33187)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_copy_clipboard (a_buffer: POINTER; a_clipboard: POINTER) is
 		-- gtk_text_buffer_copy_clipboard (node at line 33316)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_get_iter_at_line (a_buffer: POINTER; an_iter: POINTER; a_line_number: INTEGER_32) is
 		-- gtk_text_buffer_get_iter_at_line (node at line 33795)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_get_modified (a_buffer: POINTER): INTEGER_32 is
 		-- gtk_text_buffer_get_modified (node at line 34188)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_get_iter_at_offset (a_buffer: POINTER; an_iter: POINTER; a_char_offset: INTEGER_32) is
 		-- gtk_text_buffer_get_iter_at_offset (node at line 34216)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_get_start_iter (a_buffer: POINTER; an_iter: POINTER) is
 		-- gtk_text_buffer_get_start_iter (node at line 34283)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_get_iter_at_mark (a_buffer: POINTER; an_iter: POINTER; a_mark: POINTER) is
 		-- gtk_text_buffer_get_iter_at_mark (node at line 35301)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_get_line_count (a_buffer: POINTER): INTEGER_32 is
 		-- gtk_text_buffer_get_line_count (node at line 35676)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_get_bounds (a_buffer: POINTER; a_start: POINTER; an_end_external: POINTER) is
 		-- gtk_text_buffer_get_bounds (node at line 36169)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_place_cursor (a_buffer: POINTER; a_where: POINTER) is
 		-- gtk_text_buffer_place_cursor (node at line 36607)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_get_type: NATURAL_32 is
 		-- gtk_text_buffer_get_type (node at line 37164)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_text_buffer_create_child_anchor (a_buffer: POINTER; an_iter: POINTER): POINTER is
 		-- gtk_text_buffer_create_child_anchor (node at line 37574)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
