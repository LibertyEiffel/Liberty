...
feature {} -- Low-level setters
	...
	gtk_toolbar_struct_set_num_children (a_structure: POINTER; a_value: INTEGER_32) is
	...
	gtk_toolbar_struct_set_tooltips (a_structure: POINTER; a_value: POINTER) is
			-- Setter for tooltips field of GTK_TOOLBAR_STRUCT structure.
			-- TODO: setter description
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "gtk_toolbar_struct_set_tooltips"
		}"
		end

	gtk_toolbar_struct_set_button_maxw (a_structure: POINTER; a_value: INTEGER_32) is
	...
	gtk_toolbar_struct_set_button_maxh (a_structure: POINTER; a_value: INTEGER_32) is
	...
	gtk_toolbar_struct_set_style_set (a_structure: POINTER; a_value: NATURAL_32) is
	...
	gtk_toolbar_struct_set_icon_size_set (a_structure: POINTER; a_value: NATURAL_32) is
...
feature {} -- Low-level queries
	...
	gtk_toolbar_struct_get_num_children (a_structure: POINTER): INTEGER_32 is
	...
	gtk_toolbar_struct_get_tooltips (a_structure: POINTER): POINTER is
			-- Query for tooltips field of GTK_TOOLBAR_STRUCT structure.
			-- TODO: getter description
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "gtk_toolbar_struct_get_tooltips"
		}"
		end

	gtk_toolbar_struct_get_button_maxw (a_structure: POINTER): INTEGER_32 is
	...
	gtk_toolbar_struct_get_button_maxh (a_structure: POINTER): INTEGER_32 is
	...
	gtk_toolbar_struct_get_style_set (a_structure: POINTER): NATURAL_32 is
	...
	gtk_toolbar_struct_get_icon_size_set (a_structure: POINTER): NATURAL_32 is
