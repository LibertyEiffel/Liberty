...
feature {} -- External calls
	...
	gtk_radio_menu_item_new_with_mnemonic (a_group: POINTER; a_label: POINTER): POINTER is
 		-- gtk_radio_menu_item_new_with_mnemonic (node at line 3332)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_radio_menu_item_get_group (a_radio_menu_item: POINTER): POINTER is
 		-- gtk_radio_menu_item_get_group (node at line 4792)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_radio_menu_item_new_from_widget (a_group: POINTER): POINTER is
 		-- gtk_radio_menu_item_new_from_widget (node at line 9104)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_radio_menu_item_set_group (a_radio_menu_item: POINTER; a_group: POINTER) is
 		-- gtk_radio_menu_item_set_group (node at line 14050)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_radio_menu_item_new_with_label_from_widget (a_group: POINTER; a_label: POINTER): POINTER is
 		-- gtk_radio_menu_item_new_with_label_from_widget (node at line 15499)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_radio_menu_item_new_with_label (a_group: POINTER; a_label: POINTER): POINTER is
 		-- gtk_radio_menu_item_new_with_label (node at line 26271)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_radio_menu_item_new (a_group: POINTER): POINTER is
 		-- gtk_radio_menu_item_new (node at line 27305)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_radio_menu_item_new_with_mnemonic_from_widget (a_group: POINTER; a_label: POINTER): POINTER is
 		-- gtk_radio_menu_item_new_with_mnemonic_from_widget (node at line 31426)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_radio_menu_item_get_type: NATURAL_32 is
 		-- gtk_radio_menu_item_get_type (node at line 33381)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
