...
feature {} -- External calls
	...
	gtk_handle_box_get_type: NATURAL_32 is
 		-- gtk_handle_box_get_type (node at line 698)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_handle_box_get_handle_position (a_handle_box: POINTER): INTEGER is
 		-- gtk_handle_box_get_handle_position (node at line 8233)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_handle_box_get_shadow_type (a_handle_box: POINTER): INTEGER is
 		-- gtk_handle_box_get_shadow_type (node at line 10051)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_handle_box_new: POINTER is
 		-- gtk_handle_box_new (node at line 11164)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_handle_box_get_child_detached (a_handle_box: POINTER): INTEGER_32 is
 		-- gtk_handle_box_get_child_detached (node at line 16931)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_handle_box_get_snap_edge (a_handle_box: POINTER): INTEGER is
 		-- gtk_handle_box_get_snap_edge (node at line 18938)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_handle_box_set_snap_edge (a_handle_box: POINTER; an_edge: INTEGER) is
 		-- gtk_handle_box_set_snap_edge (node at line 22722)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_handle_box_set_handle_position (a_handle_box: POINTER; a_position: INTEGER) is
 		-- gtk_handle_box_set_handle_position (node at line 33991)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_handle_box_set_shadow_type (a_handle_box: POINTER; a_type: INTEGER) is
 		-- gtk_handle_box_set_shadow_type (node at line 34069)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
