...
feature {} -- Low-level setters
	...
	gtk_item_class_struct_set_select_external (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "gtk_item_class_struct_set_select_external"
		}"
		end
...
feature {} -- Low-level queries
	...
	gtk_item_class_struct_get_select_external (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "gtk_item_class_struct_get_select_external"
		}"
		end
