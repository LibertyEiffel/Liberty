...
feature {} -- External calls
	...
	gtk_tool_button_set_icon_widget (a_button: POINTER; an_icon_widget: POINTER) is
 		-- gtk_tool_button_set_icon_widget (node at line 145)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_tool_button_get_type: NATURAL_32 is
 		-- gtk_tool_button_get_type (node at line 3839)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_tool_button_new (an_icon_widget: POINTER; a_label: POINTER): POINTER is
 		-- gtk_tool_button_new (node at line 5921)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_tool_button_set_label (a_button: POINTER; a_label: POINTER) is
 		-- gtk_tool_button_set_label (node at line 13401)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_tool_button_get_icon_widget (a_button: POINTER): POINTER is
 		-- gtk_tool_button_get_icon_widget (node at line 14188)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_tool_button_set_stock_id (a_button: POINTER; a_stock_id: POINTER) is
 		-- gtk_tool_button_set_stock_id (node at line 14993)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_tool_button_get_stock_id (a_button: POINTER): POINTER is
 		-- gtk_tool_button_get_stock_id (node at line 16096)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_tool_button_get_icon_name (a_button: POINTER): POINTER is
 		-- gtk_tool_button_get_icon_name (node at line 22899)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_tool_button_set_icon_name (a_button: POINTER; an_icon_name: POINTER) is
 		-- gtk_tool_button_set_icon_name (node at line 26882)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_tool_button_get_label (a_button: POINTER): POINTER is
 		-- gtk_tool_button_get_label (node at line 27378)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_tool_button_set_label_widget (a_button: POINTER; a_label_widget: POINTER) is
 		-- gtk_tool_button_set_label_widget (node at line 28074)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_tool_button_get_use_underline (a_button: POINTER): INTEGER_32 is
 		-- gtk_tool_button_get_use_underline (node at line 30592)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_tool_button_get_label_widget (a_button: POINTER): POINTER is
 		-- gtk_tool_button_get_label_widget (node at line 31732)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_tool_button_new_from_stock (a_stock_id: POINTER): POINTER is
 		-- gtk_tool_button_new_from_stock (node at line 34862)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_tool_button_set_use_underline (a_button: POINTER; an_use_underline: INTEGER_32) is
 		-- gtk_tool_button_set_use_underline (node at line 35830)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
