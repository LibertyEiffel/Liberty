...
feature -- Queries
	...
	is_pixels_above_lines: BOOLEAN is
		do
			Result := (value=pixels_above_lines_low_level)
		end

	is_pixels_below_lines: BOOLEAN is
		do
			Result := (value=pixels_below_lines_low_level)
		end

	is_pixels_inside_wrap: BOOLEAN is
		do
			Result := (value=pixels_inside_wrap_low_level)
		end

	is_bg_full_height: BOOLEAN is
		do
