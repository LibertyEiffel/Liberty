...
feature {} -- External calls
	...
	gtk_tree_model_sort_convert_child_iter_to_iter (a_tree_model_sort: POINTER; a_sort_iter: POINTER; a_child_iter: POINTER): INTEGER_32 is
 		-- gtk_tree_model_sort_convert_child_iter_to_iter (node at line 3004)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_tree_model_sort_convert_iter_to_child_iter (a_tree_model_sort: POINTER; a_child_iter: POINTER; a_sorted_iter: POINTER) is
 		-- gtk_tree_model_sort_convert_iter_to_child_iter (node at line 4774)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_tree_model_sort_new_with_model (a_child_model: POINTER): POINTER is
 		-- gtk_tree_model_sort_new_with_model (node at line 5271)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_tree_model_sort_clear_cache (a_tree_model_sort: POINTER) is
 		-- gtk_tree_model_sort_clear_cache (node at line 5289)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_tree_model_sort_reset_default_sort_func (a_tree_model_sort: POINTER) is
 		-- gtk_tree_model_sort_reset_default_sort_func (node at line 6436)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_tree_model_sort_iter_is_valid (a_tree_model_sort: POINTER; an_iter: POINTER): INTEGER_32 is
 		-- gtk_tree_model_sort_iter_is_valid (node at line 17240)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_tree_model_sort_get_model (a_tree_model: POINTER): POINTER is
 		-- gtk_tree_model_sort_get_model (node at line 28514)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_tree_model_sort_get_type: NATURAL_32 is
 		-- gtk_tree_model_sort_get_type (node at line 28770)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_tree_model_sort_convert_child_path_to_path (a_tree_model_sort: POINTER; a_child_path: POINTER): POINTER is
 		-- gtk_tree_model_sort_convert_child_path_to_path (node at line 34819)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_tree_model_sort_convert_path_to_child_path (a_tree_model_sort: POINTER; a_sorted_path: POINTER): POINTER is
 		-- gtk_tree_model_sort_convert_path_to_child_path (node at line 36939)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
