...
feature -- Queries
	is_invalid_type_function: BOOLEAN is
		do
			Result := (value=invalid_type_function_low_level)
		end

	is_unhandled_tag: BOOLEAN is
		do
	...
	is_invalid_attribute: BOOLEAN is
		do
			Result := (value=invalid_attribute_low_level)
		end

	is_invalid_tag: BOOLEAN is
		do
			Result := (value=invalid_tag_low_level)
		end

	is_missing_property_value: BOOLEAN is
		do
	...
	is_version_mismatch: BOOLEAN is
		do
			Result := (value=version_mismatch_low_level)
		end

	is_duplicate_id: BOOLEAN is
		do
