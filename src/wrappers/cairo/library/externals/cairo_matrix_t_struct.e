...
feature {} -- Low-level setters
	...
	cairo_matrix_t_struct_set_xx (a_structure: POINTER; a_value: REAL_64) is
	...
	cairo_matrix_t_struct_set_yx (a_structure: POINTER; a_value: REAL_64) is
	...
	cairo_matrix_t_struct_set_xy (a_structure: POINTER; a_value: REAL_64) is
	...
	cairo_matrix_t_struct_set_yy (a_structure: POINTER; a_value: REAL_64) is
	...
	cairo_matrix_t_struct_set_x0 (a_structure: POINTER; a_value: REAL_64) is
	...
	cairo_matrix_t_struct_set_y0 (a_structure: POINTER; a_value: REAL_64) is
...
feature {} -- Low-level queries
	...
	cairo_matrix_t_struct_get_xx (a_structure: POINTER): REAL_64 is
	...
	cairo_matrix_t_struct_get_yx (a_structure: POINTER): REAL_64 is
	...
	cairo_matrix_t_struct_get_xy (a_structure: POINTER): REAL_64 is
	...
	cairo_matrix_t_struct_get_yy (a_structure: POINTER): REAL_64 is
	...
	cairo_matrix_t_struct_get_x0 (a_structure: POINTER): REAL_64 is
	...
	cairo_matrix_t_struct_get_y0 (a_structure: POINTER): REAL_64 is
