...
feature {} -- Low-level setters
	...
	cairo_rectangle_list_t_struct_set_status (a_structure: POINTER; a_value: INTEGER) is
	...
	cairo_rectangle_list_t_struct_set_rectangles (a_structure: POINTER; a_value: POINTER) is
	...
	cairo_rectangle_list_t_struct_set_num_rectangles (a_structure: POINTER; a_value: INTEGER_32) is
...
feature {} -- Low-level queries
	...
	cairo_rectangle_list_t_struct_get_status (a_structure: POINTER): INTEGER is
	...
	cairo_rectangle_list_t_struct_get_rectangles (a_structure: POINTER): POINTER is
	...
	cairo_rectangle_list_t_struct_get_num_rectangles (a_structure: POINTER): INTEGER_32 is
