...
feature {} -- Low-level setters
	...
	cairo_path_t_struct_set_status (a_structure: POINTER; a_value: INTEGER) is
	...
	cairo_path_t_struct_set_data (a_structure: POINTER; a_value: POINTER) is
	...
	cairo_path_t_struct_set_num_data (a_structure: POINTER; a_value: INTEGER_32) is
...
feature {} -- Low-level queries
	...
	cairo_path_t_struct_get_status (a_structure: POINTER): INTEGER is
	...
	cairo_path_t_struct_get_data (a_structure: POINTER): POINTER is
	...
	cairo_path_t_struct_get_num_data (a_structure: POINTER): INTEGER_32 is
