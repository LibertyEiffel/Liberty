	...
	is_valid_value (a_value: INTEGER): BOOLEAN is
		do
			Result := ((a_value = xml_err_ok) or else 
				...
				(a_value = xml_tree_not_utf8) or else 
				...
				(a_value = xml_schematronv_assert) or else 
				(a_value = xml_schematronv_report) or else 
...
feature -- Setters
	default_create,  set_err_ok is
	 ...
	 set_schematronv_assert is
		...
		do
			value := xml_schematronv_assert
		end

	 set_schematronv_report is
	
		do
			value := xml_schematronv_report
		end
...
feature -- Queries
	...
	is_tree_not_utf8: BOOLEAN is
		...
		do
			Result := (value=xml_tree_not_utf8)
		end
	...
	is_schematronv_assert: BOOLEAN is
		...
		do
			Result := (value=xml_schematronv_assert)
		end

	is_schematronv_report: BOOLEAN is
		
		do
			Result := (value=xml_schematronv_report)
		end
...
feature {WRAPPER, WRAPPER_HANDLER} -- Low level values
	...
	xml_schematronv_assert: INTEGER is
		external "plug_in"
 		alias "{
 			location: "../../../plugins"
 			module: "glib"
	...
	xml_schematronv_report: INTEGER is
		external "plug_in"
 		alias "{
 			location: "../../../plugins"
 			module: "glib"
