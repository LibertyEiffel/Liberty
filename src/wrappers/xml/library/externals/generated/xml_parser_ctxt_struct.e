...
-- Wrapper of struct _xmlParserCtxt defined in file /usr/include/libxml2/libxml/parser.h line 184
...
feature {} -- Low-level setters
   ...
   xml_parser_ctxt_struct_set_input_id (a_structure: POINTER; a_value: INTEGER) 
         -- Setter for input_id field of XML_PARSER_CTXT_STRUCT structure.
         -- TODO: setter description
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "xml_parser_ctxt_struct_set_input_id"
      }"
      end

   xml_parser_ctxt_struct_set_sizeentcopy (a_structure: POINTER; a_value: like long_unsigned) 
         -- Setter for sizeentcopy field of XML_PARSER_CTXT_STRUCT structure.
         -- TODO: setter description
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "xml_parser_ctxt_struct_set_sizeentcopy"
      }"
      end
...
feature {} -- Low-level queries
   ...
   xml_parser_ctxt_struct_get_input_id (a_structure: POINTER): INTEGER 
         -- Query for input_id field of XML_PARSER_CTXT_STRUCT structure.
         -- TODO: getter description
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "xml_parser_ctxt_struct_get_input_id"
      }"
      end

   xml_parser_ctxt_struct_get_sizeentcopy (a_structure: POINTER): like long_unsigned 
         -- Query for sizeentcopy field of XML_PARSER_CTXT_STRUCT structure.
         -- TODO: getter description
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "xml_parser_ctxt_struct_get_sizeentcopy"
      }"
      end
...
feature {WRAPPER, WRAPPER_HANDLER} -- Structure size
       struct_size: like size_t 
               ...
               alias "{
                       location: "."
                       module_name: "plugin"
                       feature_name: "sizeof_xml_parser_ctxt"
               }"
               end
