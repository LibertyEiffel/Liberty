...
feature {} -- Creation
	...
	set_translation_domain (a_domain: STRING) is
		-- A convenience feature to use gettext for translating user-visible
		-- strings; 'a_domain' is the domain to use.
	require a_domain/=Void
	do
		g_option_group_set_translation_domain(handle, a_domain.to_external)
	end
