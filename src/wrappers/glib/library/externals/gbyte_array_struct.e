...
feature {} -- Low-level setters
   ...
   gbyte_array_struct_set_data (a_structure: POINTER; a_value: POINTER) 
   ...
   gbyte_array_struct_set_len (a_structure: POINTER; a_value: NATURAL) 
...
feature {} -- Low-level queries
   ...
   gbyte_array_struct_get_data (a_structure: POINTER): POINTER 
   ...
   gbyte_array_struct_get_len (a_structure: POINTER): NATURAL 
