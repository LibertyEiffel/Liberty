...
feature {} -- External calls
	...
	g_variant_compare (an_one: POINTER; a_two: POINTER): INTEGER_32 is
 		-- g_variant_compare
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_get_child (a_value: POINTER; an_index: NATURAL_64; a_format_string: POINTER) is
	...
	g_variant_get_child_value (a_value: POINTER; an_index: NATURAL_64): POINTER is
	...
	g_variant_get_fixed_array (a_value: POINTER; a_n_elements: POINTER; an_element_size: NATURAL_64): POINTER is
	...
	g_variant_get_size (a_value: POINTER): NATURAL_64 is
 		-- g_variant_get_size
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_is_floating (a_value: POINTER): INTEGER_32 is
	...
	g_variant_iter_init (an_iter: POINTER; a_value: POINTER): NATURAL_64 is
 		-- g_variant_iter_init
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_iter_n_children (an_iter: POINTER): NATURAL_64 is
	...
	g_variant_lookup (a_dictionary: POINTER; a_key: POINTER; a_format_string: POINTER): INTEGER_32 is
	...
	g_variant_n_children (a_value: POINTER): NATURAL_64 is
	...
	g_variant_new_array (a_child_type: POINTER; a_children: POINTER; a_n_children: NATURAL_64): POINTER is
 		-- g_variant_new_array
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_new_boolean (a_value: INTEGER_32): POINTER is
	...
	g_variant_new_bytestring_array (a_strv: POINTER; a_length: INTEGER_64): POINTER is
	...
	g_variant_new_double (a_value: REAL_64): POINTER is
	...
	g_variant_new_fixed_array (an_element_type: POINTER; an_elements: POINTER; a_n_elements: NATURAL_64; an_element_size: NATURAL_64): POINTER is
	...
	g_variant_new_from_data (a_type: POINTER; a_data: POINTER; a_size: NATURAL_64; a_trusted: INTEGER_32; a_notify: POINTER; an_user_data: POINTER): POINTER is
	...
	g_variant_new_handle (a_value: INTEGER_32): POINTER is
	...
	g_variant_new_int32 (a_value: INTEGER_32): POINTER is
 		-- g_variant_new_int32
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_new_objv (a_strv: POINTER; a_length: INTEGER_64): POINTER is
 		-- g_variant_new_objv
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_new_strv (a_strv: POINTER; a_length: INTEGER_64): POINTER is
 		-- g_variant_new_strv
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_new_tuple (a_children: POINTER; a_n_children: NATURAL_64): POINTER is
 		-- g_variant_new_tuple
		external "plug_in"
		alias "{
			location: "."
	...
	g_variant_new_uint32 (a_value: NATURAL_32): POINTER is
