...
feature {} -- External calls
	...
	g_pointer_bit_lock (an_address: POINTER; a_lock_bit: INTEGER_32) is
 		-- g_pointer_bit_lock
		external "plug_in"
		alias "{
			location: "."
	...
	g_pointer_bit_trylock (an_address: POINTER; a_lock_bit: INTEGER_32): INTEGER_32 is
	...
	g_pointer_bit_unlock (an_address: POINTER; a_lock_bit: INTEGER_32) is
