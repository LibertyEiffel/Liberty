...
feature {} -- External calls
	...
	g_checksum_type_get_length (a_checksum_type: INTEGER): INTEGER_64 is
	...
	g_checksum_update (a_checksum: POINTER; a_data: POINTER; a_length: INTEGER_64) is
 		-- g_checksum_update
		external "plug_in"
		alias "{
			location: "."
	...
	g_compute_checksum_for_data (a_checksum_type: INTEGER; a_data: POINTER; a_length: NATURAL_64): POINTER is
	...
	g_compute_checksum_for_string (a_checksum_type: INTEGER; a_str: POINTER; a_length: INTEGER_64): POINTER is
