...
feature {} -- External calls
	...
	g_io_channel_get_buffer_size (a_channel: POINTER): NATURAL_64 is
	...
	g_io_channel_read (a_channel: POINTER; a_buf: POINTER; a_count: NATURAL_64; a_bytes_read: POINTER): INTEGER is
 		-- g_io_channel_read
		external "plug_in"
		alias "{
			location: "."
	...
	g_io_channel_read_chars (a_channel: POINTER; a_buf: POINTER; a_count: NATURAL_64; a_bytes_read: POINTER; an_error: POINTER): INTEGER is
	...
	g_io_channel_set_buffer_size (a_channel: POINTER; a_size: NATURAL_64) is
	...
	g_io_channel_write (a_channel: POINTER; a_buf: POINTER; a_count: NATURAL_64; a_bytes_written: POINTER): INTEGER is
 		-- g_io_channel_write
		external "plug_in"
		alias "{
			location: "."
	...
	g_io_channel_write_chars (a_channel: POINTER; a_buf: POINTER; a_count: INTEGER_64; a_bytes_written: POINTER; an_error: POINTER): INTEGER is
