...
feature {} -- External calls
	...
	g_dcgettext (a_domain: POINTER; a_msgid: POINTER; a_category: INTEGER_32): POINTER is
 		-- g_dcgettext
		external "plug_in"
		alias "{
			location: "."
	...
	g_dngettext (a_domain: POINTER; a_msgid: POINTER; a_msgid_plural: POINTER; a_n: NATURAL_64): POINTER is
 		-- g_dngettext
		external "plug_in"
		alias "{
			location: "."
	...
	g_dpgettext (a_domain: POINTER; a_msgctxtid: POINTER; a_msgidoffset: NATURAL_64): POINTER is
 		-- g_dpgettext
		external "plug_in"
		alias "{
			location: "."
