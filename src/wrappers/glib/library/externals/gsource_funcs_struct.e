...
feature {} -- Low-level setters
	...
	gsource_funcs_struct_set_check_external (a_structure: POINTER; a_value: POINTER) is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "gsource_funcs_struct_set_check_external"
		}"
		end
...
feature {} -- Low-level queries
	...
	gsource_funcs_struct_get_check_external (a_structure: POINTER): POINTER is
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "gsource_funcs_struct_get_check_external"
		}"
		end
