...
*/
#define garray_struct_get_data(a_structure) (((struct _GArray*) (a_structure))->data)

#define garray_struct_set_data(a_structure,a_value) do {(((struct _GArray*)(a_structure)))->data = (a_value);}while(0)

#define garray_struct_get_len(a_structure) (((struct _GArray*) (a_structure))->len)

#define garray_struct_set_len(a_structure,a_value) do {(((struct _GArray*)(a_structure)))->len = (a_value);}while(0)
...
#define gnode_struct_set_data(a_structure,a_value) do {(((struct _GNode*)(a_structure)))->data = (a_value);}while(0)

#define gnode_struct_get_next(a_structure) (((struct _GNode*) (a_structure))->next)

#define gnode_struct_set_next(a_structure,a_value) do {(((struct _GNode*)(a_structure)))->next = (a_value);}while(0)

#define gnode_struct_get_prev(a_structure) (((struct _GNode*) (a_structure))->prev)

#define gnode_struct_set_prev(a_structure,a_value) do {(((struct _GNode*)(a_structure)))->prev = (a_value);}while(0)

#define gnode_struct_get_parent(a_structure) (((struct _GNode*) (a_structure))->parent)

#define gnode_struct_set_parent(a_structure,a_value) do {(((struct _GNode*)(a_structure)))->parent = (a_value);}while(0)

#define gnode_struct_get_children(a_structure) (((struct _GNode*) (a_structure))->children)

#define gnode_struct_set_children(a_structure,a_value) do {(((struct _GNode*)(a_structure)))->children = (a_value);}while(0)
...
#define gonce_struct_set_status(a_structure,a_value) do {(((struct _GOnce*)(a_structure)))->status = (a_value);}while(0)

#define gonce_struct_get_retval(a_structure) (((struct _GOnce*) (a_structure))->retval)

#define gonce_struct_set_retval(a_structure,a_value) do {(((struct _GOnce*)(a_structure)))->retval = (a_value);}while(0)

#define sizeof__GOnce (sizeof(struct _GOnce))
#define sizeof__GAsyncQueue (sizeof(struct _GAsyncQueue))
#define sizeof__GCond (sizeof(struct _GCond))
#define gstatic_rwlock_struct_get_read_cond(a_structure) (((struct _GStaticRWLock*) (a_structure))->read_cond)

#define gstatic_rwlock_struct_set_read_cond(a_structure,a_value) do {(((struct _GStaticRWLock*)(a_structure)))->read_cond = (a_value);}while(0)

#define gstatic_rwlock_struct_get_write_cond(a_structure) (((struct _GStaticRWLock*) (a_structure))->write_cond)

#define gstatic_rwlock_struct_set_write_cond(a_structure,a_value) do {(((struct _GStaticRWLock*)(a_structure)))->write_cond = (a_value);}while(0)

#define gstatic_rwlock_struct_get_read_counter(a_structure) (((struct _GStaticRWLock*) (a_structure))->read_counter)

#define gstatic_rwlock_struct_set_read_counter(a_structure,a_value) do {(((struct _GStaticRWLock*)(a_structure)))->read_counter = (a_value);}while(0)

#define gstatic_rwlock_struct_get_have_writer(a_structure) (((struct _GStaticRWLock*) (a_structure))->have_writer)

#define gstatic_rwlock_struct_set_have_writer(a_structure,a_value) do {(((struct _GStaticRWLock*)(a_structure)))->have_writer = (a_value);}while(0)

#define gstatic_rwlock_struct_get_want_to_read(a_structure) (((struct _GStaticRWLock*) (a_structure))->want_to_read)

#define gstatic_rwlock_struct_set_want_to_read(a_structure,a_value) do {(((struct _GStaticRWLock*)(a_structure)))->want_to_read = (a_value);}while(0)

#define gstatic_rwlock_struct_get_want_to_write(a_structure) (((struct _GStaticRWLock*) (a_structure))->want_to_write)

#define gstatic_rwlock_struct_set_want_to_write(a_structure,a_value) do {(((struct _GStaticRWLock*)(a_structure)))->want_to_write = (a_value);}while(0)

#define sizeof__GStaticRWLock (sizeof(struct _GStaticRWLock))
#define sizeof__GRelation (sizeof(struct _GRelation))
#define sizeof__GCache (sizeof(struct _GCache))
...
#define giochannel_struct_get_funcs(a_structure) (((struct _GIOChannel*) (a_structure))->funcs)

#define giochannel_struct_set_funcs(a_structure,a_value) do {(((struct _GIOChannel*)(a_structure)))->funcs = (a_value);}while(0)

#define giochannel_struct_get_encoding(a_structure) (((struct _GIOChannel*) (a_structure))->encoding)

#define giochannel_struct_set_encoding(a_structure,a_value) do {(((struct _GIOChannel*)(a_structure)))->encoding = (a_value);}while(0)

#define giochannel_struct_get_read_cd(a_structure) (((struct _GIOChannel*) (a_structure))->read_cd)

#define giochannel_struct_set_read_cd(a_structure,a_value) do {(((struct _GIOChannel*)(a_structure)))->read_cd = (a_value);}while(0)

#define giochannel_struct_get_write_cd(a_structure) (((struct _GIOChannel*) (a_structure))->write_cd)

#define giochannel_struct_set_write_cd(a_structure,a_value) do {(((struct _GIOChannel*)(a_structure)))->write_cd = (a_value);}while(0)

#define giochannel_struct_get_line_term(a_structure) (((struct _GIOChannel*) (a_structure))->line_term)

#define giochannel_struct_set_line_term(a_structure,a_value) do {(((struct _GIOChannel*)(a_structure)))->line_term = (a_value);}while(0)

#define giochannel_struct_get_line_term_len(a_structure) (((struct _GIOChannel*) (a_structure))->line_term_len)

#define giochannel_struct_set_line_term_len(a_structure,a_value) do {(((struct _GIOChannel*)(a_structure)))->line_term_len = (a_value);}while(0)

#define giochannel_struct_get_buf_size(a_structure) (((struct _GIOChannel*) (a_structure))->buf_size)

#define giochannel_struct_set_buf_size(a_structure,a_value) do {(((struct _GIOChannel*)(a_structure)))->buf_size = (a_value);}while(0)

#define giochannel_struct_get_read_buf(a_structure) (((struct _GIOChannel*) (a_structure))->read_buf)

#define giochannel_struct_set_read_buf(a_structure,a_value) do {(((struct _GIOChannel*)(a_structure)))->read_buf = (a_value);}while(0)

#define giochannel_struct_get_encoded_read_buf(a_structure) (((struct _GIOChannel*) (a_structure))->encoded_read_buf)

#define giochannel_struct_set_encoded_read_buf(a_structure,a_value) do {(((struct _GIOChannel*)(a_structure)))->encoded_read_buf = (a_value);}while(0)

#define giochannel_struct_get_write_buf(a_structure) (((struct _GIOChannel*) (a_structure))->write_buf)

#define giochannel_struct_set_write_buf(a_structure,a_value) do {(((struct _GIOChannel*)(a_structure)))->write_buf = (a_value);}while(0)

#define giochannel_struct_get_partial_write_buf(a_structure) (((struct _GIOChannel*) (a_structure))->partial_write_buf)

#define giochannel_struct_set_partial_write_buf(a_structure,a_value) do {(((struct _GIOChannel*)(a_structure)))->partial_write_buf = (a_value);}while(0)

#define giochannel_struct_get_use_buffer(a_structure) (((struct _GIOChannel*) (a_structure))->use_buffer)

#define giochannel_struct_set_use_buffer(a_structure,a_value) do {(((struct _GIOChannel*)(a_structure)))->use_buffer = (a_value);}while(0)

#define giochannel_struct_get_do_encode(a_structure) (((struct _GIOChannel*) (a_structure))->do_encode)

#define giochannel_struct_set_do_encode(a_structure,a_value) do {(((struct _GIOChannel*)(a_structure)))->do_encode = (a_value);}while(0)

#define giochannel_struct_get_close_on_unref(a_structure) (((struct _GIOChannel*) (a_structure))->close_on_unref)

#define giochannel_struct_set_close_on_unref(a_structure,a_value) do {(((struct _GIOChannel*)(a_structure)))->close_on_unref = (a_value);}while(0)

#define giochannel_struct_get_is_readable(a_structure) (((struct _GIOChannel*) (a_structure))->is_readable)

#define giochannel_struct_set_is_readable(a_structure,a_value) do {(((struct _GIOChannel*)(a_structure)))->is_readable = (a_value);}while(0)

#define giochannel_struct_get_is_writeable(a_structure) (((struct _GIOChannel*) (a_structure))->is_writeable)

#define giochannel_struct_set_is_writeable(a_structure,a_value) do {(((struct _GIOChannel*)(a_structure)))->is_writeable = (a_value);}while(0)

#define giochannel_struct_get_is_seekable(a_structure) (((struct _GIOChannel*) (a_structure))->is_seekable)

#define giochannel_struct_set_is_seekable(a_structure,a_value) do {(((struct _GIOChannel*)(a_structure)))->is_seekable = (a_value);}while(0)

#define giochannel_struct_get_reserved1(a_structure) (((struct _GIOChannel*) (a_structure))->reserved1)

#define giochannel_struct_set_reserved1(a_structure,a_value) do {(((struct _GIOChannel*)(a_structure)))->reserved1 = (a_value);}while(0)

#define giochannel_struct_get_reserved2(a_structure) (((struct _GIOChannel*) (a_structure))->reserved2)
...
#define gstatic_rec_mutex_struct_get_depth(a_structure) (((struct _GStaticRecMutex*) (a_structure))->depth)

#define gstatic_rec_mutex_struct_set_depth(a_structure,a_value) do {(((struct _GStaticRecMutex*)(a_structure)))->depth = (a_value);}while(0)

#define sizeof__GStaticRecMutex (sizeof(struct _GStaticRecMutex))
...
#define gscanner_struct_get_max_parse_errors(a_structure) (((struct _GScanner*) (a_structure))->max_parse_errors)

#define gscanner_struct_set_max_parse_errors(a_structure,a_value) do {(((struct _GScanner*)(a_structure)))->max_parse_errors = (a_value);}while(0)

#define gscanner_struct_get_parse_errors(a_structure) (((struct _GScanner*) (a_structure))->parse_errors)

#define gscanner_struct_set_parse_errors(a_structure,a_value) do {(((struct _GScanner*)(a_structure)))->parse_errors = (a_value);}while(0)

#define gscanner_struct_get_input_name(a_structure) (((struct _GScanner*) (a_structure))->input_name)

#define gscanner_struct_set_input_name(a_structure,a_value) do {(((struct _GScanner*)(a_structure)))->input_name = (a_value);}while(0)

#define gscanner_struct_get_qdata(a_structure) (((struct _GScanner*) (a_structure))->qdata)

#define gscanner_struct_set_qdata(a_structure,a_value) do {(((struct _GScanner*)(a_structure)))->qdata = (a_value);}while(0)

#define gscanner_struct_get_config(a_structure) (((struct _GScanner*) (a_structure))->config)

#define gscanner_struct_set_config(a_structure,a_value) do {(((struct _GScanner*)(a_structure)))->config = (a_value);}while(0)

#define gscanner_struct_get_token(a_structure) (((struct _GScanner*) (a_structure))->token)

#define gscanner_struct_set_token(a_structure,a_value) do {(((struct _GScanner*)(a_structure)))->token = (a_value);}while(0)

#define gscanner_struct_get_line(a_structure) (((struct _GScanner*) (a_structure))->line)

#define gscanner_struct_set_line(a_structure,a_value) do {(((struct _GScanner*)(a_structure)))->line = (a_value);}while(0)

#define gscanner_struct_get_position(a_structure) (((struct _GScanner*) (a_structure))->position)

#define gscanner_struct_set_position(a_structure,a_value) do {(((struct _GScanner*)(a_structure)))->position = (a_value);}while(0)

#define gscanner_struct_get_next_token(a_structure) (((struct _GScanner*) (a_structure))->next_token)

#define gscanner_struct_set_next_token(a_structure,a_value) do {(((struct _GScanner*)(a_structure)))->next_token = (a_value);}while(0)

#define gscanner_struct_get_next_line(a_structure) (((struct _GScanner*) (a_structure))->next_line)

#define gscanner_struct_set_next_line(a_structure,a_value) do {(((struct _GScanner*)(a_structure)))->next_line = (a_value);}while(0)

#define gscanner_struct_get_next_position(a_structure) (((struct _GScanner*) (a_structure))->next_position)

#define gscanner_struct_set_next_position(a_structure,a_value) do {(((struct _GScanner*)(a_structure)))->next_position = (a_value);}while(0)

#define gscanner_struct_get_symbol_table(a_structure) (((struct _GScanner*) (a_structure))->symbol_table)

#define gscanner_struct_set_symbol_table(a_structure,a_value) do {(((struct _GScanner*)(a_structure)))->symbol_table = (a_value);}while(0)

#define gscanner_struct_get_input_fd(a_structure) (((struct _GScanner*) (a_structure))->input_fd)

#define gscanner_struct_set_input_fd(a_structure,a_value) do {(((struct _GScanner*)(a_structure)))->input_fd = (a_value);}while(0)

#define gscanner_struct_get_text(a_structure) (((struct _GScanner*) (a_structure))->text)

#define gscanner_struct_set_text(a_structure,a_value) do {(((struct _GScanner*)(a_structure)))->text = (a_value);}while(0)

#define gscanner_struct_get_text_end(a_structure) (((struct _GScanner*) (a_structure))->text_end)

#define gscanner_struct_set_text_end(a_structure,a_value) do {(((struct _GScanner*)(a_structure)))->text_end = (a_value);}while(0)

#define gscanner_struct_get_buffer(a_structure) (((struct _GScanner*) (a_structure))->buffer)

#define gscanner_struct_set_buffer(a_structure,a_value) do {(((struct _GScanner*)(a_structure)))->buffer = (a_value);}while(0)

#define gscanner_struct_get_scope_id(a_structure) (((struct _GScanner*) (a_structure))->scope_id)

#define gscanner_struct_set_scope_id(a_structure,a_value) do {(((struct _GScanner*)(a_structure)))->scope_id = (a_value);}while(0)

#define gscanner_struct_get_msg_handler(a_structure) (((struct _GScanner*) (a_structure))->msg_handler)
...
#define gtuples_struct_get_len(a_structure) (((struct _GTuples*) (a_structure))->len)

#define gtuples_struct_set_len(a_structure,a_value) do {(((struct _GTuples*)(a_structure)))->len = (a_value);}while(0)

#define sizeof__GTuples (sizeof(struct _GTuples))
...
#define gstring_struct_set_str(a_structure,a_value) do {(((struct _GString*)(a_structure)))->str = (a_value);}while(0)

#define gstring_struct_get_len(a_structure) (((struct _GString*) (a_structure))->len)

#define gstring_struct_set_len(a_structure,a_value) do {(((struct _GString*)(a_structure)))->len = (a_value);}while(0)

#define gstring_struct_get_allocated_len(a_structure) (((struct _GString*) (a_structure))->allocated_len)
...
#define sizeof__GAllocator (sizeof(struct _GAllocator))
#define sizeof__GPrivate (sizeof(struct _GPrivate))
...
#define gthread_struct_get_func(a_structure) (((struct _GThread*) (a_structure))->func)

#define gthread_struct_set_func(a_structure,a_value) do {(((struct _GThread*)(a_structure)))->func = (a_value);}while(0)

#define gthread_struct_get_data(a_structure) (((struct _GThread*) (a_structure))->data)

#define gthread_struct_set_data(a_structure,a_value) do {(((struct _GThread*)(a_structure)))->data = (a_value);}while(0)

#define gthread_struct_get_joinable(a_structure) (((struct _GThread*) (a_structure))->joinable)

#define gthread_struct_set_joinable(a_structure,a_value) do {(((struct _GThread*)(a_structure)))->joinable = (a_value);}while(0)

#define gthread_struct_get_priority(a_structure) (((struct _GThread*) (a_structure))->priority)

#define gthread_struct_set_priority(a_structure,a_value) do {(((struct _GThread*)(a_structure)))->priority = (a_value);}while(0)

#define sizeof__GThread (sizeof(struct _GThread))
...
#define gsource_struct_get_callback_funcs(a_structure) (((struct _GSource*) (a_structure))->callback_funcs)

#define gsource_struct_set_callback_funcs(a_structure,a_value) do {(((struct _GSource*)(a_structure)))->callback_funcs = (a_value);}while(0)

#define gsource_struct_get_source_funcs(a_structure) (((struct _GSource*) (a_structure))->source_funcs)

#define gsource_struct_set_source_funcs(a_structure,a_value) do {(((struct _GSource*)(a_structure)))->source_funcs = (a_value);}while(0)

#define gsource_struct_get_ref_count(a_structure) (((struct _GSource*) (a_structure))->ref_count)

#define gsource_struct_set_ref_count(a_structure,a_value) do {(((struct _GSource*)(a_structure)))->ref_count = (a_value);}while(0)

#define gsource_struct_get_context(a_structure) (((struct _GSource*) (a_structure))->context)

#define gsource_struct_set_context(a_structure,a_value) do {(((struct _GSource*)(a_structure)))->context = (a_value);}while(0)

#define gsource_struct_get_priority(a_structure) (((struct _GSource*) (a_structure))->priority)

#define gsource_struct_set_priority(a_structure,a_value) do {(((struct _GSource*)(a_structure)))->priority = (a_value);}while(0)

#define gsource_struct_get_flags(a_structure) (((struct _GSource*) (a_structure))->flags)

#define gsource_struct_set_flags(a_structure,a_value) do {(((struct _GSource*)(a_structure)))->flags = (a_value);}while(0)

#define gsource_struct_get_source_id(a_structure) (((struct _GSource*) (a_structure))->source_id)

#define gsource_struct_set_source_id(a_structure,a_value) do {(((struct _GSource*)(a_structure)))->source_id = (a_value);}while(0)

#define gsource_struct_get_poll_fds(a_structure) (((struct _GSource*) (a_structure))->poll_fds)

#define gsource_struct_set_poll_fds(a_structure,a_value) do {(((struct _GSource*)(a_structure)))->poll_fds = (a_value);}while(0)

#define gsource_struct_get_prev(a_structure) (((struct _GSource*) (a_structure))->prev)

#define gsource_struct_set_prev(a_structure,a_value) do {(((struct _GSource*)(a_structure)))->prev = (a_value);}while(0)

#define gsource_struct_get_next(a_structure) (((struct _GSource*) (a_structure))->next)

#define gsource_struct_set_next(a_structure,a_value) do {(((struct _GSource*)(a_structure)))->next = (a_value);}while(0)

#define gsource_struct_get_reserved1(a_structure) (((struct _GSource*) (a_structure))->reserved1)

#define gsource_struct_set_reserved1(a_structure,a_value) do {(((struct _GSource*)(a_structure)))->reserved1 = (a_value);}while(0)

#define gsource_struct_get_reserved2(a_structure) (((struct _GSource*) (a_structure))->reserved2)

#define gsource_struct_set_reserved2(a_structure,a_value) do {(((struct _GSource*)(a_structure)))->reserved2 = (a_value);}while(0)
...
#define gcompletion_struct_get_items(a_structure) (((struct _GCompletion*) (a_structure))->items)

#define gcompletion_struct_set_items(a_structure,a_value) do {(((struct _GCompletion*)(a_structure)))->items = (a_value);}while(0)

#define gcompletion_struct_get_func(a_structure) (((struct _GCompletion*) (a_structure))->func)

#define gcompletion_struct_set_func(a_structure,a_value) do {(((struct _GCompletion*)(a_structure)))->func = (a_value);}while(0)

#define gcompletion_struct_get_prefix(a_structure) (((struct _GCompletion*) (a_structure))->prefix)

#define gcompletion_struct_set_prefix(a_structure,a_value) do {(((struct _GCompletion*)(a_structure)))->prefix = (a_value);}while(0)

#define gcompletion_struct_get_cache(a_structure) (((struct _GCompletion*) (a_structure))->cache)

#define gcompletion_struct_set_cache(a_structure,a_value) do {(((struct _GCompletion*)(a_structure)))->cache = (a_value);}while(0)

#define gcompletion_struct_get_strncmp_func(a_structure) (((struct _GCompletion*) (a_structure))->strncmp_func)

#define gcompletion_struct_set_strncmp_func(a_structure,a_value) do {(((struct _GCompletion*)(a_structure)))->strncmp_func = (a_value);}while(0)

#define sizeof__GCompletion (sizeof(struct _GCompletion))
#define sizeof__GOptionGroup (sizeof(struct _GOptionGroup))
#define sizeof_GTestCase (sizeof(struct GTestCase))
#define sizeof__GStringChunk (sizeof(struct _GStringChunk))
#define sizeof__GKeyFile (sizeof(struct _GKeyFile))
#define ghook_struct_get_data(a_structure) (((struct _GHook*) (a_structure))->data)

#define ghook_struct_set_data(a_structure,a_value) do {(((struct _GHook*)(a_structure)))->data = (a_value);}while(0)

#define ghook_struct_get_next(a_structure) (((struct _GHook*) (a_structure))->next)

#define ghook_struct_set_next(a_structure,a_value) do {(((struct _GHook*)(a_structure)))->next = (a_value);}while(0)

#define ghook_struct_get_prev(a_structure) (((struct _GHook*) (a_structure))->prev)

#define ghook_struct_set_prev(a_structure,a_value) do {(((struct _GHook*)(a_structure)))->prev = (a_value);}while(0)

#define ghook_struct_get_ref_count(a_structure) (((struct _GHook*) (a_structure))->ref_count)

#define ghook_struct_set_ref_count(a_structure,a_value) do {(((struct _GHook*)(a_structure)))->ref_count = (a_value);}while(0)

#define ghook_struct_get_hook_id(a_structure) (((struct _GHook*) (a_structure))->hook_id)

#define ghook_struct_set_hook_id(a_structure,a_value) do {(((struct _GHook*)(a_structure)))->hook_id = (a_value);}while(0)

#define ghook_struct_get_flags(a_structure) (((struct _GHook*) (a_structure))->flags)

#define ghook_struct_set_flags(a_structure,a_value) do {(((struct _GHook*)(a_structure)))->flags = (a_value);}while(0)

#define ghook_struct_get_func(a_structure) (((struct _GHook*) (a_structure))->func)

#define ghook_struct_set_func(a_structure,a_value) do {(((struct _GHook*)(a_structure)))->func = (a_value);}while(0)

#define ghook_struct_get_destroy(a_structure) (((struct _GHook*) (a_structure))->destroy)
...
#define gqueue_struct_set_head(a_structure,a_value) do {(((struct _GQueue*)(a_structure)))->head = (a_value);}while(0)

#define gqueue_struct_get_tail(a_structure) (((struct _GQueue*) (a_structure))->tail)

#define gqueue_struct_set_tail(a_structure,a_value) do {(((struct _GQueue*)(a_structure)))->tail = (a_value);}while(0)

#define gqueue_struct_get_length(a_structure) (((struct _GQueue*) (a_structure))->length)
...
#define giofuncs_struct_set_io_read(a_structure,a_value) do {(((struct _GIOFuncs*)(a_structure)))->io_read = (a_value);}while(0)

#define giofuncs_struct_get_io_write(a_structure) (((struct _GIOFuncs*) (a_structure))->io_write)

#define giofuncs_struct_set_io_write(a_structure,a_value) do {(((struct _GIOFuncs*)(a_structure)))->io_write = (a_value);}while(0)

#define giofuncs_struct_get_io_seek(a_structure) (((struct _GIOFuncs*) (a_structure))->io_seek)

#define giofuncs_struct_set_io_seek(a_structure,a_value) do {(((struct _GIOFuncs*)(a_structure)))->io_seek = (a_value);}while(0)

#define giofuncs_struct_get_io_close(a_structure) (((struct _GIOFuncs*) (a_structure))->io_close)

#define giofuncs_struct_set_io_close(a_structure,a_value) do {(((struct _GIOFuncs*)(a_structure)))->io_close = (a_value);}while(0)

#define giofuncs_struct_get_io_create_watch(a_structure) (((struct _GIOFuncs*) (a_structure))->io_create_watch)

#define giofuncs_struct_set_io_create_watch(a_structure,a_value) do {(((struct _GIOFuncs*)(a_structure)))->io_create_watch = (a_value);}while(0)

#define giofuncs_struct_get_io_free(a_structure) (((struct _GIOFuncs*) (a_structure))->io_free)

#define giofuncs_struct_set_io_free(a_structure,a_value) do {(((struct _GIOFuncs*)(a_structure)))->io_free = (a_value);}while(0)

#define giofuncs_struct_get_io_set_flags(a_structure) (((struct _GIOFuncs*) (a_structure))->io_set_flags)

#define giofuncs_struct_set_io_set_flags(a_structure,a_value) do {(((struct _GIOFuncs*)(a_structure)))->io_set_flags = (a_value);}while(0)

#define giofuncs_struct_get_io_get_flags(a_structure) (((struct _GIOFuncs*) (a_structure))->io_get_flags)
...
#define gstatic_private_struct_get_index(a_structure) (((struct _GStaticPrivate*) (a_structure))->index)

#define gstatic_private_struct_set_index(a_structure,a_value) do {(((struct _GStaticPrivate*)(a_structure)))->index = (a_value);}while(0)

#define sizeof__GStaticPrivate (sizeof(struct _GStaticPrivate))
#define sizeof__GMappedFile (sizeof(struct _GMappedFile))
#define sizeof__GMemChunk (sizeof(struct _GMemChunk))
...
#define gsource_funcs_struct_get_check_external(a_structure) (((struct _GSourceFuncs*) (a_structure))->check)

#define gsource_funcs_struct_set_check_external(a_structure,a_value) do {(((struct _GSourceFuncs*)(a_structure)))->check = (a_value);}while(0)
...
#define sizeof__GData (sizeof(struct _GData))
#define gdate_struct_get_julian_days(a_structure) (((struct _GDate*) (a_structure))->julian_days)

#define gdate_struct_set_julian_days(a_structure,a_value) do {(((struct _GDate*)(a_structure)))->julian_days = (a_value);}while(0)

#define gdate_struct_get_julian(a_structure) (((struct _GDate*) (a_structure))->julian)

#define gdate_struct_set_julian(a_structure,a_value) do {(((struct _GDate*)(a_structure)))->julian = (a_value);}while(0)

#define gdate_struct_get_dmy(a_structure) (((struct _GDate*) (a_structure))->dmy)

#define gdate_struct_set_dmy(a_structure,a_value) do {(((struct _GDate*)(a_structure)))->dmy = (a_value);}while(0)

#define gdate_struct_get_day(a_structure) (((struct _GDate*) (a_structure))->day)

#define gdate_struct_set_day(a_structure,a_value) do {(((struct _GDate*)(a_structure)))->day = (a_value);}while(0)

#define gdate_struct_get_month(a_structure) (((struct _GDate*) (a_structure))->month)

#define gdate_struct_set_month(a_structure,a_value) do {(((struct _GDate*)(a_structure)))->month = (a_value);}while(0)

#define gdate_struct_get_year(a_structure) (((struct _GDate*) (a_structure))->year)

#define gdate_struct_set_year(a_structure,a_value) do {(((struct _GDate*)(a_structure)))->year = (a_value);}while(0)

#define sizeof__GDate (sizeof(struct _GDate))
#define sizeof__GDir (sizeof(struct _GDir))
#define gslist_struct_get_data(a_structure) (((struct _GSList*) (a_structure))->data)

#define gslist_struct_set_data(a_structure,a_value) do {(((struct _GSList*)(a_structure)))->data = (a_value);}while(0)

#define gslist_struct_get_next(a_structure) (((struct _GSList*) (a_structure))->next)
...
#define gthread_functions_struct_get_mutex_new(a_structure) (((struct _GThreadFunctions*) (a_structure))->mutex_new)

#define gthread_functions_struct_set_mutex_new(a_structure,a_value) do {(((struct _GThreadFunctions*)(a_structure)))->mutex_new = (a_value);}while(0)

#define gthread_functions_struct_get_mutex_lock(a_structure) (((struct _GThreadFunctions*) (a_structure))->mutex_lock)

#define gthread_functions_struct_set_mutex_lock(a_structure,a_value) do {(((struct _GThreadFunctions*)(a_structure)))->mutex_lock = (a_value);}while(0)

#define gthread_functions_struct_get_mutex_trylock(a_structure) (((struct _GThreadFunctions*) (a_structure))->mutex_trylock)

#define gthread_functions_struct_set_mutex_trylock(a_structure,a_value) do {(((struct _GThreadFunctions*)(a_structure)))->mutex_trylock = (a_value);}while(0)

#define gthread_functions_struct_get_mutex_unlock(a_structure) (((struct _GThreadFunctions*) (a_structure))->mutex_unlock)

#define gthread_functions_struct_set_mutex_unlock(a_structure,a_value) do {(((struct _GThreadFunctions*)(a_structure)))->mutex_unlock = (a_value);}while(0)

#define gthread_functions_struct_get_mutex_free(a_structure) (((struct _GThreadFunctions*) (a_structure))->mutex_free)

#define gthread_functions_struct_set_mutex_free(a_structure,a_value) do {(((struct _GThreadFunctions*)(a_structure)))->mutex_free = (a_value);}while(0)

#define gthread_functions_struct_get_cond_new(a_structure) (((struct _GThreadFunctions*) (a_structure))->cond_new)

#define gthread_functions_struct_set_cond_new(a_structure,a_value) do {(((struct _GThreadFunctions*)(a_structure)))->cond_new = (a_value);}while(0)

#define gthread_functions_struct_get_cond_signal(a_structure) (((struct _GThreadFunctions*) (a_structure))->cond_signal)

#define gthread_functions_struct_set_cond_signal(a_structure,a_value) do {(((struct _GThreadFunctions*)(a_structure)))->cond_signal = (a_value);}while(0)

#define gthread_functions_struct_get_cond_broadcast(a_structure) (((struct _GThreadFunctions*) (a_structure))->cond_broadcast)

#define gthread_functions_struct_set_cond_broadcast(a_structure,a_value) do {(((struct _GThreadFunctions*)(a_structure)))->cond_broadcast = (a_value);}while(0)

#define gthread_functions_struct_get_cond_wait(a_structure) (((struct _GThreadFunctions*) (a_structure))->cond_wait)

#define gthread_functions_struct_set_cond_wait(a_structure,a_value) do {(((struct _GThreadFunctions*)(a_structure)))->cond_wait = (a_value);}while(0)

#define gthread_functions_struct_get_cond_timed_wait(a_structure) (((struct _GThreadFunctions*) (a_structure))->cond_timed_wait)

#define gthread_functions_struct_set_cond_timed_wait(a_structure,a_value) do {(((struct _GThreadFunctions*)(a_structure)))->cond_timed_wait = (a_value);}while(0)

#define gthread_functions_struct_get_cond_free(a_structure) (((struct _GThreadFunctions*) (a_structure))->cond_free)

#define gthread_functions_struct_set_cond_free(a_structure,a_value) do {(((struct _GThreadFunctions*)(a_structure)))->cond_free = (a_value);}while(0)

#define gthread_functions_struct_get_private_new(a_structure) (((struct _GThreadFunctions*) (a_structure))->private_new)

#define gthread_functions_struct_set_private_new(a_structure,a_value) do {(((struct _GThreadFunctions*)(a_structure)))->private_new = (a_value);}while(0)

#define gthread_functions_struct_get_private_get(a_structure) (((struct _GThreadFunctions*) (a_structure))->private_get)

#define gthread_functions_struct_set_private_get(a_structure,a_value) do {(((struct _GThreadFunctions*)(a_structure)))->private_get = (a_value);}while(0)

#define gthread_functions_struct_get_private_set(a_structure) (((struct _GThreadFunctions*) (a_structure))->private_set)

#define gthread_functions_struct_set_private_set(a_structure,a_value) do {(((struct _GThreadFunctions*)(a_structure)))->private_set = (a_value);}while(0)

#define gthread_functions_struct_get_thread_create(a_structure) (((struct _GThreadFunctions*) (a_structure))->thread_create)

#define gthread_functions_struct_set_thread_create(a_structure,a_value) do {(((struct _GThreadFunctions*)(a_structure)))->thread_create = (a_value);}while(0)

#define gthread_functions_struct_get_thread_yield(a_structure) (((struct _GThreadFunctions*) (a_structure))->thread_yield)

#define gthread_functions_struct_set_thread_yield(a_structure,a_value) do {(((struct _GThreadFunctions*)(a_structure)))->thread_yield = (a_value);}while(0)

#define gthread_functions_struct_get_thread_join(a_structure) (((struct _GThreadFunctions*) (a_structure))->thread_join)

#define gthread_functions_struct_set_thread_join(a_structure,a_value) do {(((struct _GThreadFunctions*)(a_structure)))->thread_join = (a_value);}while(0)

#define gthread_functions_struct_get_thread_exit(a_structure) (((struct _GThreadFunctions*) (a_structure))->thread_exit)

#define gthread_functions_struct_set_thread_exit(a_structure,a_value) do {(((struct _GThreadFunctions*)(a_structure)))->thread_exit = (a_value);}while(0)

#define gthread_functions_struct_get_thread_set_priority(a_structure) (((struct _GThreadFunctions*) (a_structure))->thread_set_priority)

#define gthread_functions_struct_set_thread_set_priority(a_structure,a_value) do {(((struct _GThreadFunctions*)(a_structure)))->thread_set_priority = (a_value);}while(0)

#define gthread_functions_struct_get_thread_self(a_structure) (((struct _GThreadFunctions*) (a_structure))->thread_self)

#define gthread_functions_struct_set_thread_self(a_structure,a_value) do {(((struct _GThreadFunctions*)(a_structure)))->thread_self = (a_value);}while(0)

#define gthread_functions_struct_get_thread_equal(a_structure) (((struct _GThreadFunctions*) (a_structure))->thread_equal)

#define gthread_functions_struct_set_thread_equal(a_structure,a_value) do {(((struct _GThreadFunctions*)(a_structure)))->thread_equal = (a_value);}while(0)

#define sizeof__GThreadFunctions (sizeof(struct _GThreadFunctions))
