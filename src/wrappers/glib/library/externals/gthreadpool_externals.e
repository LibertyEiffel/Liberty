...
feature {} -- External calls
	...
	g_thread_pool_push (a_pool: POINTER; a_data: POINTER; an_error: POINTER): INTEGER_32 is
 		-- g_thread_pool_push
		external "plug_in"
		alias "{
			location: "."
	...
	g_thread_pool_set_max_threads (a_pool: POINTER; a_max_threads: INTEGER_32; an_error: POINTER): INTEGER_32 is
