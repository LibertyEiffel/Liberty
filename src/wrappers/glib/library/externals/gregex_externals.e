...
feature {} -- External calls
	...
	g_regex_split_simple (a_pattern: POINTER; a_string: POINTER; a_compile_options: INTEGER_32; a_match_options: INTEGER_32): POINTER is
	...
	g_regex_split (a_regex: POINTER; a_string: POINTER; a_match_options: INTEGER_32): POINTER is
 		-- g_regex_split
		external "plug_in"
		alias "{
			location: "../../../plugins"
	...
	g_regex_match_full (a_regex: POINTER; a_string: POINTER; a_string_len: INTEGER_32; a_start_position: INTEGER_32; a_match_options: INTEGER_32; a_match_info: POINTER; an_error: POINTER): INTEGER_32 is
 		-- g_regex_match_full
		external "plug_in"
		alias "{
			location: "../../../plugins"
	...
	g_regex_replace_literal (a_regex: POINTER; a_string: POINTER; a_string_len: INTEGER_32; a_start_position: INTEGER_32; a_replacement: POINTER; a_match_options: INTEGER_32; an_error: POINTER): POINTER is
	...
	g_regex_match (a_regex: POINTER; a_string: POINTER; a_match_options: INTEGER_32; a_match_info: POINTER): INTEGER_32 is
 		-- g_regex_match
		external "plug_in"
		alias "{
			location: "../../../plugins"
	...
	g_regex_new (a_pattern: POINTER; a_compile_options: INTEGER_32; a_match_options: INTEGER_32; an_error: POINTER): POINTER is
 		-- g_regex_new
		external "plug_in"
		alias "{
			location: "../../../plugins"
	...
	g_regex_match_all (a_regex: POINTER; a_string: POINTER; a_match_options: INTEGER_32; a_match_info: POINTER): INTEGER_32 is
 		-- g_regex_match_all
		external "plug_in"
		alias "{
			location: "../../../plugins"
	...
	g_regex_replace (a_regex: POINTER; a_string: POINTER; a_string_len: INTEGER_32; a_start_position: INTEGER_32; a_replacement: POINTER; a_match_options: INTEGER_32; an_error: POINTER): POINTER is
 		-- g_regex_replace
		external "plug_in"
		alias "{
			location: "../../../plugins"
	...
	g_regex_match_all_full (a_regex: POINTER; a_string: POINTER; a_string_len: INTEGER_32; a_start_position: INTEGER_32; a_match_options: INTEGER_32; a_match_info: POINTER; an_error: POINTER): INTEGER_32 is
	...
	g_regex_replace_eval (a_regex: POINTER; a_string: POINTER; a_string_len: INTEGER_32; a_start_position: INTEGER_32; a_match_options: INTEGER_32; an_eval: POINTER; an_user_data: POINTER; an_error: POINTER): POINTER is
	...
	g_regex_split_full (a_regex: POINTER; a_string: POINTER; a_string_len: INTEGER_32; a_start_position: INTEGER_32; a_match_options: INTEGER_32; a_max_tokens: INTEGER_32; an_error: POINTER): POINTER is
 		-- g_regex_split_full
		external "plug_in"
		alias "{
			location: "../../../plugins"
	...
	g_regex_match_simple (a_pattern: POINTER; a_string: POINTER; a_compile_options: INTEGER_32; a_match_options: INTEGER_32): INTEGER_32 is
