...
feature {} -- External calls
	...
	g_compute_hmac_for_data (a_digest_type: INTEGER; a_key: POINTER; a_key_len: NATURAL_64; a_data: POINTER; a_length: NATURAL_64): POINTER is
	...
	g_compute_hmac_for_string (a_digest_type: INTEGER; a_key: POINTER; a_key_len: NATURAL_64; a_str: POINTER; a_length: INTEGER_64): POINTER is
	...
	g_hmac_new (a_digest_type: INTEGER; a_key: POINTER; a_key_len: NATURAL_64): POINTER is
 		-- g_hmac_new
		external "plug_in"
		alias "{
			location: "."
	...
	g_hmac_update (a_hmac: POINTER; a_data: POINTER; a_length: INTEGER_64) is
 		-- g_hmac_update
		external "plug_in"
		alias "{
			location: "."
