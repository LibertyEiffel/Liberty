...
feature {} -- External calls
	...
	g_ucs4_to_utf16 (a_str: POINTER; a_len: INTEGER_64; an_items_read: POINTER; an_items_written: POINTER; an_error: POINTER): POINTER is
 		-- g_ucs4_to_utf16
		external "plug_in"
		alias "{
			location: "."
	...
	g_ucs4_to_utf8 (a_str: POINTER; a_len: INTEGER_64; an_items_read: POINTER; an_items_written: POINTER; an_error: POINTER): POINTER is
 		-- g_ucs4_to_utf8
		external "plug_in"
		alias "{
			location: "."
	...
	g_unichar_compose (an_a: NATURAL_32; a_b: NATURAL_32; a_ch: POINTER): INTEGER_32 is
 		-- g_unichar_compose
		external "plug_in"
		alias "{
			location: "."
	...
	g_unichar_decompose (a_ch: NATURAL_32; an_a: POINTER; a_b: POINTER): INTEGER_32 is
 		-- g_unichar_decompose
		external "plug_in"
		alias "{
			location: "."
	...
	g_unichar_fully_decompose (a_ch: NATURAL_32; a_compat: INTEGER_32; a_result: POINTER; a_result_len: NATURAL_64): NATURAL_64 is
	...
	g_unicode_canonical_ordering (a_string: POINTER; a_len: NATURAL_64) is
	...
	g_unicode_script_from_iso15924 (an_iso15924: NATURAL_32): INTEGER is
	...
	g_unicode_script_to_iso15924 (a_script: INTEGER): NATURAL_32 is
	...
	g_utf16_to_ucs4 (a_str: POINTER; a_len: INTEGER_64; an_items_read: POINTER; an_items_written: POINTER; an_error: POINTER): POINTER is
 		-- g_utf16_to_ucs4
		external "plug_in"
		alias "{
			location: "."
	...
	g_utf16_to_utf8 (a_str: POINTER; a_len: INTEGER_64; an_items_read: POINTER; an_items_written: POINTER; an_error: POINTER): POINTER is
 		-- g_utf16_to_utf8
		external "plug_in"
		alias "{
			location: "."
	...
	g_utf8_casefold (a_str: POINTER; a_len: INTEGER_64): POINTER is
 		-- g_utf8_casefold
		external "plug_in"
		alias "{
			location: "."
	...
	g_utf8_collate_key (a_str: POINTER; a_len: INTEGER_64): POINTER is
 		-- g_utf8_collate_key
		external "plug_in"
		alias "{
			location: "."
	...
	g_utf8_collate_key_for_filename (a_str: POINTER; a_len: INTEGER_64): POINTER is
	...
	g_utf8_get_char_validated (a_p: POINTER; a_max_len: INTEGER_64): NATURAL_32 is
	...
	g_utf8_normalize (a_str: POINTER; a_len: INTEGER_64; a_mode: INTEGER): POINTER is
 		-- g_utf8_normalize
		external "plug_in"
		alias "{
			location: "."
	...
	g_utf8_offset_to_pointer (a_str: POINTER; an_offset: INTEGER_64): POINTER is
	...
	g_utf8_pointer_to_offset (a_str: POINTER; a_pos: POINTER): INTEGER_64 is
	...
	g_utf8_strchr (a_p: POINTER; a_len: INTEGER_64; a_c: NATURAL_32): POINTER is
 		-- g_utf8_strchr
		external "plug_in"
		alias "{
			location: "."
	...
	g_utf8_strdown (a_str: POINTER; a_len: INTEGER_64): POINTER is
 		-- g_utf8_strdown
		external "plug_in"
		alias "{
			location: "."
	...
	g_utf8_strlen (a_p: POINTER; a_max: INTEGER_64): INTEGER_64 is
 		-- g_utf8_strlen
		external "plug_in"
		alias "{
			location: "."
	...
	g_utf8_strncpy (a_dest: POINTER; a_src: POINTER; a_n: NATURAL_64): POINTER is
 		-- g_utf8_strncpy
		external "plug_in"
		alias "{
			location: "."
	...
	g_utf8_strrchr (a_p: POINTER; a_len: INTEGER_64; a_c: NATURAL_32): POINTER is
 		-- g_utf8_strrchr
		external "plug_in"
		alias "{
			location: "."
	...
	g_utf8_strreverse (a_str: POINTER; a_len: INTEGER_64): POINTER is
 		-- g_utf8_strreverse
		external "plug_in"
		alias "{
			location: "."
	...
	g_utf8_strup (a_str: POINTER; a_len: INTEGER_64): POINTER is
 		-- g_utf8_strup
		external "plug_in"
		alias "{
			location: "."
	...
	g_utf8_substring (a_str: POINTER; a_start_pos: INTEGER_64; an_end_pos: INTEGER_64): POINTER is
 		-- g_utf8_substring
		external "plug_in"
		alias "{
			location: "."
	...
	g_utf8_to_ucs4 (a_str: POINTER; a_len: INTEGER_64; an_items_read: POINTER; an_items_written: POINTER; an_error: POINTER): POINTER is
 		-- g_utf8_to_ucs4
		external "plug_in"
		alias "{
			location: "."
	...
	g_utf8_to_ucs4_fast (a_str: POINTER; a_len: INTEGER_64; an_items_written: POINTER): POINTER is
 		-- g_utf8_to_ucs4_fast
		external "plug_in"
		alias "{
			location: "."
	...
	g_utf8_to_utf16 (a_str: POINTER; a_len: INTEGER_64; an_items_read: POINTER; an_items_written: POINTER; an_error: POINTER): POINTER is
 		-- g_utf8_to_utf16
		external "plug_in"
		alias "{
			location: "."
	...
	g_utf8_validate (a_str: POINTER; a_max_len: INTEGER_64; an_end_external: POINTER): INTEGER_32 is
 		-- g_utf8_validate
		external "plug_in"
		alias "{
			location: "."
