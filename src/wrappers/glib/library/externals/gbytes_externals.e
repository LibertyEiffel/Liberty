...
feature {} -- External calls
	...
	g_bytes_compare (a_bytes1: POINTER; a_bytes2: POINTER): INTEGER_32 is
 		-- g_bytes_compare
		external "plug_in"
		alias "{
			location: "."
	...
	g_bytes_equal (a_bytes1: POINTER; a_bytes2: POINTER): INTEGER_32 is
 		-- g_bytes_equal
		external "plug_in"
		alias "{
			location: "."
	...
	g_bytes_get_size (a_bytes: POINTER): NATURAL_64 is
 		-- g_bytes_get_size
		external "plug_in"
		alias "{
			location: "."
	...
	g_bytes_hash (a_bytes: POINTER): NATURAL_32 is
 		-- g_bytes_hash
		external "plug_in"
		alias "{
			location: "."
	...
	g_bytes_new (a_data: POINTER; a_size: NATURAL_64): POINTER is
 		-- g_bytes_new
		external "plug_in"
		alias "{
			location: "."
	...
	g_bytes_new_from_bytes (a_bytes: POINTER; an_offset: NATURAL_64; a_length: NATURAL_64): POINTER is
	...
	g_bytes_new_static (a_data: POINTER; a_size: NATURAL_64): POINTER is
 		-- g_bytes_new_static
		external "plug_in"
		alias "{
			location: "."
	...
	g_bytes_new_take (a_data: POINTER; a_size: NATURAL_64): POINTER is
 		-- g_bytes_new_take
		external "plug_in"
		alias "{
			location: "."
	...
	g_bytes_new_with_free_func (a_data: POINTER; a_size: NATURAL_64; a_free_func: POINTER; an_user_data: POINTER): POINTER is
