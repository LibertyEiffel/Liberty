...
feature {} -- External calls
	...
	g_queue_push_tail_link (a_queue: POINTER; a_link_: POINTER) is
	...
	g_queue_push_head_link (a_queue: POINTER; a_link_: POINTER) is
	...
	g_queue_push_nth_link (a_queue: POINTER; a_n: INTEGER_32; a_link_: POINTER) is
	...
	g_queue_unlink (a_queue: POINTER; a_link_: POINTER) is
 		-- g_queue_unlink
		external "plug_in"
		alias "{
			location: "../../../plugins"
	...
	g_queue_delete_link (a_queue: POINTER; a_link_: POINTER) is
 		-- g_queue_delete_link
		external "plug_in"
		alias "{
			location: "../../../plugins"
	...
	g_queue_link_index (a_queue: POINTER; a_link_: POINTER): INTEGER_32 is
 		-- g_queue_link_index
		external "plug_in"
		alias "{
			location: "../../../plugins"
