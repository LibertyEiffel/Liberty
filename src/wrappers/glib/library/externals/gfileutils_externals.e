...
feature {} -- External calls
	...
	g_file_set_contents (a_filename: POINTER; a_contents: POINTER; a_length: INTEGER_64; an_error: POINTER): INTEGER_32 is
 		-- g_file_set_contents
		external "plug_in"
		alias "{
			location: "."
	...
	g_mkdtemp_full (a_tmpl: POINTER; a_mode: INTEGER_32): POINTER is
 		-- g_mkdtemp_full
		external "plug_in"
		alias "{
			location: "."
