...
feature {} -- External calls
	...
	g_ascii_strdown (a_str: POINTER; a_len: INTEGER_64): POINTER is
 		-- g_ascii_strdown
		external "plug_in"
		alias "{
			location: "."
	...
	g_ascii_strncasecmp (a_s1: POINTER; a_s2: POINTER; a_n: NATURAL_64): INTEGER_32 is
 		-- g_ascii_strncasecmp
		external "plug_in"
		alias "{
			location: "."
	...
	g_ascii_strup (a_str: POINTER; a_len: INTEGER_64): POINTER is
 		-- g_ascii_strup
		external "plug_in"
		alias "{
			location: "."
	...
	g_strlcat (a_dest: POINTER; a_src: POINTER; a_dest_size: NATURAL_64): NATURAL_64 is
 		-- g_strlcat
		external "plug_in"
		alias "{
			location: "."
	...
	g_strlcpy (a_dest: POINTER; a_src: POINTER; a_dest_size: NATURAL_64): NATURAL_64 is
 		-- g_strlcpy
		external "plug_in"
		alias "{
			location: "."
	...
	g_strndup (a_str: POINTER; a_n: NATURAL_64): POINTER is
 		-- g_strndup
		external "plug_in"
		alias "{
			location: "."
	...
	g_strnfill (a_length: NATURAL_64; a_fill_char: CHARACTER): POINTER is
 		-- g_strnfill
		external "plug_in"
		alias "{
			location: "."
	...
	g_strrstr_len (a_haystack: POINTER; a_haystack_len: INTEGER_64; a_needle: POINTER): POINTER is
 		-- g_strrstr_len
		external "plug_in"
		alias "{
			location: "."
	...
	g_strstr_len (a_haystack: POINTER; a_haystack_len: INTEGER_64; a_needle: POINTER): POINTER is
 		-- g_strstr_len
		external "plug_in"
		alias "{
			location: "."
