...
feature {} -- External calls
	...
	g_date_valid_dmy (a_day: CHARACTER; a_month: INTEGER_32; a_year: NATURAL_16): INTEGER_32 is
 		-- g_date_valid_dmy
		external "plug_in"
		alias "{
			location: "../../../plugins"
	...
	g_date_get_weekday (a_date: POINTER): INTEGER_32 is
 		-- g_date_get_weekday
		external "plug_in"
		alias "{
			location: "../../../plugins"
	...
	g_date_set_time (a_date: POINTER; a_time_: INTEGER_32) is
 		-- g_date_set_time
		external "plug_in"
		alias "{
			location: "../../../plugins"
	...
	g_date_valid_month (a_month: INTEGER_32): INTEGER_32 is
 		-- g_date_valid_month
		external "plug_in"
		alias "{
			location: "../../../plugins"
	...
	g_date_set_dmy (a_date: POINTER; a_day: CHARACTER; a_month: INTEGER_32; a_y: NATURAL_16) is
 		-- g_date_set_dmy
		external "plug_in"
		alias "{
			location: "../../../plugins"
	...
	g_date_valid_weekday (a_weekday: INTEGER_32): INTEGER_32 is
	...
	g_date_get_days_in_month (a_month: INTEGER_32; a_year: NATURAL_16): CHARACTER is
	...
	g_date_set_month (a_date: POINTER; a_month: INTEGER_32) is
 		-- g_date_set_month
		external "plug_in"
		alias "{
			location: "../../../plugins"
	...
	g_date_get_month (a_date: POINTER): INTEGER_32 is
 		-- g_date_get_month
		external "plug_in"
		alias "{
			location: "../../../plugins"
	...
	g_date_new_dmy (a_day: CHARACTER; a_month: INTEGER_32; a_year: NATURAL_16): POINTER is
 		-- g_date_new_dmy
		external "plug_in"
		alias "{
			location: "../../../plugins"
