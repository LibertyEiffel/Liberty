...
feature {} -- External calls
	...
	g_assertion_message_cmpnum (a_domain: POINTER; a_file: POINTER; a_line: INTEGER_32; a_func: POINTER; an_expr: POINTER; an_arg1: REAL_128; a_cmp: POINTER; an_arg2: REAL_128; a_numtype: CHARACTER) is
	...
	g_test_add_vtable (a_testpath: POINTER; a_data_size: NATURAL_64; a_test_data: POINTER; a_data_setup: POINTER; a_data_test: POINTER; a_data_teardown: POINTER) is
 		-- g_test_add_vtable
		external "plug_in"
		alias "{
			location: "."
	...
	g_test_create_case (a_test_name: POINTER; a_data_size: NATURAL_64; a_test_data: POINTER; a_data_setup: POINTER; a_data_test: POINTER; a_data_teardown: POINTER): POINTER is
 		-- g_test_create_case
		external "plug_in"
		alias "{
			location: "."
