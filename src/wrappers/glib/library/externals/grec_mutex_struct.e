...
feature {} -- Low-level setters
   ...
   grec_mutex_struct_set_p (a_structure: POINTER; a_value: POINTER) 
   ...
   grec_mutex_struct_set_i (a_structure: POINTER; a_value: POINTER) 
...
feature {} -- Low-level queries
   ...
   grec_mutex_struct_get_p (a_structure: POINTER): POINTER 
   ...
   grec_mutex_struct_get_i (a_structure: POINTER): POINTER 
