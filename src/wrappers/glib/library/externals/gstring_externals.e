...
feature {} -- External calls
	...
	g_string_append_len (a_string: POINTER; a_val: POINTER; a_len: INTEGER_64): POINTER is
 		-- g_string_append_len
		external "plug_in"
		alias "{
			location: "."
	...
	g_string_erase (a_string: POINTER; a_pos: INTEGER_64; a_len: INTEGER_64): POINTER is
 		-- g_string_erase
		external "plug_in"
		alias "{
			location: "."
	...
	g_string_insert (a_string: POINTER; a_pos: INTEGER_64; a_val: POINTER): POINTER is
 		-- g_string_insert
		external "plug_in"
		alias "{
			location: "."
	...
	g_string_insert_c (a_string: POINTER; a_pos: INTEGER_64; a_c: CHARACTER): POINTER is
 		-- g_string_insert_c
		external "plug_in"
		alias "{
			location: "."
	...
	g_string_insert_len (a_string: POINTER; a_pos: INTEGER_64; a_val: POINTER; a_len: INTEGER_64): POINTER is
 		-- g_string_insert_len
		external "plug_in"
		alias "{
			location: "."
	...
	g_string_insert_unichar (a_string: POINTER; a_pos: INTEGER_64; a_wc: NATURAL_32): POINTER is
	...
	g_string_new_len (an_init: POINTER; a_len: INTEGER_64): POINTER is
 		-- g_string_new_len
		external "plug_in"
		alias "{
			location: "."
	...
	g_string_overwrite (a_string: POINTER; a_pos: NATURAL_64; a_val: POINTER): POINTER is
 		-- g_string_overwrite
		external "plug_in"
		alias "{
			location: "."
	...
	g_string_overwrite_len (a_string: POINTER; a_pos: NATURAL_64; a_val: POINTER; a_len: INTEGER_64): POINTER is
	...
	g_string_prepend_len (a_string: POINTER; a_val: POINTER; a_len: INTEGER_64): POINTER is
	...
	g_string_set_size (a_string: POINTER; a_len: NATURAL_64): POINTER is
 		-- g_string_set_size
		external "plug_in"
		alias "{
			location: "."
	...
	g_string_sized_new (a_dfl_size: NATURAL_64): POINTER is
 		-- g_string_sized_new
		external "plug_in"
		alias "{
			location: "."
	...
	g_string_truncate (a_string: POINTER; a_len: NATURAL_64): POINTER is
 		-- g_string_truncate
		external "plug_in"
		alias "{
			location: "."
