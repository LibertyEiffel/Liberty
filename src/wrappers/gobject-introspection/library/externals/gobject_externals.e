...
feature {} -- External calls
	...
	g_clear_object (an_object_ptr: POINTER) is
 		-- g_clear_object
		external "plug_in"
		alias "{
			location: "."
	...
	g_object_dup_qdata (an_object: POINTER; a_quark: NATURAL_32; a_dup_func: POINTER; an_user_data: POINTER): POINTER is
 		-- g_object_dup_qdata
		external "plug_in"
		alias "{
			location: "."
	...
	g_object_notify_by_pspec (an_object: POINTER; a_pspec: POINTER) is
	...
	g_object_replace_data (an_object: POINTER; a_key: POINTER; an_oldval: POINTER; a_newval: POINTER; a_destroy: POINTER; an_old_destroy: POINTER): INTEGER_32 is
	...
	g_object_replace_qdata (an_object: POINTER; a_quark: NATURAL_32; an_oldval: POINTER; a_newval: POINTER; a_destroy: POINTER; an_old_destroy: POINTER): INTEGER_32 is
	...
	g_weak_ref_clear (a_weak_ref: POINTER) is
 		-- g_weak_ref_clear
		external "plug_in"
		alias "{
			location: "."
	...
	g_weak_ref_get (a_weak_ref: POINTER): POINTER is
 		-- g_weak_ref_get
		external "plug_in"
		alias "{
			location: "."
	...
	g_weak_ref_init (a_weak_ref: POINTER; an_object: POINTER) is
 		-- g_weak_ref_init
		external "plug_in"
		alias "{
			location: "."
	...
	g_weak_ref_set (a_weak_ref: POINTER; an_object: POINTER) is
 		-- g_weak_ref_set
		external "plug_in"
		alias "{
			location: "."
