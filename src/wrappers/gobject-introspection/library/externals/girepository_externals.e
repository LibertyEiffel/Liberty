...
feature {} -- External calls
	...
	g_irepository_dump (an_arg: POINTER; an_error: POINTER): INTEGER_32 is
 		-- g_irepository_dump
		external "plug_in"
		alias "{
			location: "."
	...
	g_irepository_error_quark: NATURAL_32 is
	...
	g_irepository_find_by_error_domain (a_repository: POINTER; a_domain: NATURAL_32): POINTER is
	...
	g_irepository_get_info (a_repository: POINTER; a_namespace: POINTER; an_index: INTEGER_32): POINTER is
	...
	g_irepository_get_n_infos (a_repository: POINTER; a_namespace: POINTER): INTEGER_32 is
	...
	g_irepository_is_registered (a_repository: POINTER; a_namespace: POINTER; a_version: POINTER): INTEGER_32 is
	...
	gi_cclosure_marshal_generic (a_closure: POINTER; a_return_gvalue: POINTER; a_n_param_values: NATURAL_32; a_param_values: POINTER; an_invocation_hint: POINTER; a_marshal_data: POINTER) is
