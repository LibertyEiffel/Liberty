...
feature {} -- External calls
	...
	g_base_info_equal (an_info1: POINTER; an_info2: POINTER): INTEGER_32 is
 		-- g_base_info_equal
		external "plug_in"
		alias "{
			location: "."
	...
	g_base_info_is_deprecated (an_info: POINTER): INTEGER_32 is
	...
	g_base_info_iterate_attributes (an_info: POINTER; an_iterator: POINTER; a_name: POINTER; a_value: POINTER): INTEGER_32 is
	...
	g_info_new (a_type: INTEGER; a_container: POINTER; a_typelib: POINTER; an_offset: NATURAL_32): POINTER is
 		-- g_info_new
		external "plug_in"
		alias "{
			location: "."
