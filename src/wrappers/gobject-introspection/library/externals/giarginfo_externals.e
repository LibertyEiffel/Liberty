...
feature {} -- External calls
	...
	g_arg_info_get_closure (an_info: POINTER): INTEGER_32 is
	...
	g_arg_info_get_destroy (an_info: POINTER): INTEGER_32 is
	...
	g_arg_info_get_direction (an_info: POINTER): INTEGER is
	...
	g_arg_info_get_ownership_transfer (an_info: POINTER): INTEGER is
	...
	g_arg_info_get_scope (an_info: POINTER): INTEGER is
	...
	g_arg_info_get_type (an_info: POINTER): POINTER is
 		-- g_arg_info_get_type
		external "plug_in"
		alias "{
			location: "."
	...
	g_arg_info_is_caller_allocates (an_info: POINTER): INTEGER_32 is
	...
	g_arg_info_is_optional (an_info: POINTER): INTEGER_32 is
	...
	g_arg_info_is_return_value (an_info: POINTER): INTEGER_32 is
	...
	g_arg_info_is_skip (an_info: POINTER): INTEGER_32 is
 		-- g_arg_info_is_skip
		external "plug_in"
		alias "{
			location: "."
	...
	g_arg_info_load_type (an_info: POINTER; a_type: POINTER) is
	...
	g_arg_info_may_be_null (an_info: POINTER): INTEGER_32 is
