...
feature {} -- External calls
	...
	g_callable_info_get_arg (an_info: POINTER; a_n: INTEGER): POINTER is
	...
	g_callable_info_get_n_args (an_info: POINTER): INTEGER is
	...
	g_callable_info_invoke (an_info: POINTER; a_function: POINTER; an_in_args: POINTER; a_n_in_args: INTEGER; an_out_args: POINTER; a_n_out_args: INTEGER; a_return_value: POINTER; an_is_method: INTEGER; a_throws: INTEGER; an_error: POINTER): INTEGER is
	...
	g_callable_info_is_method (an_info: POINTER): INTEGER is
	...
	g_callable_info_iterate_return_attributes (an_info: POINTER; an_iterator: POINTER; a_name: POINTER; a_value: POINTER): INTEGER is
	...
	g_callable_info_load_arg (an_info: POINTER; a_n: INTEGER; an_arg: POINTER) is
	...
	g_callable_info_may_return_null (an_info: POINTER): INTEGER is
	...
	g_callable_info_skip_return (an_info: POINTER): INTEGER is
