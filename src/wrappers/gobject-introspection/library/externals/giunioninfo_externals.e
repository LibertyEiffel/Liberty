...
feature {} -- External calls
	...
	g_union_info_get_alignment (an_info: POINTER): NATURAL_32 is
	...
	g_union_info_get_discriminator (an_info: POINTER; a_n: INTEGER_32): POINTER is
	...
	g_union_info_get_discriminator_offset (an_info: POINTER): INTEGER_32 is
	...
	g_union_info_get_field (an_info: POINTER; a_n: INTEGER_32): POINTER is
	...
	g_union_info_get_method (an_info: POINTER; a_n: INTEGER_32): POINTER is
	...
	g_union_info_get_n_fields (an_info: POINTER): INTEGER_32 is
	...
	g_union_info_get_n_methods (an_info: POINTER): INTEGER_32 is
	...
	g_union_info_get_size (an_info: POINTER): NATURAL_32 is
	...
	g_union_info_is_discriminated (an_info: POINTER): INTEGER_32 is
