...
feature {} -- External calls
	...
	g_object_info_get_abstract (an_info: POINTER): INTEGER_32 is
	...
	g_object_info_get_constant (an_info: POINTER; a_n: INTEGER_32): POINTER is
	...
	g_object_info_get_field (an_info: POINTER; a_n: INTEGER_32): POINTER is
	...
	g_object_info_get_fundamental (an_info: POINTER): INTEGER_32 is
	...
	g_object_info_get_interface (an_info: POINTER; a_n: INTEGER_32): POINTER is
	...
	g_object_info_get_method (an_info: POINTER; a_n: INTEGER_32): POINTER is
	...
	g_object_info_get_n_constants (an_info: POINTER): INTEGER_32 is
	...
	g_object_info_get_n_fields (an_info: POINTER): INTEGER_32 is
	...
	g_object_info_get_n_interfaces (an_info: POINTER): INTEGER_32 is
	...
	g_object_info_get_n_methods (an_info: POINTER): INTEGER_32 is
	...
	g_object_info_get_n_properties (an_info: POINTER): INTEGER_32 is
	...
	g_object_info_get_n_signals (an_info: POINTER): INTEGER_32 is
	...
	g_object_info_get_n_vfuncs (an_info: POINTER): INTEGER_32 is
	...
	g_object_info_get_property (an_info: POINTER; a_n: INTEGER_32): POINTER is
	...
	g_object_info_get_signal (an_info: POINTER; a_n: INTEGER_32): POINTER is
	...
	g_object_info_get_vfunc (an_info: POINTER; a_n: INTEGER_32): POINTER is
