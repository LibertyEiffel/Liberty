...
feature {} -- External calls
	...
	gtk_event_box_get_type: NATURAL_64 is
 		-- gtk_event_box_get_type (node at line 761)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_event_box_new: POINTER is
 		-- gtk_event_box_new (node at line 3697)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_event_box_get_above_child (an_event_box: POINTER): INTEGER_32 is
 		-- gtk_event_box_get_above_child (node at line 6393)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_event_box_set_above_child (an_event_box: POINTER; an_above_child: INTEGER_32) is
 		-- gtk_event_box_set_above_child (node at line 22742)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_event_box_get_visible_window (an_event_box: POINTER): INTEGER_32 is
 		-- gtk_event_box_get_visible_window (node at line 29696)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_event_box_set_visible_window (an_event_box: POINTER; a_visible_window: INTEGER_32) is
 		-- gtk_event_box_set_visible_window (node at line 38212)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
