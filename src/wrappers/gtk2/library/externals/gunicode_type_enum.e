...
feature -- Queries
	...
	unassigned: BOOLEAN is
		do
			Result := (value=unassigned_low_level)
		end

	private_use: BOOLEAN is
		do
	...
	final_punctuation: BOOLEAN is
		do
			Result := (value=final_punctuation_low_level)
		end

	initial_punctuation: BOOLEAN is
		do
			Result := (value=initial_punctuation_low_level)
		end

	other_punctuation: BOOLEAN is
		do
