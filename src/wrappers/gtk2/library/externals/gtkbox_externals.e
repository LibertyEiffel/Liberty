...
feature {} -- External calls
	...
	gtk_box_set_child_packing (a_box: POINTER; a_child: POINTER; an_expand: INTEGER_32; a_fill: INTEGER_32; a_padding: NATURAL_32; a_pack_type: INTEGER) is
 		-- gtk_box_set_child_packing (node at line 4060)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_box_query_child_packing (a_box: POINTER; a_child: POINTER; an_expand: POINTER; a_fill: POINTER; a_padding: POINTER; a_pack_type: POINTER) is
 		-- gtk_box_query_child_packing (node at line 13669)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_box_pack_end (a_box: POINTER; a_child: POINTER; an_expand: INTEGER_32; a_fill: INTEGER_32; a_padding: NATURAL_32) is
 		-- gtk_box_pack_end (node at line 13877)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_box_set_homogeneous (a_box: POINTER; a_homogeneous: INTEGER_32) is
 		-- gtk_box_set_homogeneous (node at line 27231)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_box_get_type: NATURAL_64 is
 		-- gtk_box_get_type (node at line 30560)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_box_reorder_child (a_box: POINTER; a_child: POINTER; a_position: INTEGER_32) is
 		-- gtk_box_reorder_child (node at line 32817)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_box_pack_start (a_box: POINTER; a_child: POINTER; an_expand: INTEGER_32; a_fill: INTEGER_32; a_padding: NATURAL_32) is
 		-- gtk_box_pack_start (node at line 34147)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_box_set_spacing (a_box: POINTER; a_spacing: INTEGER_32) is
 		-- gtk_box_set_spacing (node at line 36888)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_box_get_spacing (a_box: POINTER): INTEGER_32 is
 		-- gtk_box_get_spacing (node at line 37839)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_box_get_homogeneous (a_box: POINTER): INTEGER_32 is
 		-- gtk_box_get_homogeneous (node at line 40817)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
