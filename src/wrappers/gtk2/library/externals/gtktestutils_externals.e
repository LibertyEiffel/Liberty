...
feature {} -- External calls
	...
	gtk_test_register_all_types is
 		-- gtk_test_register_all_types (node at line 2637)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_test_display_button_window (a_window_title: POINTER; a_dialog_text: POINTER): POINTER is
 		-- gtk_test_display_button_window (variadic call)  (node at line 3793)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_test_init (an_argcp: POINTER; an_argvp: POINTER) is
 		-- gtk_test_init (variadic call)  (node at line 4708)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_test_slider_set_perc (a_widget: POINTER; a_percentage: REAL_64) is
 		-- gtk_test_slider_set_perc (node at line 10541)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_test_list_all_types (a_n_types: POINTER): POINTER is
 		-- gtk_test_list_all_types (node at line 17205)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_test_widget_send_key (a_widget: POINTER; a_keyval: NATURAL_32; a_modifiers: INTEGER): INTEGER_32 is
 		-- gtk_test_widget_send_key (node at line 18085)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_test_slider_get_value (a_widget: POINTER): REAL_64 is
 		-- gtk_test_slider_get_value (node at line 19549)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_test_widget_click (a_widget: POINTER; a_button: NATURAL_32; a_modifiers: INTEGER): INTEGER_32 is
 		-- gtk_test_widget_click (node at line 22500)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_test_create_widget (a_widget_type: NATURAL_64; a_first_property_name: POINTER): POINTER is
 		-- gtk_test_create_widget (variadic call)  (node at line 28402)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_test_find_widget (a_widget: POINTER; a_label_pattern: POINTER; a_widget_type: NATURAL_64): POINTER is
 		-- gtk_test_find_widget (node at line 33243)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_test_create_simple_window (a_window_title: POINTER; a_dialog_text: POINTER): POINTER is
 		-- gtk_test_create_simple_window (node at line 33285)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_test_text_set (a_widget: POINTER; a_string: POINTER) is
 		-- gtk_test_text_set (node at line 33572)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_test_find_label (a_widget: POINTER; a_label_pattern: POINTER): POINTER is
 		-- gtk_test_find_label (node at line 34889)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_test_spin_button_click (a_spinner: POINTER; a_button: NATURAL_32; an_upwards: INTEGER_32): INTEGER_32 is
 		-- gtk_test_spin_button_click (node at line 34994)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_test_text_get (a_widget: POINTER): POINTER is
 		-- gtk_test_text_get (node at line 40149)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
	...
	gtk_test_find_sibling (a_base_widget: POINTER; a_widget_type: NATURAL_64): POINTER is
 		-- gtk_test_find_sibling (node at line 40549)
		external "plug_in"
		alias "{
			location: "."
			module_name: "plugin"
