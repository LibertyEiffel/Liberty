	...
	is_valid_value (a_value: INTEGER): BOOLEAN is
		do
			Result := ((a_value = failed_low_level)  or else
				(a_value = basic_type_expected_low_level)  or else
...
feature {ANY} -- Queries
	...
	invalid_type_string: BOOLEAN is
		do
			Result := (value=invalid_type_string_low_level)
		end

	no_common_type: BOOLEAN is
		do
			Result := (value=no_common_type_low_level)
		end

	number_out_of_range: BOOLEAN is
		do
