...
feature {} -- Low-level setters
	...
	gtk_invisible_struct_set_has_user_ref_count (a_structure: POINTER; a_value: INTEGER) is
...
feature {} -- Low-level queries
	...
	gtk_invisible_struct_get_has_user_ref_count (a_structure: POINTER): INTEGER is
