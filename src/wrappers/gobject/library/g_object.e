...
deferred class G_OBJECT
	...
	-- floating state across certain code portions (an example
...
--    This function is intended for GObject implementations to re-enforce a floating object reference. Doing this
...
--    the object are dropped, or when this is already the last reference to the object and another reference
--    established.

--    This functionality is intended for binding object to a proxy object managed by another memory manager. This
