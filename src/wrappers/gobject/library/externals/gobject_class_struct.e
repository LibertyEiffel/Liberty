...
feature {} -- Low-level setters
   ...
   gobject_class_struct_set_construct_properties (a_structure: POINTER; a_value: POINTER) 
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "gobject_class_struct_set_construct_properties"
      }"
      end
   ...
   gobject_class_struct_set_constructor (a_structure: POINTER; a_value: POINTER) 
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "gobject_class_struct_set_constructor"
      }"
      end
   ...
   gobject_class_struct_set_set_property (a_structure: POINTER; a_value: POINTER) 
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "gobject_class_struct_set_set_property"
      }"
      end
   ...
   gobject_class_struct_set_get_property (a_structure: POINTER; a_value: POINTER) 
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "gobject_class_struct_set_get_property"
      }"
      end
   ...
   gobject_class_struct_set_dispose (a_structure: POINTER; a_value: POINTER) 
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "gobject_class_struct_set_dispose"
      }"
      end
   ...
   gobject_class_struct_set_finalize (a_structure: POINTER; a_value: POINTER) 
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "gobject_class_struct_set_finalize"
      }"
      end
   ...
   gobject_class_struct_set_dispatch_properties_changed (a_structure: POINTER; a_value: POINTER) 
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "gobject_class_struct_set_dispatch_properties_changed"
      }"
      end
   ...
   gobject_class_struct_set_notify (a_structure: POINTER; a_value: POINTER) 
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "gobject_class_struct_set_notify"
      }"
      end
   ...
   gobject_class_struct_set_constructed (a_structure: POINTER; a_value: POINTER) 
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "gobject_class_struct_set_constructed"
      }"
      end

   gobject_class_struct_set_flags (a_structure: POINTER; a_value: like long_unsigned) 
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "gobject_class_struct_set_flags"
      }"
      end
   ...
   gobject_class_struct_set_pdummy (a_structure: POINTER; a_value: POINTER) 
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "gobject_class_struct_set_pdummy"
      }"
      end
...
feature {} -- Low-level queries
   ...
   gobject_class_struct_get_construct_properties (a_structure: POINTER): POINTER 
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "gobject_class_struct_get_construct_properties"
      }"
      end
   ...
   gobject_class_struct_get_constructor (a_structure: POINTER): POINTER 
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "gobject_class_struct_get_constructor"
      }"
      end
   ...
   gobject_class_struct_get_set_property (a_structure: POINTER): POINTER 
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "gobject_class_struct_get_set_property"
      }"
      end
   ...
   gobject_class_struct_get_get_property (a_structure: POINTER): POINTER 
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "gobject_class_struct_get_get_property"
      }"
      end
   ...
   gobject_class_struct_get_dispose (a_structure: POINTER): POINTER 
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "gobject_class_struct_get_dispose"
      }"
      end
   ...
   gobject_class_struct_get_finalize (a_structure: POINTER): POINTER 
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "gobject_class_struct_get_finalize"
      }"
      end
   ...
   gobject_class_struct_get_dispatch_properties_changed (a_structure: POINTER): POINTER 
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "gobject_class_struct_get_dispatch_properties_changed"
      }"
      end
   ...
   gobject_class_struct_get_notify (a_structure: POINTER): POINTER 
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "gobject_class_struct_get_notify"
      }"
      end
   ...
   gobject_class_struct_get_constructed (a_structure: POINTER): POINTER 
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "gobject_class_struct_get_constructed"
      }"
      end

   gobject_class_struct_get_flags (a_structure: POINTER): like long_unsigned 
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "gobject_class_struct_get_flags"
      }"
      end
   ...
   gobject_class_struct_get_pdummy (a_structure: POINTER): POINTER 
      ...
      alias "{
         location: "."
         module_name: "plugin"
         feature_name: "gobject_class_struct_get_pdummy"
      }"
      end
