...
feature {ANY} -- Creation
	link_to (an_object: like object)
		...
		do
			...
			-- which no destroy_callback since the user_data, which
...
-- 	Adds a pair of notifiers which get invoked before and after the closure callback, respectively. This
...
-- 	Sets the meta marshaller of closure. A meta marshaller wraps closure->marshal and modifies the way it
...
feature {} -- Externals
	...
	g_cclosure_new (callback_func, user_data, destroy_data: POINTER): POINTER -- GClosure
		external "C use <glib-object.h>"
		end
	
	g_cclosure_new_swap (callback_func, user_data, destroy_data: POINTER): POINTER -- GClosure
		external "C use <glib-object.h>"
		end
	
	g_cclosure_new_object (callback_func, an_object: POINTER): POINTER -- GClosure
		external "C use <glib-object.h>"
		end
	
	g_cclosure_new_object_swap (callback_func, an_object: POINTER): POINTER -- GClosure
		external "C use <glib-object.h>"
		end

	g_closure_new_object (sizeof_closure: INTEGER; an_object: POINTER): POINTER -- GClosure
		-- Note: sizeof_closure is a guint/NATURAL
		external "C use <glib-object.h>"
		end

	g_closure_ref (a_closure: POINTER): POINTER -- GClosure
		external "C use <glib-object.h>"
		end
	...
	g_closure_new_simple (sizeof_closure: INTEGER; data: POINTER): POINTER -- GClosure
		-- Note sizeof_closure is a guint/NATURAL
		external "C use <glib-object.h>"
		end
...
feature {}-- GClosure struct 
	...
	-- volatile guint in_marshal : 1; Indicates whether the closure
