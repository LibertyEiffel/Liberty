...
feature {} -- External calls
   ...
   bsearch (a_key: POINTER; a_base: POINTER; a_nmemb: like long_unsigned; a_size: like long_unsigned
      a_compar: POINTER): POINTER is
         -- bsearch
      external "plug_in"
      alias "{
         location: "."
   ...
   ecvt_r (a_value: REAL; a_ndigit: INTEGER; a_decpt: POINTER; a_sign: POINTER; a_buf: POINTER
      a_len: like long_unsigned): INTEGER is
         -- ecvt_r
      external "plug_in"
      alias "{
         location: "."
   ...
   erand48_r (a_xsubi: POINTER; a_buffer: POINTER; a_result: POINTER): INTEGER is
      ...
      end -- `hidden' function _Exit skipped.
   ...
   fcvt_r (a_value: REAL; a_ndigit: INTEGER; a_decpt: POINTER; a_sign: POINTER; a_buf: POINTER
      a_len: like long_unsigned): INTEGER is
         -- fcvt_r
      external "plug_in"
      alias "{
   ...
   lcong48_r (a_param: POINTER; a_buffer: POINTER): INTEGER is
      ...
      end -- function ldiv (at line 788 in file /usr/include/stdlib.h is not wrappable
   ...
   llabs (a_x: INTEGER_64): INTEGER_64 is
      ...
      end -- function lldiv (at line 795 in file /usr/include/stdlib.h is not wrappable
   ...
   qecvt_r (a_value: REAL_EXTENDED; a_ndigit: INTEGER; a_decpt: POINTER; a_sign: POINTER; a_buf: POINTER
      a_len: like long_unsigned): INTEGER is
         -- qecvt_r
      external "plug_in"
      alias "{
   ...
   qfcvt_r (a_value: REAL_EXTENDED; a_ndigit: INTEGER; a_decpt: POINTER; a_sign: POINTER; a_buf: POINTER
      a_len: like long_unsigned): INTEGER is
         -- qfcvt_r
      external "plug_in"
      alias "{
   ...
   qsort_r (a_base: POINTER; a_nmemb: like long_unsigned; a_size: like long_unsigned; a_compar: POINTER
      an_arg: POINTER) is
         -- qsort_r
      external "plug_in"
      alias "{
   ...
   rpmatch (a_response: POINTER): INTEGER is
      ...
      end -- `hidden' function __secure_getenv skipped.
