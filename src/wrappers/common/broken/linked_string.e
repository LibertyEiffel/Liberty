...
inherit
   STRING
      redefine make, with_capacity, item, is_equal, same_as, reverse_index_of, has, occurrences, resize, clear_count, wipe_out,
         ...
         remove_last, first, last, substring, precede_multiple, precede_to_count, set_count, index_of, set_storage, get_new_iterator,
         from_external_sized, from_external_copy, from_external_sized_copy, append_substring, make_from_string, reverse,
         ensure_capacity, from_external, to_external, recycle
      end
