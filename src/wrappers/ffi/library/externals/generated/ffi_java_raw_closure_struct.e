...
-- Wrapper of struct ffi_java_raw_closure defined in file /usr/include/x86_64-linux-gnu/ffi.h line 401
...
feature {} -- Low-level setters
   ...
   ffi_java_raw_closure_struct_set_translate_args (a_structure: POINTER; a_value: POINTER) 
   ...
   ffi_java_raw_closure_struct_set_this_closure (a_structure: POINTER; a_value: POINTER) 
...
feature {} -- Low-level queries
   ...
   ffi_java_raw_closure_struct_get_translate_args (a_structure: POINTER): POINTER 
   ...
   ffi_java_raw_closure_struct_get_this_closure (a_structure: POINTER): POINTER 
