...
feature {} -- External calls
	...
	av_format_context_get_iformat (a_context: POINTER): POINTER
		external "C struct AVFormatContext get iformat use <avformat.h>"
		end

	av_format_context_get_filename (a_context: POINTER): POINTER
		external "C inline use <avformat.h>"
		alias "&(((AVFormatContext *)$a_context)->filename)"
		end

	av_format_context_get_title (a_context: POINTER): POINTER
		external "C inline use <avformat.h>"
		alias "&(((AVFormatContext *)$a_context)->title)"
		end

	av_format_context_get_author (a_context: POINTER): POINTER
		external "C inline use <avformat.h>"
		alias "&(((AVFormatContext *)$a_context)->author)"
		end

	av_format_context_get_comment (a_context: POINTER): POINTER
		external "C inline use <avformat.h>"
		alias "&(((AVFormatContext *)$a_context)->comment)"
		end

	av_format_context_get_year (a_context: POINTER): INTEGER
		external "C struct AVFormatContext get year use <avformat.h>"
		end

	av_format_context_get_track (a_context: POINTER): INTEGER
		external "C struct AVFormatContext get track use <avformat.h>"
		end

	av_format_context_get_nb_streams (a_context: POINTER): INTEGER
		external "C struct AVFormatContext get nb_streams use <avformat.h>"
		end

	av_format_context_get_start_time (a_context: POINTER): INTEGER_64
		external "C struct AVFormatContext get start_time use <avformat.h>"
		end

	av_format_context_get_duration (a_context: POINTER): INTEGER_64
		external "C struct AVFormatContext get duration use <avformat.h>"
		end

	av_format_context_get_file_size (a_context: POINTER): INTEGER_64
		external "C struct AVFormatContext get file_size use <avformat.h>"
		end

	av_format_context_get_bit_rate (a_context: POINTER): INTEGER
		external "C struct AVFormatContext get bit_rate use <avformat.h>"
		end

	av_format_context_get_stream (a_context: POINTER; a_index: INTEGER): POINTER
		external "C inline use <avformat.h>"
	...
	av_open_input_file (a_context_pointer, a_filename, a_input_format_dummy: POINTER;
						a_buffer_size_dummy: INTEGER; a_parameters: POINTER): INTEGER
		external "C use <avformat.h>"
		end

	av_close_input_file (a_context: POINTER)
		external "C use <avformat.h>"
		end

	av_find_default_stream_index (a_context: POINTER): INTEGER
		external "C use <avformat.h>"
		end

	av_find_stream_info (a_context: POINTER): INTEGER
		external "C use <avformat.h>"
		end

	av_alloc_format_context: POINTER
		external "C use <avformat.h>"
		end

	av_seek_frame (a_context: POINTER; a_stream_index: INTEGER;
					 a_timestamp: INTEGER_64; some_flags: INTEGER): INTEGER
		external "C use <avformat.h>"
		end

	av_read_frame (a_context, a_packet: POINTER): INTEGER
		external "C use <avformat.h>"
		end
