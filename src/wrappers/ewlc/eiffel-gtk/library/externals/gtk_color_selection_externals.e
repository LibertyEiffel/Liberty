...
feature {} -- Externals
	...
	gtk_color_selection_set_has_opacity_control (a_colorsel: POINTER; has_opacity_bool: INTEGER) is
	...
	gtk_color_selection_set_has_palette (a_colorsel: POINTER; has_palette_bool: INTEGER) is
	...
	gtk_color_selection_get_previous_color (a_colorsel, a_color: POINTER) is
			-- gtk_color_selection_get_previous_color (GtkColorSelection *colorsel, GdkColor *color);
		external "C use <gtk/gtk.h>"
		end

	gtk_color_selection_set_previous_color (a_colorsel, a_color: POINTER) is
