...
feature {} -- Structure getter/setter calls
	...
	--   GtkWidget *dir_list;
	get_dir_list (a_struct: POINTER): POINTER is
		external "C struct GtkFileSelection get dir_list use <gtk/gtk.h>"
		end

	set_c_dir_list (a_struct: POINTER; a_dir_list: POINTER) is
		external "C struct GtkFileSelection set dir_list use <gtk/gtk.h>"
		end
	--   GtkWidget *file_list;
	get_file_list (a_struct: POINTER): POINTER is
		external "C struct GtkFileSelection get file_list use <gtk/gtk.h>"
		end

	set_c_file_list (a_struct: POINTER; a_file_list: POINTER) is
	...
	set_c_main_vbox (a_struct: POINTER; a_main_vbox: POINTER) is
	...
	set_c_ok_button (a_struct: POINTER; a_ok_button: POINTER) is
