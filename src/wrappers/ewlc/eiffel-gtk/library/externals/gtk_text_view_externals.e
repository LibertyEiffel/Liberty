...
feature {}
	...
	gtk_text_view_get_iter_location (a_text_view: POINTER; a_const_iter: POINTER; a_gdkrectangle_location: POINTER) is
		external "C use <gtk/gtk.h>"
		end
