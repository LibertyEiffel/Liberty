...
feature {} -- External calls
	...
	gtk_font_button_set_font_name (a_font_button, a_font_name: POINTER): INTEGER is
	...
	gtk_font_button_set_show_style (a_font_button: POINTER; a_font_style: INTEGER) is
	...
	gtk_font_button_set_use_font (a_font_button: POINTER; a_use_font: INTEGER) is
	...
	gtk_font_button_set_use_size (a_font_button: POINTER; a_use_size: INTEGER) is
