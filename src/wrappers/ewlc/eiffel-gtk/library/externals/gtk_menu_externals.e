note
	...
	copyright: "Copyright (C) 2007-2022: Paolo Redaelli"
...
feature {} -- External calls
	gtk_is_menu (a_ptr: POINTER): INTEGER
	...
	gtk_menu_set_screen (a_menu: POINTER; a_gdkscreen: POINTER)
		external "C use <gtk/gtk.h>"
		end
	
	gtk_menu_reorder_child (a_menu: POINTER; a_child: POINTER; a_position: INTEGER)
		external "C use <gtk/gtk.h>"
		end
	...
	gtk_menu_popup (a_menu, parent_menu_shell, parent_menu_item, a_gtkmenupositionfunc, some_data: POINTER;
						 a_button: INTEGER; an_activate_time:  INTEGER_32)
			-- Note: a_button shall be a NATURAL
			-- Note: an_activate_time shall be a NATURAL_32
		external "C use <gtk/gtk.h>"
		end
	
	gtk_menu_set_accel_group (a_menu: POINTER; an_accel_group: POINTER)
		external "C use <gtk/gtk.h>"
		end
	...
	gtk_menu_set_accel_path (a_menu: POINTER; a_path: POINTER)
		external "C use <gtk/gtk.h>"
		end
	
	gtk_menu_set_title (a_menu: POINTER; a_title: POINTER)
		external "C use <gtk/gtk.h>"
		end
	...
	gtk_menu_popdown (a_menu: POINTER)
		external "C use <gtk/gtk.h>"
		end
	
	gtk_menu_reposition (a_menu: POINTER)
		external "C use <gtk/gtk.h>"
		end
	...
	gtk_menu_set_active (a_menu: POINTER; an_index: INTEGER)
			-- Note: an_index shall be NATURAL
		external "C use <gtk/gtk.h>"
		end
	

	gtk_menu_set_tearoff_state (a_menu: POINTER; a_torn_off: INTEGER)
		external "C use <gtk/gtk.h>"
		end
	
	gtk_menu_attach_to_widget (a_menu, an_attach_widget, a_gtk_menu_detach_func: POINTER)
		external "C use <gtk/gtk.h>"
		end
	
	gtk_menu_detach (a_menu: POINTER)
		external "C use <gtk/gtk.h>"
		end
	...
	gtk_menu_set_monitor (a_menu: POINTER; a_monitor_num: INTEGER)
		external "C use <gtk/gtk.h>"
		end
end
