...
feature {} -- enum
	...
	is_valid_gtk_file_chooser_error (a_gtk_file_chooser_error :INTEGER): BOOLEAN
		do
	...
	gtk_file_chooser_error_nonexistent: INTEGER
			-- 	Indicates that a file does not exist.
		external "C macro use <gtk/gtk.h>"
		alias "GTK_FILE_CHOOSER_ERROR_NONEXISTENT"
		end

	gtk_file_chooser_error_bad_filename: INTEGER
