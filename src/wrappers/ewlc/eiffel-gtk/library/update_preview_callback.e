note
	description: "Generic callback for the update-preview signal"
	copyright: "[
					Copyright (C) 2006-2022: eiffel-libraries team, GTK+ team and others
...
feature {ANY}
	...
	connect (an_object: GTK_FILE_CHOOSER; a_procedure: PROCEDURE [ANY, TUPLE[GTK_FILE_CHOOSER]])
		do
			debug
				print ("UPDATE_PREVIEW_CALLBACK.connect (an_object=") print (an_object.to_pointer.to_string)
	...
	signal_name: STRING is "update-preview"
