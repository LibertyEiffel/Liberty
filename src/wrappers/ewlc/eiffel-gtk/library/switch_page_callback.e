...
feature {ANY}
	callback (notebook_page: POINTER; arg1: INTEGER; instance: POINTER)
		do
			debug
	...
	connect (an_object: GTK_NOTEBOOK; a_procedure: PROCEDURE [ANY, TUPLE[GTK_NOTEBOOK_PAGE, INTEGER, GTK_NOTEBOOK]])
		do
			debug
