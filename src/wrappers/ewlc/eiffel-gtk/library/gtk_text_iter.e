...
feature {ANY}
	...
	slice (an_end: GTK_TREE_ITER): STRING
	...
	text (an_end: GTK_TREE_ITER): STRING
	...
	visible_slice (an_end: GTK_TEXT_ITER): STRING
	...
	visible_text (an_end: GTK_TEXT_ITER): STRING
	...
	toggled_tags (toggled_on: BOOLEAN): G_SLIST [GTK_TEXT_TAG]
	...
	child_anchor: GTK_TEXT_CHILD_ANCHOR
	...
	tag_begins (a_tag: GTK_TEXT_TAG): BOOLEAN
	...
	tag_ends (a_tag: GTK_TEXT_TAG): BOOLEAN
	...
	has_tag (a_tag: GTK_TEXT_TAG): BOOLEAN
	...
	is_editable (a_default_setting: BOOLEAN): BOOLEAN
	...
	can_insert (a_default_editability: BOOLEAN): BOOLEAN
	...
	attributes: GTK_TEXT_ATTRIBUTES
...
feature {ANY} -- Iterator-like 
	...
	backward_chars (a_count: INTEGER)
	...
	backward_lines (a_count: INTEGER)
	...
	forward_word_ends (a_count: INTEGER)
	...
	backward_word_starts (a_count: INTEGER)
	...
	forward_cursor_positions (a_count: INTEGER)
	...
	backward_cursor_positions (a_count: INTEGER)
			-- Moves up to `a_count' cursor positions. See
			-- `forward_cursor_position' for details.
	...
	backward_sentence_starts (a_count: INTEGER)
	...
	forward_sentence_ends (a_count: INTEGER)
	...
	forward_visible_word_ends (a_count: INTEGER)
	...
	backward_visible_word_starts (a_count: INTEGER)
	...
	forward_visible_cursor_positions (a_count: INTEGER)
	...
	backward_visible_cursor_positions (a_count: INTEGER)
			-- Moves up to `a_count' visible cursor positions. See
			-- `forward_cursor_position' for details.
	...
	forward_visible_lines (a_count: INTEGER)
	...
	backward_visible_lines (a_count: INTEGER)
	...
	set_offset (a_char_offset: INTEGER)
	...
	set_line (a_line_number: INTEGER)
	...
	set_line_offset (a_char_on_line: INTEGER)
	...
	set_line_index (a_byte_on_line: INTEGER)
	...
	set_visible_line_index (a_byte_on_line: INTEGER)
	...
	set_visible_line_offset (a_char_on_line: INTEGER)
	...
	forward_to_tag_toggle (a_tag: GTK_TEXT_TAG)
	...
	backward_to_tag_toggle (a_tag: GTK_TEXT_TAG)
	...
	forward_find_char (a_predicate: PREDICATE[TUPLE[INTEGER_32]]; a_limit: GTK_TEXT_ITER)
	...
	backward_find_char (a_predicate: PREDICATE[TUPLE[INTEGER_32]]; a_limit: GTK_TEXT_ITER)
	...
	forward_search (a_string: STRING; some_flags: INTEGER;
						 a_start_match, an_end_match, a_limit: GTK_TEXT_ITER)
...
feature {} -- External call
	...
	gtk_text_iter_free (an_iter: POINTER)
		external "C use <gtk/gtk.h>"
		end
	...
	gtk_text_iter_set_offset (an_iter: POINTER; a_char_offset: INTEGER)
		external "C use <gtk/gtk.h>"
		end

	gtk_text_iter_set_line (an_iter: POINTER; a_line_number: INTEGER)
		external "C use <gtk/gtk.h>"
		end

	gtk_text_iter_set_line_offset (an_iter: POINTER; a_char_on_line: INTEGER)
		external "C use <gtk/gtk.h>"
		end

	gtk_text_iter_set_line_index (an_iter: POINTER; a_byte_on_line: INTEGER)
		external "C use <gtk/gtk.h>"
		end

	gtk_text_iter_set_visible_line_index (an_iter: POINTER; a_byte_on_line: INTEGER)
		external "C use <gtk/gtk.h>"
		end

	gtk_text_iter_set_visible_line_offset (an_iter: POINTER; a_char_on_line: INTEGER)
		external "C use <gtk/gtk.h>"
		end

	gtk_text_iter_forward_to_end (an_iter: POINTER)
		external "C use <gtk/gtk.h>"
		end
	...
	gtk_text_iter_order (first: POINTER; an_second: POINTER)
		external "C use <gtk/gtk.h>"
		end

feature {} -- GtkTextCharPredicate callback
	hidden_callback (a_gunichar: INTEGER_32; data: POINTER): INTEGER
		external "C inline use <gtk/gtk.h>"
...
feature {}
	callback (a_unicode_character: INTEGER_32): BOOLEAN
		do
			debug
