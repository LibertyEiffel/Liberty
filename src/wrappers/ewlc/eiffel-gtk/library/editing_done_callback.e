note
	description: "Generic callback for the editing-done signal"
	copyright: "[
...
feature {ANY}
	...
	connect (an_object: GTK_CELL_EDITABLE; a_procedure: PROCEDURE [ANY, TUPLE[GTK_CELL_EDITABLE]])
		do
			debug
