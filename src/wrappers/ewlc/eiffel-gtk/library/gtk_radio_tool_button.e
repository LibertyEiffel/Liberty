...
feature {} -- Creation
	...
	from_group (a_group: G_SLIST[GTK_RADIO_TOOL_BUTTON]) is
	...
	from_stock (a_group: G_SLIST[GTK_RADIO_TOOL_BUTTON]; a_stock_id: STRING) is
	...
	from_widget (a_radio: GTK_RADIO_TOOL_BUTTON) is
	...
	from_widget_with_stock (a_radio: GTK_RADIO_TOOL_BUTTON; a_stock_id: STRING) is
			-- Creates a new GtkRadioToolButton adding it to the same
...
feature {ANY} 
	...
	set_group (a_group: G_SLIST[GTK_RADIO_TOOL_BUTTON]) is
...
feature {} -- External calls
	...
	gtk_radio_tool_button_new_from_stock (a_group, a_stock_id: POINTER): POINTER is
	...
	gtk_radio_tool_button_new_with_stock_from_widget (a_group, a_stock_id: POINTER): POINTER is
	...
	gtk_radio_tool_button_set_group (a_button, a_group: POINTER) is
