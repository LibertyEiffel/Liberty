...
feature {ANY} -- Setters
	default_create, set_gda_query_field_all_xml_load_error
		do
			value := gda_query_field_all_xml_load_error
		end

	set_gda_query_field_all_render_error
		do
...
feature {ANY} -- Queries
	is_gda_query_field_all_xml_load_error: BOOLEAN
		do
			Result := (value=gda_query_field_all_xml_load_error)
		end

	is_gda_query_field_all_render_error: BOOLEAN
		do
...
feature {WRAPPER, WRAPPER_HANDLER} -- Low level values
	gda_query_field_all_xml_load_error: INTEGER
		external "C macro use <libgda/libgda.h>"
		alias "GDA_QUERY_FIELD_ALL_XML_LOAD_ERROR"
		end

	gda_query_field_all_render_error: INTEGER
		external "C macro use <libgda/libgda.h>"
