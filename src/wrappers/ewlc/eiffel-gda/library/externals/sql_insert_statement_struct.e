...
feature {} -- Low-level setters
	low_level_set_table (a_structure: POINTER; a_value: POINTER)
	...
	low_level_set_values (a_structure: POINTER; a_value: POINTER)
		external "C struct sql_insert_statement set values use <libgda/libgda.h>"
		end

feature {} -- Low-level queries
	get_table (a_structure: POINTER): POINTER
	...
	get_values (a_structure: POINTER): POINTER
