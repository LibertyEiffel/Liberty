...
feature {ANY} -- Setters
	...
	set_gda_data_model_query_option_use_all_fields_if_no_pk
		do
			value := value.bit_or(gda_data_model_query_option_use_all_fields_if_no_pk)
		end

	unset_gda_data_model_query_option_use_all_fields_if_no_pk
		do
...
feature {ANY} -- Queries
	is_gda_data_model_query_option_use_all_fields_if_no_pk: BOOLEAN
		do
...
feature {WRAPPER, WRAPPER_HANDLER} -- Low level values
	gda_data_model_query_option_use_all_fields_if_no_pk: INTEGER
