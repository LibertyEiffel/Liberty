...
feature {ANY} -- Setters
	...
	set_gda_query_condition_renderer_error is
		do
			value := gda_query_condition_renderer_error
		end

	set_gda_query_condition_parent_error is
		do
...
feature {ANY} -- Queries
	...
	is_gda_query_condition_renderer_error: BOOLEAN is
		do
			Result := (value=gda_query_condition_renderer_error)
		end

	is_gda_query_condition_parent_error: BOOLEAN is
		do
