...
feature {} -- Low-level setters
	low_level_set_order_type (a_structure: POINTER; a_value: INTEGER_32) is
		external "C struct sql_order_field set order_type use <libgda/libgda.h>"
		end

	low_level_set_name (a_structure: POINTER; a_value: POINTER) is
		external "C struct sql_order_field set name use <libgda/libgda.h>"
		end

feature {} -- Low-level queries
	get_order_type (a_structure: POINTER): INTEGER_32 is
		external "C struct sql_order_field get order_type use <libgda/libgda.h>"
		end

	get_name (a_structure: POINTER): POINTER is
