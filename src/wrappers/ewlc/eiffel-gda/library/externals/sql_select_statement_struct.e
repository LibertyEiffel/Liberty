...
feature {} -- Low-level setters
	low_level_set_distinct (a_structure: POINTER; a_value: INTEGER_32) is
	...
	low_level_set_from_external (a_structure: POINTER; a_value: POINTER) is
	...
	low_level_set_order (a_structure: POINTER; a_value: POINTER) is
		external "C struct sql_select_statement set order use <libgda/libgda.h>"
		end

	low_level_set_group (a_structure: POINTER; a_value: POINTER) is
		external "C struct sql_select_statement set group use <libgda/libgda.h>"
		end

feature {} -- Low-level queries
	get_distinct (a_structure: POINTER): INTEGER_32 is
	...
	get_from_external (a_structure: POINTER): POINTER is
	...
	get_order (a_structure: POINTER): POINTER is
		external "C struct sql_select_statement get order use <libgda/libgda.h>"
		end

	get_group (a_structure: POINTER): POINTER is
