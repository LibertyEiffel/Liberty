...
feature {} -- External calls
	...
	gda_server_provider_create_parser (a_provider: POINTER; a_cnc: POINTER): POINTER is
	...
	gda_server_provider_get_name (a_provider: POINTER): POINTER is
		external "C use <library/externals/all-gda-includes.h>"
		end
	...
	gda_server_provider_error_quark: INTEGER_32 is
		external "C use <library/externals/all-gda-includes.h>"
		end
