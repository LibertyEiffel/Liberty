...
feature {} -- External calls
	...
	gda_query_target_set_alias (a_target: POINTER; an_alias: POINTER) is
		external "C use <libgda/libgda.h>"
		end
	...
	gda_query_target_new (a_query: POINTER; a_table: POINTER): POINTER is
		external "C use <libgda/libgda.h>"
		end

	gda_query_target_get_type: INTEGER_32 is
		external "C use <libgda/libgda.h>"
		end

	gda_query_target_error_quark: INTEGER_32 is
		external "C use <libgda/libgda.h>"
		end
