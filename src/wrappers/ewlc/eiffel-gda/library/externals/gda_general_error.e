...
feature {ANY} -- Setters
	default_create, set_gda_general_object_name_error
		do
			value := gda_general_object_name_error
		end

	set_gda_general_incorrect_value_error
		do
			value := gda_general_incorrect_value_error
		end

	set_gda_general_operation_error
		do
...
feature {ANY} -- Queries
	is_gda_general_object_name_error: BOOLEAN
		do
			Result := (value=gda_general_object_name_error)
		end

	is_gda_general_incorrect_value_error: BOOLEAN
		do
			Result := (value=gda_general_incorrect_value_error)
		end

	is_gda_general_operation_error: BOOLEAN
		do
...
feature {WRAPPER, WRAPPER_HANDLER} -- Low level values
	gda_general_object_name_error: INTEGER
		external "C macro use <libgda/libgda.h>"
		alias "GDA_GENERAL_OBJECT_NAME_ERROR"
		end

	gda_general_incorrect_value_error: INTEGER
		external "C macro use <libgda/libgda.h>"
		alias "GDA_GENERAL_INCORRECT_VALUE_ERROR"
		end

	gda_general_operation_error: INTEGER
		external "C macro use <libgda/libgda.h>"
