...
feature {WRAPPER, WRAPPER_HANDLER} -- Low level values
	gda_server_operation_create_db: INTEGER
		external "C macro use <library/externals/all-gda-includes.h>"
		alias "GDA_SERVER_OPERATION_CREATE_DB"
		end

	gda_server_operation_drop_db: INTEGER
		external "C macro use <library/externals/all-gda-includes.h>"
		alias "GDA_SERVER_OPERATION_DROP_DB"
		end

	gda_server_operation_create_table: INTEGER
		external "C macro use <library/externals/all-gda-includes.h>"
		alias "GDA_SERVER_OPERATION_CREATE_TABLE"
		end

	gda_server_operation_drop_table: INTEGER
		external "C macro use <library/externals/all-gda-includes.h>"
		alias "GDA_SERVER_OPERATION_DROP_TABLE"
		end

	gda_server_operation_rename_table: INTEGER
		external "C macro use <library/externals/all-gda-includes.h>"
		alias "GDA_SERVER_OPERATION_RENAME_TABLE"
		end

	gda_server_operation_add_column: INTEGER
		external "C macro use <library/externals/all-gda-includes.h>"
		alias "GDA_SERVER_OPERATION_ADD_COLUMN"
		end

	gda_server_operation_drop_column: INTEGER
		external "C macro use <library/externals/all-gda-includes.h>"
		alias "GDA_SERVER_OPERATION_DROP_COLUMN"
		end

	gda_server_operation_create_index: INTEGER
		external "C macro use <library/externals/all-gda-includes.h>"
		alias "GDA_SERVER_OPERATION_CREATE_INDEX"
		end

	gda_server_operation_drop_index: INTEGER
		external "C macro use <library/externals/all-gda-includes.h>"
		alias "GDA_SERVER_OPERATION_DROP_INDEX"
		end

	gda_server_operation_create_view: INTEGER
		external "C macro use <library/externals/all-gda-includes.h>"
		alias "GDA_SERVER_OPERATION_CREATE_VIEW"
		end

	gda_server_operation_drop_view: INTEGER
		external "C macro use <library/externals/all-gda-includes.h>"
		alias "GDA_SERVER_OPERATION_DROP_VIEW"
		end

	gda_server_operation_last: INTEGER
		external "C macro use <library/externals/all-gda-includes.h>"
