...
feature {WRAPPER, WRAPPER_HANDLER} -- Low level values
	gda_data_model_query_xml_load_error: INTEGER
		external "C macro use <library/externals/all-gda-includes.h>"
		alias "GDA_DATA_MODEL_QUERY_XML_LOAD_ERROR"
		end

	gda_data_model_query_compute_modif_statements_error: INTEGER
		external "C macro use <library/externals/all-gda-includes.h>"
		alias "GDA_DATA_MODEL_QUERY_COMPUTE_MODIF_STATEMENTS_ERROR"
		end

	gda_data_model_query_modif_statement_error: INTEGER
		external "C macro use <library/externals/all-gda-includes.h>"
		alias "GDA_DATA_MODEL_QUERY_MODIF_STATEMENT_ERROR"
		end

	gda_data_model_query_connection_error: INTEGER
		external "C macro use <library/externals/all-gda-includes.h>"
