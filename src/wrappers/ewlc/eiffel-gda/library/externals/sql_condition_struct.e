...
feature {} -- Low-level setters
	low_level_set_op (a_structure: POINTER; a_value: INTEGER_32)
		external "C struct sql_condition set op use <libgda/libgda.h>"
		end

	low_level_set_negated (a_structure: POINTER; a_value: INTEGER_32)
		external "C struct sql_condition set negated use <libgda/libgda.h>"
		end

feature {} -- Low-level queries
	get_op (a_structure: POINTER): INTEGER_32
		external "C struct sql_condition get op use <libgda/libgda.h>"
		end

	get_negated (a_structure: POINTER): INTEGER_32
