...
feature {ANY} -- Setters
	...
	set_provider_not_found_error is
		do
			value := gda_connection_provider_not_found_error
		end

	set_provider_error is
		do
...
feature {ANY} -- Queries
	...
	is_provider_not_found_error: BOOLEAN is
		do
			Result := (value=gda_connection_provider_not_found_error)
		end

	is_provider_error: BOOLEAN is
		do
	...
	is_statement_type_error: BOOLEAN is
		do
...
feature {WRAPPER, WRAPPER_HANDLER} -- Low level values
	gda_connection_dsn_not_found_error: INTEGER is
		external "C macro use <library/externals/all-gda-includes.h>"
		alias "GDA_CONNECTION_DSN_NOT_FOUND_ERROR"
		end

	gda_connection_provider_not_found_error: INTEGER is
		external "C macro use <library/externals/all-gda-includes.h>"
		alias "GDA_CONNECTION_PROVIDER_NOT_FOUND_ERROR"
		end

	gda_connection_provider_error: INTEGER is
		external "C macro use <library/externals/all-gda-includes.h>"
	...
	gda_connection_statement_type_error: INTEGER is
		external "C macro use <library/externals/all-gda-includes.h>"
