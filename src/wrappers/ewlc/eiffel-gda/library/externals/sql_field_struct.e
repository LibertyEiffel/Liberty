...
feature {} -- Low-level setters
	low_level_set_item (a_structure: POINTER; a_value: POINTER)
	...
	low_level_set_param_spec (a_structure: POINTER; a_value: POINTER)
		external "C struct sql_field set param_spec use <libgda/libgda.h>"
		end

feature {} -- Low-level queries
	get_item (a_structure: POINTER): POINTER
	...
	get_param_spec (a_structure: POINTER): POINTER
