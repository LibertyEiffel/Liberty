note
	description: "."
	copyright: "[
					Copyright (C) 2007 Paolo Redaelli, GtkSource developers
...
feature {} -- Creation
	...
	from_buffer (a_buffer: GTK_SOURCE_BUFFER) is
...
feature {ANY} -- Setters
	...
	set_show_line_markers (a_setting: BOOLEAN) is
	...
	set_tabs_width (a_width: INTEGER) is
	...
	set_auto_indent (a_setting: BOOLEAN) is
	...
	set_insert_spaces_instead_of_tabs (a_setting: BOOLEAN) is
	...
	set_indent_on_tab (a_setting: BOOLEAN) is
	...
	set_show_margin (a_setting: BOOLEAN) is
	...
	set_margin (a_margin: INTEGER) is
	...
	set_highlight_current_line (a_setting: BOOLEAN) is
	...
	set_marker_pixbuf (a_marker_type: STRING; a_pixbuf: GDK_PIXBUF) is
	...
	set_smart_home_end (a_setting: BOOLEAN) is
...
feature {ANY} -- Getters
	...
	are_line_markers_show: BOOLEAN is
	...
	is_smart_home_end_set: BOOLEAN is	
...
feature {ANY} -- Style Properties
	...
	right_margin_line_color: GDK_COLOR is
	...
	right_margin_overlay_alpha: INTEGER is
...
feature {} -- External calls
	...
	gtk_source_view_new: POINTER is
	...
	gtk_source_view_set_show_line_numbers (a_view: POINTER; a_show_bool: INTEGER) is
			-- void gtk_source_view_set_show_line_numbers (GtkSourceView *view,
			-- gboolean show);
		external "C use <gtksourceview/gtksourceview.h>"
		end

	gtk_source_view_get_show_line_numbers (a_view: POINTER): INTEGER is
			-- gboolean gtk_source_view_get_show_line_numbers (GtkSourceView
			-- *view);
		external "C use <gtksourceview/gtksourceview.h>"
		end

	gtk_source_view_set_show_line_markers (a_view: POINTER; a_show_bool: INTEGER) is
			-- void gtk_source_view_set_show_line_markers (GtkSourceView *view,
			-- gboolean show);
		external "C use <gtksourceview/gtksourceview.h>"
		end

	gtk_source_view_get_show_line_markers (a_view: POINTER): INTEGER is
			-- gboolean gtk_source_view_get_show_line_markers (GtkSourceView
			-- *view);
		external "C use <gtksourceview/gtksourceview.h>"
		end

	gtk_source_view_set_tabs_width (a_view: POINTER; a_width: INTEGER) is
			-- void gtk_source_view_set_tabs_width (GtkSourceView *view, guint
			-- width);
		external "C use <gtksourceview/gtksourceview.h>"
		end

	gtk_source_view_get_tabs_width (a_view: POINTER): INTEGER is
			-- 	guint gtk_source_view_get_tabs_width (GtkSourceView *view);
		external "C use <gtksourceview/gtksourceview.h>"
		end

	gtk_source_view_set_auto_indent (a_view: POINTER; an_enable_bool: INTEGER) is
			-- void gtk_source_view_set_auto_indent (GtkSourceView *view, gboolean
			-- enable);
		external "C use <gtksourceview/gtksourceview.h>"
		end

	gtk_source_view_get_auto_indent (a_view: POINTER): INTEGER is
			-- gboolean gtk_source_view_get_auto_indent (GtkSourceView *view);
		external "C use <gtksourceview/gtksourceview.h>"
		end

	gtk_source_view_set_insert_spaces_instead_of_tabs (a_view: POINTER; an_enable: INTEGER) is
			-- void gtk_source_view_set_insert_spaces_instead_of_tabs
			-- (GtkSourceView *view, gboolean enable);
		external "C use <gtksourceview/gtksourceview.h>"
		end

	gtk_source_view_get_insert_spaces_instead_of_tabs (a_view: POINTER): INTEGER is
			-- gboolean gtk_source_view_get_insert_spaces_instead_of_tabs
			-- (GtkSourceView *view);
		external "C use <gtksourceview/gtksourceview.h>"
		end

	gtk_source_view_set_indent_on_tab (a_view: POINTER; an_enable_bool: INTEGER) is
			-- void gtk_source_view_set_indent_on_tab (GtkSourceView *view,
			-- gboolean enable);
		external "C use <gtksourceview/gtksourceview.h>"
		end

	gtk_source_view_get_indent_on_tab (a_view: POINTER): INTEGER is
			-- gboolean gtk_source_view_get_indent_on_tab (GtkSourceView *view);
		external "C use <gtksourceview/gtksourceview.h>"
		end

	gtk_source_view_set_show_margin (a_view: POINTER; a_show_bool: INTEGER) is
			-- void gtk_source_view_set_show_margin (GtkSourceView *view, gboolean
			-- show);
		external "C use <gtksourceview/gtksourceview.h>"
		end

	gtk_source_view_get_show_margin (a_view: POINTER): INTEGER is
			-- gboolean gtk_source_view_get_show_margin (GtkSourceView *view);
		external "C use <gtksourceview/gtksourceview.h>"
		end

	gtk_source_view_set_margin (a_view: POINTER; a_margin: INTEGER) is
			-- void gtk_source_view_set_margin (GtkSourceView *view, guint margin);
		external "C use <gtksourceview/gtksourceview.h>"
		end

	gtk_source_view_get_margin (a_view: POINTER): INTEGER is
			-- guint gtk_source_view_get_margin (GtkSourceView *view);
		external "C use <gtksourceview/gtksourceview.h>"
		end

	gtk_source_view_set_highlight_current_line (a_view: POINTER; a_show_bool: INTEGER) is
			-- void gtk_source_view_set_highlight_current_line (GtkSourceView
			-- *view, gboolean show);
		external "C use <gtksourceview/gtksourceview.h>"
		end

	gtk_source_view_get_highlight_current_line (a_view: POINTER): INTEGER is
			-- gboolean gtk_source_view_get_highlight_current_line (GtkSourceView
			-- *view);
		external "C use <gtksourceview/gtksourceview.h>"
		end

	gtk_source_view_set_marker_pixbuf (a_view, a_marker_type, a_pixbuf: POINTER) is
	...
	gtk_source_view_set_smart_home_end (a_view: POINTER; a_enable_bool: INTEGER) is
