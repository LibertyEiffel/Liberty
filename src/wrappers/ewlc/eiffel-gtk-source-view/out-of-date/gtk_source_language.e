...
feature {ANY} 
	...
	tags: G_SLIST[GTK_SOURCE_LANGUAGE] is
	...
	set_mime_types (some_mime_types: G_SLIST_STRING) is
	...
	style_scheme: GTK_SOURCE_STYLE_SCHEME is
	...
	set_tag_style (a_tag_id: STRING; a_style: GTK_SOURCE_TAG_STYLE) is
...
feature {} -- External calls
	...
	gtk_source_language_get_name (a_language: POINTER): POINTER is
			--  gchar* gtk_source_language_get_name (GtkSourceLanguage *language);
		external "C use <gtksourceview/gtksourcelanguage.h>"
		end
	
	gtk_source_language_get_section (a_language: POINTER): POINTER is
			--  gchar* gtk_source_language_get_section (GtkSourceLanguage *language);
		external "C use <gtksourceview/gtksourcelanguage.h>"
		end

	gtk_source_language_get_tags (a_language: POINTER): POINTER is
