...
feature {} -- Creation
	...
	--   Link: Using the GConf library (next)
	...
	--                a dynamically-typed value. A GConfEntry stores a key-value
	--                pair. A GConfMetaInfo stores metainformation about a key.
	--
	--                GConf Core Interfaces -- Basic functions to initialize GConf
	--                and get/set values
	--
	--                gconf-locale
	--
