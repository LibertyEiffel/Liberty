		...
		do
			std_error.put_line(once "[
		      ...
		      --typedefs CLASS_NAME 
				  ...
				  this option is not given all typedefs referreing to
				  fundamental types will be resolved to its referred type
				  everytime is used; while being easier to understand and
				  implement it raises issues in cases of 32-64 bit mismatches.
