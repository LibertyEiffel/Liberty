...
feature {} -- External calls
	cairo_pdf_surface_create (a_filename: POINTER; a_width_in_points, an_height_in_points: REAL): POINTER is
	...
	cairo_pdf_surface_create_for_stream (a_write_func, a_closure: POINTER; a_width_in_points, an_height_in_points: REAL): POINTER is
	...
	cairo_pdf_surface_set_size (a_surface: POINTER; a_width_in_points, an_height_in_points: REAL) is
