...
feature {ANY}  -- enum
	...
	cairo_operator_clear: INTEGER is
			-- CAIRO_OPERATOR_CLEAR
		external "C macro use <pango.h>"
		alias "CAIRO_OPERATOR_CLEAR"
		end
	
	cairo_operator_source: INTEGER is
			-- CAIRO_OPERATOR_SOURCE
		external "C macro use <pango.h>"
		alias "CAIRO_OPERATOR_SOURCE"
		end

	cairo_operator_over: INTEGER is
			-- CAIRO_OPERATOR_OVER
		external "C macro use <pango.h>"
		alias "CAIRO_OPERATOR_OVER"
		end

	cairo_operator_in: INTEGER is
			-- CAIRO_OPERATOR_IN
		external "C macro use <pango.h>"
		alias "CAIRO_OPERATOR_IN"
		end
	
	cairo_operator_out: INTEGER is
			-- CAIRO_OPERATOR_OUT
		external "C macro use <pango.h>"
		alias "CAIRO_OPERATOR_OUT"
		end

	cairo_operator_atop: INTEGER is
			-- CAIRO_OPERATOR_ATOP
		external "C macro use <pango.h>"
		alias "CAIRO_OPERATOR_ATOP"
		end

	cairo_operator_dest: INTEGER is
			-- CAIRO_OPERATOR_DEST
		external "C macro use <pango.h>"
		alias "CAIRO_OPERATOR_DEST"
		end
	
	cairo_operator_dest_over: INTEGER is
			-- CAIRO_OPERATOR_DEST_OVER
		external "C macro use <pango.h>"
		alias "CAIRO_OPERATOR_DEST_OVER"
		end

	cairo_operator_dest_in: INTEGER is
			-- CAIRO_OPERATOR_DEST_IN
		external "C macro use <pango.h>"
		alias "CAIRO_OPERATOR_DEST_IN"
		end

	cairo_operator_dest_out: INTEGER is
			-- CAIRO_OPERATOR_DEST_OUT
		external "C macro use <pango.h>"
		alias "CAIRO_OPERATOR_DEST_OUT"
		end

	cairo_operator_dest_atop: INTEGER is
			-- CAIRO_OPERATOR_DEST_ATOP
		external "C macro use <pango.h>"
		alias "CAIRO_OPERATOR_DEST_ATOP"
		end

	cairo_operator_xor: INTEGER is
			-- CAIRO_OPERATOR_XOR
		external "C macro use <pango.h>"
		alias "CAIRO_OPERATOR_XOR"
		end

	cairo_operator_add: INTEGER is
			-- CAIRO_OPERATOR_ADD
		external "C macro use <pango.h>"
		alias "CAIRO_OPERATOR_ADD"
		end

	cairo_operator_saturate: INTEGER is
