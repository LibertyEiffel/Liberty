...
-- GtsSurface;
	...
	gts_surface_class: POINTER
			-- GtsSurfaceClass* gts_surface_class (void);
		external "C use <gts.h>"
		end

	gts_surface_new (a_klass, a_face_class, a_edge_class, a_vertex_class: POINTER): POINTER
	...
	gts_surface_add_face (an_s, a_f: POINTER)
			-- void gts_surface_add_face (GtsSurface *s, GtsFace *f);
		external "C use <gts.h>"
		end

	gts_surface_remove_face (an_s, a_f: POINTER)
			-- void gts_surface_remove_face (GtsSurface *s, GtsFace *f);
		external "C use <gts.h>"
		end

	gts_surface_copy (an_s1, an_s2: POINTER)
	...
	gts_surface_merge (an_s, a_with: POINTER)
			-- void gts_surface_merge (GtsSurface *s, GtsSurface *with);
		external "C use <gts.h>"
		end

	gts_surface_read (a_surface, a_f: POINTER): INTEGER
	...
	gts_surface_is_manifold (a_s: POINTER): INTEGER
			-- gboolean gts_surface_is_manifold (GtsSurface *s);
		external "C use <gts.h>"
		end

	gts_surface_is_orientable (a_s: POINTER): INTEGER
			-- gboolean gts_surface_is_orientable (GtsSurface *s);
		external "C use <gts.h>"
		end

	gts_surface_is_closed (a_s: POINTER): INTEGER
			-- gboolean gts_surface_is_closed (GtsSurface *s);
		external "C use <gts.h>"
		end

	gts_surface_vertex_number (a_s: POINTER): INTEGER
	...
	gts_surface_edge_number (a_s: POINTER): INTEGER
	...
	gts_surface_face_number (a_s: POINTER): INTEGER
	...
	gts_surface_foreach_vertex (a_s, a_func, some_data: POINTER)
			-- void gts_surface_foreach_vertex (GtsSurface *s, GtsFunc
			-- func, gpointer data);
		external "C use <gts.h>"
		end

	gts_surface_foreach_edge (a_s, a_func, some_data: POINTER)
			-- void gts_surface_foreach_edge (GtsSurface *s, GtsFunc func, gpointer data);
		external "C use <gts.h>"
		end

	gts_surface_foreach_face (a_s, a_func, some_data: POINTER)
			-- void gts_surface_foreach_face (GtsSurface *s, GtsFunc func, gpointer data);
		external "C use <gts.h>"
		end

	gts_surface_foreach_face_remove (a_s, a_func, some_data: POINTER): INTEGER
	...
	gts_surface_foreach_intersecting_face(an_s, a_gts_bb_tree_traverse_func, some_data: POINTER): INTEGER
			-- gboolean gts_surface_foreach_intersecting_face(GtsSurface
			-- *s, GtsBBTreeTraverseFunc func, gpointer data);
		external "C use <gts.h>"
		end
	
	gts_surface_distance (a_s1, a_s2: POINTER; a_delta: REAL; a_face_range, a_boundary_range: POINTER)
	...
	gts_surface_strip (a_s: POINTER): POINTER
			-- GSList* gts_surface_strip (GtsSurface *s);
		external "C use <gts.h>"
		end

	gts_surface_tessellate (a_s, a_refine_func, some_refine_data: POINTER)
			-- void gts_surface_tessellate (GtsSurface *s, GtsRefineFunc refine_func, gpointer refine_data);
		external "C use <gts.h>"
		end

	gts_surface_generate_sphere (a_s: POINTER; a_geodesation_order: INTEGER): POINTER
	...
	gts_surface_split (a_s: POINTER): POINTER
			-- GSList* gts_surface_split (GtsSurface *s);
		external "C use <gts.h>"
		end

feature {} -- External calls for boolean operations
	gts_surface_intersection (a_surface, another_surface, a_faces_tree, another_faces_tree: POINTER): POINTER
