...
feature {} -- External calls
	...
	gts_psurface_is_closed (a_pointer: POINTER): INTEGER is
		external "C macro use <gts.h>"
		alias "GTS_PSURFACE_IS_CLOSED"
		end


	gts_psurface_class: POINTER is
			-- GtsPSurfaceClass* gts_psurface_class (void);
		external "C use <gts.h>"
		end

	gts_psurface_new (a_klass, a_surface, a_split_class, a_const_func, some_cost_data, a_coarsen_func, some_coarsen_data, a_stop_func, some_stop_data: POINTER; a_min_angle: REAL): POINTER is
	...
	gts_psurface_add_vertex (a_ps: POINTER): POINTER is
			-- GtsSplit* gts_psurface_add_vertex (GtsPSurface *ps);
		external "C use <gts.h>"
		end

	gts_psurface_remove_vertex (a_ps: POINTER): POINTER is
			-- GtsSplit* gts_psurface_remove_vertex (GtsPSurface *ps);
		external "C use <gts.h>"
		end

	gts_psurface_set_vertex_number (a_ps: POINTER; an_n: INTEGER) is
	...
	gts_psurface_get_vertex_number (a_ps: POINTER): INTEGER is
	...
	gts_psurface_min_vertex_number (a_ps: POINTER): INTEGER is
	...
	gts_psurface_max_vertex_number (a_ps: POINTER): INTEGER is
