...
feature {} -- External calls
	...
	gts_bbox_new (a_klass, a_bounded: POINTER;  a_x1, a_y1, a_z1, a_x2, a_y2, a_z2: REAL): POINTER
	...
	gts_bbox_set (a_bbox, a_bounded: POINTER; a_x1, a_y1, a_z1, a_x2, a_y2, a_z2: REAL)
	...
	gts_bbox_segment (a_class, a_s: POINTER): POINTER
			-- GtsBBox* gts_bbox_segment (GtsBBoxClass *klass, GtsSegment
			-- *s);
		external "C use <gts.h>"
		end

	gts_bbox_triangle (a_class, a_t: POINTER): POINTER
			-- GtsBBox* gts_bbox_triangle (GtsBBoxClass *klass,
			-- GtsTriangle *t);
		external "C use <gts.h>"
		end

	gts_bbox_surface (a_class, a_surface: POINTER): POINTER
			-- GtsBBox* gts_bbox_surface (GtsBBoxClass *klass, GtsSurface
			-- *surface);
		external "C use <gts.h>"
		end

	gts_bbox_points (a_class, a_points: POINTER): POINTER
			-- GtsBBox* gts_bbox_points (GtsBBoxClass *klass, GSList
			-- *points);
		external "C use <gts.h>"
		end

	gts_bbox_bboxes (a_class, a_bboxes: POINTER): POINTER
	...
	gts_bbox_point_distance2 (a_bb, a_p, a_min, a_max: POINTER)
			-- void gts_bbox_point_distance2 (GtsBBox *bb, GtsPoint *p,
			-- gdouble *min, gdouble *max);
		external "C use <gts.h>"
		end

	gts_bbox_is_stabbed (a_bb, a_p: POINTER): INTEGER
			-- gboolean gts_bbox_is_stabbed (GtsBBox *bb, GtsPoint *p);
		external "C use <gts.h>"
		end

	gts_bbox_overlaps_triangle (a_bb, a_t: POINTER): INTEGER
	...
	gts_bb_tree_new (a_bboxes: POINTER): POINTER
			-- GNode* gts_bb_tree_new (GSList *bboxes);
		external "C use <gts.h>"
		end

	gts_bb_tree_surface (a_s: POINTER): POINTER
			-- GNode* gts_bb_tree_surface (GtsSurface *s);
		external "C use <gts.h>"
		end

	gts_bb_tree_overlap (a_tree, a_bbox: POINTER): POINTER
			-- GSList* gts_bb_tree_overlap (GNode *tree, GtsBBox *bbox);
		external "C use <gts.h>"
		end

	gts_bb_tree_is_overlapping (a_tree, a_bbox: POINTER): INTEGER
			-- gboolean gts_bb_tree_is_overlapping (GNode *tree, GtsBBox
			-- *bbox);
		external "C use <gts.h>"
		end

	gts_bb_tree_traverse_overlapping (a_tree1, a_tree2, a_gtsbbtreetraversefunc, some_data: POINTER)
			-- void gts_bb_tree_traverse_overlapping (GNode *tree1, GNode
			-- *tree2, GtsBBTreeTraverseFunc func, gpointer data);
		external "C use <gts.h>"
		end

	gts_bb_tree_draw (a_tree: POINTER; a_depth: INTEGER; a_fptr: POINTER)
	...
	gts_bb_tree_destroy (a_tree: POINTER; free_leaves: INTEGER)
	...
	-- GtsPoint* (*GtsBBoxClosestFunc) (GtsPoint *p, gpointer bounded);
	 ...
	 gts_bb_tree_point_distance (a_tree, a_p, a_gts_bbox_distance_func, bbox_ptr: POINTER): REAL
			-- gdouble gts_bb_tree_point_distance (GNode *tree, GtsPoint *p, GtsBBoxDistFunc distance, GtsBBox **bbox);
		external "C use <gts.h>"
		end

	gts_bb_tree_point_closest (a_tree, a_p, a_gts_bbox_closest_func, a_distance: POINTER): POINTER
			-- GtsPoint* gts_bb_tree_point_closest (GNode *tree, GtsPoint
			-- *p, GtsBBoxClosestFunc closest, gdouble *distance);
		external "C use <gts.h>"
		end

	gts_bb_tree_segment_distance (a_tree, a_s, a_gts_bboxdistance_func: POINTER; a_delta: REAL; a_range: POINTER)
	...
	gts_bb_tree_triangle_distance (a_tree, a_t, a_gts_bbox_distance_func: POINTER; a_delta: REAL; a_range: POINTER)
	...
	gts_bb_tree_point_closest_bboxes (a_tree, a_p: POINTER): POINTER
			-- GSList* gts_bb_tree_point_closest_bboxes(GNode *tree,
			-- GtsPoint *p);
		external "C use <gts.h>"
		end

	gts_bb_tree_surface_boundary_distance (a_tree, a_s, a_gtsbboxdistfunc: POINTER; a_delta: REAL; a_range: POINTER)
	...
	gts_bb_tree_surface_distance (a_tree, a_s, a_gtsbboxdistfunc: POINTER; a_delta: REAL; a_range: POINTER)
	...
	gts_bb_tree_stabbed (a_tree, a_p: POINTER): POINTER
