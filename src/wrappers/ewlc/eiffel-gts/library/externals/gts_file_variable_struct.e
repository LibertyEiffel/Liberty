...
feature {} -- Structure getter/setter calls
   ...
   -- GtsTokenType type;
	...
	-- gboolean unique;
    get_unique (a_struct: POINTER): INTEGER is
		external "C struct GtsFileVariable get unique use <gts.h>"
		end

	set_unique (a_struct: POINTER; a_unique: INTEGER) is
