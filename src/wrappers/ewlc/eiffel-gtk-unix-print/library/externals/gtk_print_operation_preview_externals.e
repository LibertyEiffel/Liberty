...
feature {} -- External calls
	gtk_print_operation_preview_end_preview (a_preview: POINTER)
			-- void gtk_print_operation_preview_end_preview (GtkPrintOperationPreview *preview);
		external "C use <gtk/gtk.h>"
		end
	
	gtk_print_operation_preview_is_selected (a_preview: POINTER; a_page_nr: INTEGER): INTEGER
			-- gboolean gtk_print_operation_preview_is_selected (GtkPrintOperationPreview *preview, gint page_nr);
		external "C use <gtk/gtk.h>"
		end

	gtk_print_operation_preview_render_page (a_preview: POINTER; a_page_nr: INTEGER)
