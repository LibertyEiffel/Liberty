...
feature {} -- External calls
	g_main_loop_new (a_context: POINTER; is_running_bool: INTEGER): POINTER
			-- GMainLoop* g_main_loop_new (GMainContext *context, gboolean is_running);
		external "C use <glib.h>"
		end

	g_main_loop_ref (a_loop: POINTER): POINTER
			-- GMainLoop* g_main_loop_ref (GMainLoop *loop);
		external "C use <glib.h>"
		end

	g_main_loop_unref (a_loop: POINTER)
			-- void g_main_loop_unref (GMainLoop *loop);
		external "C use <glib.h>"
		end

	g_main_loop_run (a_loop: POINTER)
			-- void g_main_loop_run (GMainLoop *loop);
		external "C use <glib.h>"
		end

	g_main_loop_quit (a_loop: POINTER)
			-- void g_main_loop_quit (GMainLoop *loop);
		external "C use <glib.h>"
		end

	g_main_loop_is_running (a_loop: POINTER): INTEGER
			-- gboolean g_main_loop_is_running (GMainLoop *loop);
		external "C use <glib.h>"
		end

	g_main_loop_get_context (a_loop: POINTER): POINTER
	...
	g_main_context_iteration (a_context: POINTER; may_block_bool: INTEGER): INTEGER
	...
	g_main_context_find_source_by_id (a_context: POINTER; a_source_id: INTEGER): POINTER
	...
	g_main_context_find_source_by_user_data (a_context, some_data: POINTER): POINTER
			-- GSource* g_main_context_find_source_by_user_data (GMainContext *context, gpointer user_data);
		external "C use <glib.h>"
		end

	g_main_context_find_source_by_funcs_user_data (a_context, a_funcs, some_data: POINTER): POINTER
	...
	g_main_context_wait (a_context, a_cond, a_mutex: POINTER): INTEGER
			-- gboolean g_main_context_wait (GMainContext *context, GCond *cond, GMutex *mutex);
		external "C use <glib.h>"
		end

	g_main_context_prepare (a_context, a_priority_ptr: POINTER): INTEGER
			-- gboolean g_main_context_prepare (GMainContext *context, gint *priority);
		external "C use <glib.h>"
		end
	
	g_main_context_query (a_context: POINTER; a_max_priority: INTEGER; a_timeout_ptr, a_fds: POINTER; a_n_fds: POINTER): INTEGER
			-- gint g_main_context_query (GMainContext *context, gint
			-- max_priority, gint *timeout_, GPollFD *fds, gint n_fds);
		external "C use <glib.h>"
		end

	g_main_context_check (a_context: POINTER; a_max_priority: INTEGER; a_fds: POINTER; an_n_fds: INTEGER): POINTER
	...
	g_main_context_set_poll_func (a_context, a_func: POINTER)
	...
	g_main_context_add_poll (a_context, an_fd: POINTER; a_priority: INTEGER)
			-- void g_main_context_add_poll (GMainContext *context, GPollFD *fd, gint priority);
		external "C use <glib.h>"
		end

	g_main_context_remove_poll (a_context, an_fd: POINTER)
	...
	g_idle_add_full (a_priority: INTEGER; a_function, some_data, a_gdestroynotify: POINTER): INTEGER
	...
	g_idle_remove_by_data (some_data: POINTER): INTEGER
	...
	g_source_new (a_source_funcs: POINTER; a_struct_size: INTEGER): POINTER
	...
	g_source_attach (a_source, a_g_main_context: POINTER): INTEGER
	...
	g_source_set_can_recurse (a_source: POINTER; can_recurse_bool: INTEGER)
	...
	g_source_get_id (a_source: POINTER): INTEGER
	...
	g_source_set_callback (a_source, a_source_func, some_data, a_destroy_notify: POINTER)
	...
	g_source_set_callback_indirect (a_source, a_callback_data, a_gsourcecallbackfuncs: POINTER)
	...
	g_source_add_poll (a_source, an_fd: POINTER)
			-- void g_source_add_poll (GSource *source, GPollFD *fd);
		external "C use <glib.h>"
		end

	g_source_remove_poll (a_source, an_fd: POINTER)
			-- void g_source_remove_poll (GSource *source, GPollFD *fd);
		external "C use <glib.h>"
		end

	g_source_get_current_time (a_source, a_timeval: POINTER)
	...
	g_source_remove_by_funcs_user_data (a_gsourcefuncs, some_user_data: POINTER): INTEGER
			-- gboolean g_source_remove_by_funcs_user_data (GSourceFuncs *funcs, gpointer user_data);
		external "C use <glib.h>"
		end

	g_source_remove_by_user_data (some_user_data: POINTER): INTEGER
