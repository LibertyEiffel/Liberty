...
feature {} -- External calls
	...
	g_tree_new_full (a_key_compare_func, a_key_compare_data,	a_key_destroy_func, a_value_destroy_func: POINTER): POINTER is
	...
	g_tree_insert (a_tree, a_key, a_value: POINTER) is
			-- void g_tree_insert (GTree *tree, gpointer key, gpointer value);
		external "C use <glib.h>"
		end
			
	g_tree_replace (a_tree, a_key, a_value: POINTER) is
	...
	g_tree_lookup (a_tree, a_key: POINTER): POINTER is
			-- gpointer g_tree_lookup (GTree *tree, gconstpointer key);
		external "C use <glib.h>"
		end

	g_tree_lookup_extended (a_tree, a_lookup_key, an_orig_key, a_value: POINTER): INTEGER is
	...
	g_tree_foreach (a_tree, a_gtraversefunc, some_data: POINTER) is
				-- void g_tree_foreach (GTree *tree, GTraverseFunc func, gpointer user_data);
			external "C use <glib.h>"
			end

	g_tree_traverse (a_tree, a_traverse_func: POINTER; a_traverse_type: INTEGER; some_data: POINTER) is
	...
	g_tree_search (a_tree, a_search_func, some_data: POINTER): INTEGER is
			-- gpointer g_tree_search (GTree *tree, GCompareFunc
			-- search_func, gconstpointer user_data);
		external "C use <glib.h>"
		end

	g_tree_remove (a_tree, a_key: POINTER): INTEGER is
				-- gboolean g_tree_remove (GTree *tree, gconstpointer key);
		external "C use <glib.h>"
		end

	g_tree_steal (a_tree, a_key: POINTER): INTEGER is
