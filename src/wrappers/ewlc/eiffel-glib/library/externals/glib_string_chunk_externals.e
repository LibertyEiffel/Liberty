...
feature  {} -- External calls
	...
	g_string_chunk_new (a_size: like gsize): POINTER is
			-- GStringChunk* g_string_chunk_new (gsize size);
		external "C use <glib.h>"
		end
	
	g_string_chunk_insert (a_chunk, a_const_string: POINTER): POINTER is
			-- gchar* g_string_chunk_insert (GStringChunk *chunk, const
			-- gchar *string);
		external "C use <glib.h>"
		end

	g_string_chunk_insert_const (a_chunk, a_const_string: POINTER): POINTER is
			-- gchar* g_string_chunk_insert_const (GStringChunk *chunk,
			-- const gchar *string);
		external "C use <glib.h>"
		end

	g_string_chunk_insert_len (a_chunk, a_const_string: POINTER; a_len: like gssize): POINTER is
