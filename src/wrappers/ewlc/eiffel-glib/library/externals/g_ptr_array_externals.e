...
-- #include <glib.h>
	...
	g_ptr_array_sized_new (a_size: INTEGER): POINTER is
	...
	g_ptr_array_add (an_array, some_data: POINTER) is
			-- void g_ptr_array_add (GPtrArray *array, gpointer data);
		external "C use <glib.h>"
		end

	g_ptr_array_remove (an_array, some_data: POINTER): INTEGER is
			-- gboolean g_ptr_array_remove (GPtrArray *array, gpointer
			-- data);
		external "C use <glib.h>"
		end

	g_ptr_array_remove_index (an_array: POINTER; an_index: INTEGER): POINTER is
	...
	g_ptr_array_remove_fast (an_array, some_data: POINTER): INTEGER is
			-- gboolean g_ptr_array_remove_fast (GPtrArray *array,
			-- gpointer data);
		external "C use <glib.h>"
		end

	g_ptr_array_remove_index_fast(an_array: POINTER; an_index: INTEGER): POINTER is
	...
	g_ptr_array_remove_range (an_array: POINTER; an_index, a_length: INTEGER) is
	...
	g_ptr_array_sort (an_array, a_compare_func: POINTER) is
			-- void g_ptr_array_sort (GPtrArray *array, GCompareFunc
			-- compare_func);
		external "C use <glib.h>"
		end

	g_ptr_array_sort_with_data (an_array, a_compare_func, a_user_data: POINTER) is
	...
	g_ptr_array_index (an_array: POINTER; an_index: INTEGER): POINTER is
			-- #define g_ptr_array_index (array,index_)
		external "C macro use <glib.h>"
		end

	g_ptr_array_free (an_array: POINTER; a_free_seg: INTEGER): INTEGER is
			-- gpointer* g_ptr_array_free (GPtrArray *array, gboolean
			-- free_seg);
		external "C use <glib.h>"
		end

	g_ptr_array_foreach (an_array, a_func, a_user_data: POINTER) is
...
-- guint len; 	number of pointers in the array.
	...
	get_pdata (a_struct: POINTER): POINTER is
		external "C struct GPtrArray get pdata use <glib.h>"
		end
	
	get_len (a_struct: POINTER): INTEGER is
