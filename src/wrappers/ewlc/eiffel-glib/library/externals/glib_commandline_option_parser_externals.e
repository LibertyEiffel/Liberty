note
	...
	copyright: "Copyright (C) 2007-2022: Paolo Readelli, $original_copyright_holder"
...
feature {} -- External calls
	...
	g_option_context_set_summary (a_context, a_summary: POINTER)
	...
	g_option_context_set_description (a_context, a_description: POINTER)
	...
	g_option_context_set_translate_func (a_context, a_gtranslatefunc, some_data, a_destroy_notify: POINTER)
			-- void g_option_context_set_translate_func (GOptionContext *context,
			-- GTranslateFunc func, gpointer data, GDestroyNotify destroy_notify);
		external "C use <glib.h>"
		end
		
	g_option_context_set_translation_domain (a_context, a_domain: POINTER)
	...
	g_option_context_parse (a_context, an_argc, an_argv, a_error: POINTER): INTEGER
			-- gboolean g_option_context_parse (GOptionContext *context, gint
			-- *argc, gchar ***argv, GError **error);
		external "C use <glib.h>"
		end
	
	g_option_context_set_help_enabled (a_context: POINTER; help_enabled_bool: INTEGER)
	...
	g_option_context_set_ignore_unknown_options (a_context: POINTER; an_ignore_unknown_bool: INTEGER)
	...
	g_option_context_add_main_entries (a_context, some_entries, a_translation_domain: POINTER)
	...
	g_option_context_add_group (a_context, a_group: POINTER)
			-- void g_option_context_add_group (GOptionContext *context,
			-- GOptionGroup *group);
		external "C use <glib.h>"
		end
	
	g_option_context_set_main_group (a_context, some_group: POINTER)
	...
	g_option_group_new (a_name, a_description, a_help_description, some_data, a_gdestroynotify: POINTER): POINTER
	...
	g_option_group_add_entries (a_group, some_entries: POINTER)
	...
	g_option_group_set_parse_hooks  (a_group, pre_parse_func, post_parse_func: POINTER)
	...
	g_option_group_set_error_hook   (a_group, an_error_func: POINTER)
			--  void g_option_group_set_error_hook (GOptionGroup *group,
			--  GOptionErrorFunc error_func);
		external "C use <glib.h>"
		end
		
	g_option_group_set_translate_func (a_group, a_func, some_data, a_gdestroynotify: POINTER)
			--  void g_option_group_set_translate_func (GOptionGroup *group,
			--  GTranslateFunc func, gpointer data, GDestroyNotify destroy_notify);
		external "C use <glib.h>"
		end
		
	g_option_group_set_translation_domain (a_group, a_domain: POINTER)
