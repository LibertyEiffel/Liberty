...
feature {ANY}
	...
	slice (min, max: INTEGER): like Current do not_yet_implemented end
	...
	force (element: like first; index: INTEGER) do not_yet_implemented end
	...
	from_collection (model: COLLECTION[ITEM])
