...
--			         (an_event_type=gdk_event_grab_broken) or else
	...
	gdk_event_destroy: INTEGER is
			-- the window has been destroyed.
		external "C macro use <gdk/gdk.h>"
		alias "GDK_DESTROY"
		end

	gdk_event_expose: INTEGER is
			-- all or part of the window has become visible and needs to be redrawn.
		external "C macro use <gdk/gdk.h>"
		alias "GDK_EXPOSE"
		end

	gdk_event_motion_notify: INTEGER is
			-- the pointer (usually a mouse) has moved.
		external "C macro use <gdk/gdk.h>"
		alias "GDK_MOTION_NOTIFY"
		end

	gdk_event_button_press: INTEGER is
			-- a mouse button has been pressed.
		external "C macro use <gdk/gdk.h>"
		alias "GDK_BUTTON_PRESS"
		end

	gdk_event_2button_press: INTEGER is
	...
	gdk_event_3button_press: INTEGER is
	...
	gdk_event_button_release: INTEGER is
			-- a mouse button has been released.
		external "C macro use <gdk/gdk.h>"
		alias "GDK_BUTTON_RELEASE"
		end

	gdk_event_key_press: INTEGER is
			-- a key has been pressed.
		external "C macro use <gdk/gdk.h>"
		alias "GDK_KEY_PRESS"
		end

	gdk_event_key_release: INTEGER is
			-- a key has been released.
		external "C macro use <gdk/gdk.h>"
		alias "GDK_KEY_RELEASE"
		end

	gdk_event_enter_notify: INTEGER is
			-- the pointer has entered the window.
		external "C macro use <gdk/gdk.h>"
		alias "GDK_ENTER_NOTIFY"
		end

	gdk_event_leave_notify: INTEGER is
			-- the pointer has left the window.
		external "C macro use <gdk/gdk.h>"
		alias "GDK_LEAVE_NOTIFY"
		end

	gdk_event_focus_change: INTEGER is
			--  the keyboard focus has entered or left the window.
		external "C macro use <gdk/gdk.h>"
		alias "GDK_FOCUS_CHANGE"
		end

	gdk_event_configure: INTEGER is
	...
	gdk_event_map: INTEGER is
			-- the window has been mapped.
		external "C macro use <gdk/gdk.h>"
		alias "GDK_MAP"
		end

	gdk_event_unmap: INTEGER is
			-- the window has been unmapped.
		external "C macro use <gdk/gdk.h>"
		alias "GDK_UNMAP"
		end

	gdk_event_property_notify: INTEGER is
			-- a property on the window has been changed or deleted.
		external "C macro use <gdk/gdk.h>"
		alias "GDK_PROPERTY_NOTIFY"
		end

	gdk_event_selection_clear: INTEGER is
			-- the application has lost ownership of a selection.
		external "C macro use <gdk/gdk.h>"
		alias "GDK_SELECTION_CLEAR"
		end

	gdk_event_selection_request: INTEGER is
			-- another application has requested a selection.
		external "C macro use <gdk/gdk.h>"
		alias "GDK_SELECTION_REQUEST"
		end

	gdk_event_selection_notify: INTEGER is
			-- a selection has been received.
		external "C macro use <gdk/gdk.h>"
		alias "GDK_SELECTION_NOTIFY"
		end

	gdk_event_proximity_in: INTEGER is
	...
	gdk_event_scroll: INTEGER is
			-- the scroll wheel was turned
		external "C macro use <gdk/gdk.h>"
		alias "GDK_SCROLL"
		end

	gdk_event_window_state: INTEGER is
			-- the state of a window has changed. See GdkWindowState for the possible window states
		external "C macro use <gdk/gdk.h>"
		alias "GDK_WINDOW_STATE"
		end

	gdk_event_setting: INTEGER is
			-- a setting has been modified.
		external "C macro use <gdk/gdk.h>"
		alias "GDK_SETTING"
		end

	gdk_event_owner_change: INTEGER is
