...
feature {} -- External calls
		gdk_pixmap_new (a_drawable: POINTER; a_width, an_height, a_depth: INTEGER): POINTER is
			-- GdkPixmap* gdk_pixmap_new (GdkDrawable *drawable, gint width, gint height, gint depth);
		external "C use <gdk/gdk.h>"
		end

	gdk_bitmap_create_from_data (a_drawable, a_data: POINTER; a_width, an_height: INTEGER): POINTER is
			-- GdkBitmap* gdk_bitmap_create_from_data (GdkDrawable *drawable, const gchar *data, gint width, gint height);
		external "C use <gdk/gdk.h>"
		end


	gdk_pixmap_create_from_data (a_drawable, a_data: POINTER; a_width, an_height, a_depth: INTEGER; a_fg, a_bg: POINTER): POINTER is
	...
	gdk_pixmap_create_from_xpm (a_drawable, a_mask_ref, a_transparent_color, a_filename: POINTER): POINTER is
	...
	gdk_pixmap_colormap_create_from_xpm (a_drawable, a_colormap, a_mask_ref, a_transparent_color, a_filename: POINTER): POINTER is
	...
	gdk_pixmap_create_from_xpm_d (a_drawable, a_mask_ref, a_transparent_color, some_data: POINTER): POINTER is
			-- GdkPixmap* gdk_pixmap_create_from_xpm_d (GdkDrawable *drawable, GdkBitmap **mask, const GdkColor *transparent_color, gchar **data);
		external "C use <gdk/gdk.h>"
		end

	gdk_pixmap_colormap_create_from_xpm_d (a_drawable, a_colormap, a_mask_ref, a_transparent_color, some_data_ref: POINTER): POINTER is
