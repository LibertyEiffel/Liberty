...
feature {} -- Low-level setters
	...
	zmq_msg_t_struct_set_shared (a_structure: POINTER; a_value: CHARACTER) is
			-- Setter for shared field of ZMQ_MSG_T_STRUCT structure.
			-- TODO: setter description
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "zmq_msg_t_struct_set_shared"
		}"
		end
...
feature {} -- Low-level queries
	...
	zmq_msg_t_struct_get_shared (a_structure: POINTER): CHARACTER is
			-- Query for shared field of ZMQ_MSG_T_STRUCT structure.
			-- TODO: getter description
		...
		alias "{
			location: "."
			module_name: "plugin"
			feature_name: "zmq_msg_t_struct_get_shared"
		}"
		end
