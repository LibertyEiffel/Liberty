...
feature {} -- External calls
	...
	gsl_combination_alloc (a_n: NATURAL_32; a_k: NATURAL_32): POINTER is
	...
	gsl_combination_calloc (a_n: NATURAL_32; a_k: NATURAL_32): POINTER is
	...
	gsl_combination_fprintf (a_stream: POINTER; a_c: POINTER; a_format: POINTER): INTEGER_32 is
	...
	gsl_combination_fread (a_stream: POINTER; a_c: POINTER): INTEGER_32 is
	...
	gsl_combination_fscanf (a_stream: POINTER; a_c: POINTER): INTEGER_32 is
	...
	gsl_combination_fwrite (a_stream: POINTER; a_c: POINTER): INTEGER_32 is
	...
	gsl_combination_get (a_c: POINTER; an_i: NATURAL_32): NATURAL_32 is
 		-- gsl_combination_get
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_combination_k (a_c: POINTER): NATURAL_32 is
 		-- gsl_combination_k
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_combination_memcpy (a_dest: POINTER; a_src: POINTER): INTEGER_32 is
	...
	gsl_combination_n (a_c: POINTER): NATURAL_32 is
 		-- gsl_combination_n
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_combination_next (a_c: POINTER): INTEGER_32 is
	...
	gsl_combination_prev (a_c: POINTER): INTEGER_32 is
	...
	gsl_combination_valid (a_c: POINTER): INTEGER_32 is
