...
feature {} -- External calls
	...
	gsl_vector_long_add (an_a: POINTER; a_b: POINTER): INTEGER_32 is
 		-- gsl_vector_long_add
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_long_add_constant (an_a: POINTER; a_x: REAL_64): INTEGER_32 is
	...
	gsl_vector_long_alloc (a_n: NATURAL_32): POINTER is
	...
	gsl_vector_long_alloc_from_block (a_b: POINTER; an_offset: NATURAL_32; a_n: NATURAL_32; a_stride: NATURAL_32): POINTER is
	...
	gsl_vector_long_alloc_from_vector (a_v: POINTER; an_offset: NATURAL_32; a_n: NATURAL_32; a_stride: NATURAL_32): POINTER is
	...
	gsl_vector_long_calloc (a_n: NATURAL_32): POINTER is
	...
	gsl_vector_long_const_ptr (a_v: POINTER; an_i: NATURAL_32): POINTER is
	...
	gsl_vector_long_div (an_a: POINTER; a_b: POINTER): INTEGER_32 is
 		-- gsl_vector_long_div
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_long_equal (an_u: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_long_fprintf (a_stream: POINTER; a_v: POINTER; a_format: POINTER): INTEGER_32 is
	...
	gsl_vector_long_fread (a_stream: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_long_fscanf (a_stream: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_long_fwrite (a_stream: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_long_get (a_v: POINTER; an_i: NATURAL_32): INTEGER_32 is
 		-- gsl_vector_long_get
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_long_isneg (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_long_isnonneg (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_long_isnull (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_long_ispos (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_long_max (a_v: POINTER): INTEGER_32 is
 		-- gsl_vector_long_max
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_long_max_index (a_v: POINTER): NATURAL_32 is
	...
	gsl_vector_long_memcpy (a_dest: POINTER; a_src: POINTER): INTEGER_32 is
	...
	gsl_vector_long_min (a_v: POINTER): INTEGER_32 is
 		-- gsl_vector_long_min
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_long_min_index (a_v: POINTER): NATURAL_32 is
	...
	gsl_vector_long_mul (an_a: POINTER; a_b: POINTER): INTEGER_32 is
 		-- gsl_vector_long_mul
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_long_ptr (a_v: POINTER; an_i: NATURAL_32): POINTER is
 		-- gsl_vector_long_ptr
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_long_reverse (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_long_scale (an_a: POINTER; a_x: REAL_64): INTEGER_32 is
	...
	gsl_vector_long_set (a_v: POINTER; an_i: NATURAL_32; a_x: INTEGER_32) is
 		-- gsl_vector_long_set
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_long_set_all (a_v: POINTER; a_x: INTEGER_32) is
	...
	gsl_vector_long_set_basis (a_v: POINTER; an_i: NATURAL_32): INTEGER_32 is
	...
	gsl_vector_long_sub (an_a: POINTER; a_b: POINTER): INTEGER_32 is
 		-- gsl_vector_long_sub
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_long_swap (a_v: POINTER; a_w: POINTER): INTEGER_32 is
	...
	gsl_vector_long_swap_elements (a_v: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_32 is
