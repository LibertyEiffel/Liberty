...
feature {} -- External calls
	...
	gsl_matrix_complex_float_add (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_float_alloc (a_n1: NATURAL_32; a_n2: NATURAL_32): POINTER is
	...
	gsl_matrix_complex_float_alloc_from_block (a_b: POINTER; an_offset: NATURAL_32; a_n1: NATURAL_32; a_n2: NATURAL_32; a_d2: NATURAL_32): POINTER is
	...
	gsl_matrix_complex_float_alloc_from_matrix (a_b: POINTER; a_k1: NATURAL_32; a_k2: NATURAL_32; a_n1: NATURAL_32; a_n2: NATURAL_32): POINTER is
	...
	gsl_matrix_complex_float_calloc (a_n1: NATURAL_32; a_n2: NATURAL_32): POINTER is
	...
	gsl_matrix_complex_float_const_ptr (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): POINTER is
	...
	gsl_matrix_complex_float_div_elements (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_float_equal (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_float_fprintf (a_stream: POINTER; a_m: POINTER; a_format: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_float_fread (a_stream: POINTER; a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_float_fscanf (a_stream: POINTER; a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_float_fwrite (a_stream: POINTER; a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_float_get_col (a_v: POINTER; a_m: POINTER; a_j: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_complex_float_get_row (a_v: POINTER; a_m: POINTER; an_i: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_complex_float_isneg (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_float_isnonneg (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_float_isnull (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_float_ispos (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_float_memcpy (a_dest: POINTER; a_src: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_float_mul_elements (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_float_ptr (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): POINTER is
	...
	gsl_matrix_complex_float_set_col (a_m: POINTER; a_j: NATURAL_32; a_v: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_float_set_row (a_m: POINTER; an_i: NATURAL_32; a_v: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_float_sub (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_float_swap (a_m1: POINTER; a_m2: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_float_swap_columns (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_complex_float_swap_rowcol (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_complex_float_swap_rows (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_complex_float_transpose (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_float_transpose_memcpy (a_dest: POINTER; a_src: POINTER): INTEGER_32 is
	...
	gsl_vector_complex_float_alloc_col_from_matrix (a_m: POINTER; a_j: NATURAL_32): POINTER is
	...
	gsl_vector_complex_float_alloc_row_from_matrix (a_m: POINTER; an_i: NATURAL_32): POINTER is
