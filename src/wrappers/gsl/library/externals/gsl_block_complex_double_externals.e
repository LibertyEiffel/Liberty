...
feature {} -- External calls
	...
	gsl_block_complex_alloc (a_n: NATURAL_32): POINTER is
	...
	gsl_block_complex_calloc (a_n: NATURAL_32): POINTER is
	...
	gsl_block_complex_fprintf (a_stream: POINTER; a_b: POINTER; a_format: POINTER): INTEGER_32 is
	...
	gsl_block_complex_fread (a_stream: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_block_complex_fscanf (a_stream: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_block_complex_fwrite (a_stream: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_block_complex_raw_fprintf (a_stream: POINTER; a_b: POINTER; a_n: NATURAL_32; a_stride: NATURAL_32; a_format: POINTER): INTEGER_32 is
	...
	gsl_block_complex_raw_fread (a_stream: POINTER; a_b: POINTER; a_n: NATURAL_32; a_stride: NATURAL_32): INTEGER_32 is
	...
	gsl_block_complex_raw_fscanf (a_stream: POINTER; a_b: POINTER; a_n: NATURAL_32; a_stride: NATURAL_32): INTEGER_32 is
	...
	gsl_block_complex_raw_fwrite (a_stream: POINTER; a_b: POINTER; a_n: NATURAL_32; a_stride: NATURAL_32): INTEGER_32 is
	...
	gsl_block_complex_size (a_b: POINTER): NATURAL_32 is
