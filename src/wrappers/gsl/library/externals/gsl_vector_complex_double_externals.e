...
feature {} -- External calls
	...
	gsl_vector_complex_add (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_vector_complex_alloc (a_n: NATURAL_32): POINTER is
	...
	gsl_vector_complex_alloc_from_block (a_b: POINTER; an_offset: NATURAL_32; a_n: NATURAL_32; a_stride: NATURAL_32): POINTER is
	...
	gsl_vector_complex_alloc_from_vector (a_v: POINTER; an_offset: NATURAL_32; a_n: NATURAL_32; a_stride: NATURAL_32): POINTER is
	...
	gsl_vector_complex_calloc (a_n: NATURAL_32): POINTER is
	...
	gsl_vector_complex_const_ptr (a_v: POINTER; an_i: NATURAL_32): POINTER is
	...
	gsl_vector_complex_div (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_vector_complex_equal (an_u: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_complex_fprintf (a_stream: POINTER; a_v: POINTER; a_format: POINTER): INTEGER_32 is
	...
	gsl_vector_complex_fread (a_stream: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_complex_fscanf (a_stream: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_complex_fwrite (a_stream: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_complex_isneg (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_complex_isnonneg (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_complex_isnull (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_complex_ispos (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_complex_memcpy (a_dest: POINTER; a_src: POINTER): INTEGER_32 is
	...
	gsl_vector_complex_mul (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_vector_complex_ptr (a_v: POINTER; an_i: NATURAL_32): POINTER is
	...
	gsl_vector_complex_reverse (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_complex_set_basis (a_v: POINTER; an_i: NATURAL_32): INTEGER_32 is
	...
	gsl_vector_complex_sub (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_vector_complex_swap (a_v: POINTER; a_w: POINTER): INTEGER_32 is
	...
	gsl_vector_complex_swap_elements (a_v: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_32 is
