...
feature {} -- External calls
	...
	gsl_vector_uint_add (an_a: POINTER; a_b: POINTER): INTEGER_32 is
 		-- gsl_vector_uint_add
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_uint_add_constant (an_a: POINTER; a_x: REAL_64): INTEGER_32 is
	...
	gsl_vector_uint_alloc (a_n: NATURAL_32): POINTER is
	...
	gsl_vector_uint_alloc_from_block (a_b: POINTER; an_offset: NATURAL_32; a_n: NATURAL_32; a_stride: NATURAL_32): POINTER is
	...
	gsl_vector_uint_alloc_from_vector (a_v: POINTER; an_offset: NATURAL_32; a_n: NATURAL_32; a_stride: NATURAL_32): POINTER is
	...
	gsl_vector_uint_calloc (a_n: NATURAL_32): POINTER is
	...
	gsl_vector_uint_const_ptr (a_v: POINTER; an_i: NATURAL_32): POINTER is
	...
	gsl_vector_uint_div (an_a: POINTER; a_b: POINTER): INTEGER_32 is
 		-- gsl_vector_uint_div
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_uint_equal (an_u: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_uint_fprintf (a_stream: POINTER; a_v: POINTER; a_format: POINTER): INTEGER_32 is
	...
	gsl_vector_uint_fread (a_stream: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_uint_fscanf (a_stream: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_uint_fwrite (a_stream: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_uint_get (a_v: POINTER; an_i: NATURAL_32): NATURAL_32 is
 		-- gsl_vector_uint_get
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_uint_isneg (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_uint_isnonneg (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_uint_isnull (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_uint_ispos (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_uint_max (a_v: POINTER): NATURAL_32 is
 		-- gsl_vector_uint_max
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_uint_max_index (a_v: POINTER): NATURAL_32 is
	...
	gsl_vector_uint_memcpy (a_dest: POINTER; a_src: POINTER): INTEGER_32 is
	...
	gsl_vector_uint_min (a_v: POINTER): NATURAL_32 is
 		-- gsl_vector_uint_min
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_uint_min_index (a_v: POINTER): NATURAL_32 is
	...
	gsl_vector_uint_mul (an_a: POINTER; a_b: POINTER): INTEGER_32 is
 		-- gsl_vector_uint_mul
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_uint_ptr (a_v: POINTER; an_i: NATURAL_32): POINTER is
 		-- gsl_vector_uint_ptr
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_uint_reverse (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_uint_scale (an_a: POINTER; a_x: REAL_64): INTEGER_32 is
	...
	gsl_vector_uint_set (a_v: POINTER; an_i: NATURAL_32; a_x: NATURAL_32) is
 		-- gsl_vector_uint_set
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_uint_set_all (a_v: POINTER; a_x: NATURAL_32) is
	...
	gsl_vector_uint_set_basis (a_v: POINTER; an_i: NATURAL_32): INTEGER_32 is
	...
	gsl_vector_uint_sub (an_a: POINTER; a_b: POINTER): INTEGER_32 is
 		-- gsl_vector_uint_sub
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_uint_swap (a_v: POINTER; a_w: POINTER): INTEGER_32 is
	...
	gsl_vector_uint_swap_elements (a_v: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_32 is
