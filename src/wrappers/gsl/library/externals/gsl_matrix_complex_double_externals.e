...
feature {} -- External calls
	...
	gsl_matrix_complex_add (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_alloc (a_n1: NATURAL_32; a_n2: NATURAL_32): POINTER is
	...
	gsl_matrix_complex_alloc_from_block (a_b: POINTER; an_offset: NATURAL_32; a_n1: NATURAL_32; a_n2: NATURAL_32; a_d2: NATURAL_32): POINTER is
	...
	gsl_matrix_complex_alloc_from_matrix (a_b: POINTER; a_k1: NATURAL_32; a_k2: NATURAL_32; a_n1: NATURAL_32; a_n2: NATURAL_32): POINTER is
	...
	gsl_matrix_complex_calloc (a_n1: NATURAL_32; a_n2: NATURAL_32): POINTER is
	...
	gsl_matrix_complex_const_ptr (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): POINTER is
	...
	gsl_matrix_complex_div_elements (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_equal (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_fprintf (a_stream: POINTER; a_m: POINTER; a_format: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_fread (a_stream: POINTER; a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_fscanf (a_stream: POINTER; a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_fwrite (a_stream: POINTER; a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_get_col (a_v: POINTER; a_m: POINTER; a_j: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_complex_get_row (a_v: POINTER; a_m: POINTER; an_i: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_complex_isneg (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_isnonneg (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_isnull (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_ispos (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_memcpy (a_dest: POINTER; a_src: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_mul_elements (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_ptr (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): POINTER is
	...
	gsl_matrix_complex_set_col (a_m: POINTER; a_j: NATURAL_32; a_v: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_set_row (a_m: POINTER; an_i: NATURAL_32; a_v: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_sub (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_swap (a_m1: POINTER; a_m2: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_swap_columns (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_complex_swap_rowcol (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_complex_swap_rows (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_complex_transpose (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_complex_transpose_memcpy (a_dest: POINTER; a_src: POINTER): INTEGER_32 is
	...
	gsl_vector_complex_alloc_col_from_matrix (a_m: POINTER; a_j: NATURAL_32): POINTER is
	...
	gsl_vector_complex_alloc_row_from_matrix (a_m: POINTER; an_i: NATURAL_32): POINTER is
