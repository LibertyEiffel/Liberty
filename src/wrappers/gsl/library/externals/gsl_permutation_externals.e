...
feature {} -- External calls
	...
	gsl_permutation_alloc (a_n: NATURAL_32): POINTER is
	...
	gsl_permutation_calloc (a_n: NATURAL_32): POINTER is
	...
	gsl_permutation_canonical_cycles (a_q: POINTER): NATURAL_32 is
	...
	gsl_permutation_canonical_to_linear (a_p: POINTER; a_q: POINTER): INTEGER_32 is
	...
	gsl_permutation_fprintf (a_stream: POINTER; a_p: POINTER; a_format: POINTER): INTEGER_32 is
	...
	gsl_permutation_fread (a_stream: POINTER; a_p: POINTER): INTEGER_32 is
	...
	gsl_permutation_fscanf (a_stream: POINTER; a_p: POINTER): INTEGER_32 is
	...
	gsl_permutation_fwrite (a_stream: POINTER; a_p: POINTER): INTEGER_32 is
	...
	gsl_permutation_get (a_p: POINTER; an_i: NATURAL_32): NATURAL_32 is
 		-- gsl_permutation_get
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_permutation_inverse (an_inv: POINTER; a_p: POINTER): INTEGER_32 is
	...
	gsl_permutation_inversions (a_p: POINTER): NATURAL_32 is
	...
	gsl_permutation_linear_cycles (a_p: POINTER): NATURAL_32 is
	...
	gsl_permutation_linear_to_canonical (a_q: POINTER; a_p: POINTER): INTEGER_32 is
	...
	gsl_permutation_memcpy (a_dest: POINTER; a_src: POINTER): INTEGER_32 is
	...
	gsl_permutation_mul (a_p: POINTER; a_pa: POINTER; a_pb: POINTER): INTEGER_32 is
 		-- gsl_permutation_mul
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_permutation_next (a_p: POINTER): INTEGER_32 is
	...
	gsl_permutation_prev (a_p: POINTER): INTEGER_32 is
	...
	gsl_permutation_size (a_p: POINTER): NATURAL_32 is
	...
	gsl_permutation_swap (a_p: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_32 is
	...
	gsl_permutation_valid (a_p: POINTER): INTEGER_32 is
