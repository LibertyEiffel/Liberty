...
feature {} -- External calls
	...
	gsl_vector_uchar_add (an_a: POINTER; a_b: POINTER): INTEGER is
	...
	gsl_vector_uchar_add_constant (an_a: POINTER; a_x: REAL): INTEGER is
	...
	gsl_vector_uchar_alloc (a_n: like size_t): POINTER is
	...
	gsl_vector_uchar_alloc_from_block (a_b: POINTER; an_offset: like size_t; a_n: like size_t; a_stride: like size_t): POINTER is
	...
	gsl_vector_uchar_alloc_from_vector (a_v: POINTER; an_offset: like size_t; a_n: like size_t; a_stride: like size_t): POINTER is
	...
	gsl_vector_uchar_calloc (a_n: like size_t): POINTER is
	...
	gsl_vector_uchar_const_ptr (a_v: POINTER; an_i: like size_t): POINTER is
	...
	gsl_vector_uchar_div (an_a: POINTER; a_b: POINTER): INTEGER is
	...
	gsl_vector_uchar_equal (an_u: POINTER; a_v: POINTER): INTEGER is
	...
	gsl_vector_uchar_fprintf (a_stream: POINTER; a_v: POINTER; a_format: POINTER): INTEGER is
	...
	gsl_vector_uchar_fread (a_stream: POINTER; a_v: POINTER): INTEGER is
	...
	gsl_vector_uchar_fscanf (a_stream: POINTER; a_v: POINTER): INTEGER is
	...
	gsl_vector_uchar_fwrite (a_stream: POINTER; a_v: POINTER): INTEGER is
	...
	gsl_vector_uchar_get (a_v: POINTER; an_i: like size_t): CHARACTER is
	...
	gsl_vector_uchar_isneg (a_v: POINTER): INTEGER is
	...
	gsl_vector_uchar_isnonneg (a_v: POINTER): INTEGER is
	...
	gsl_vector_uchar_isnull (a_v: POINTER): INTEGER is
	...
	gsl_vector_uchar_ispos (a_v: POINTER): INTEGER is
	...
	gsl_vector_uchar_max_index (a_v: POINTER): like size_t is
	...
	gsl_vector_uchar_memcpy (a_dest: POINTER; a_src: POINTER): INTEGER is
	...
	gsl_vector_uchar_min_index (a_v: POINTER): like size_t is
	...
	gsl_vector_uchar_mul (an_a: POINTER; a_b: POINTER): INTEGER is
	...
	gsl_vector_uchar_ptr (a_v: POINTER; an_i: like size_t): POINTER is
	...
	gsl_vector_uchar_reverse (a_v: POINTER): INTEGER is
	...
	gsl_vector_uchar_scale (an_a: POINTER; a_x: REAL): INTEGER is
	...
	gsl_vector_uchar_set (a_v: POINTER; an_i: like size_t; a_x: CHARACTER) is
	...
	gsl_vector_uchar_set_basis (a_v: POINTER; an_i: like size_t): INTEGER is
	...
	gsl_vector_uchar_sub (an_a: POINTER; a_b: POINTER): INTEGER is
	...
	gsl_vector_uchar_swap (a_v: POINTER; a_w: POINTER): INTEGER is
	...
	gsl_vector_uchar_swap_elements (a_v: POINTER; an_i: like size_t; a_j: like size_t): INTEGER is
