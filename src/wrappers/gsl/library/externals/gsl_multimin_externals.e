...
feature {} -- External calls
	...
	gsl_multimin_diff (a_f: POINTER; a_x: POINTER; a_g: POINTER): INTEGER_32 is
 		-- gsl_multimin_diff
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_multimin_fdfminimizer_alloc (a_t: POINTER; a_n: NATURAL_32): POINTER is
	...
	gsl_multimin_fdfminimizer_iterate (a_s: POINTER): INTEGER_32 is
	...
	gsl_multimin_fdfminimizer_minimum (a_s: POINTER): REAL_64 is
	...
	gsl_multimin_fdfminimizer_restart (a_s: POINTER): INTEGER_32 is
	...
	gsl_multimin_fdfminimizer_set (a_s: POINTER; a_fdf: POINTER; a_x: POINTER; a_step_size: REAL_64; a_tol: REAL_64): INTEGER_32 is
	...
	gsl_multimin_fminimizer_alloc (a_t: POINTER; a_n: NATURAL_32): POINTER is
	...
	gsl_multimin_fminimizer_iterate (a_s: POINTER): INTEGER_32 is
	...
	gsl_multimin_fminimizer_minimum (a_s: POINTER): REAL_64 is
	...
	gsl_multimin_fminimizer_set (a_s: POINTER; a_f: POINTER; a_x: POINTER; a_step_size: POINTER): INTEGER_32 is
	...
	gsl_multimin_fminimizer_size (a_s: POINTER): REAL_64 is
	...
	gsl_multimin_test_gradient (a_g: POINTER; an_epsabs: REAL_64): INTEGER_32 is
	...
	gsl_multimin_test_size (a_size: REAL_64; an_epsabs: REAL_64): INTEGER_32 is
