...
feature {} -- External calls
	...
	gsl_sort_vector_char_index (a_p: POINTER; a_v: POINTER): INTEGER is
	...
	gsl_sort_vector_char_largest (a_dest: POINTER; a_k: like size_t; a_v: POINTER): INTEGER is
	...
	gsl_sort_vector_char_largest_index (a_p: POINTER; a_k: like size_t; a_v: POINTER): INTEGER is
	...
	gsl_sort_vector_char_smallest (a_dest: POINTER; a_k: like size_t; a_v: POINTER): INTEGER is
	...
	gsl_sort_vector_char_smallest_index (a_p: POINTER; a_k: like size_t; a_v: POINTER): INTEGER is
