...
feature {} -- External calls
	...
	gsl_permute_complex_long_double (a_p: POINTER; a_data: POINTER; a_stride: like size_t; a_n: like size_t): INTEGER is
	...
	gsl_permute_complex_long_double_inverse (a_p: POINTER; a_data: POINTER; a_stride: like size_t; a_n: like size_t): INTEGER is
