...
feature {} -- External calls
	...
	gsl_multifit_covar (a_j: POINTER; an_epsrel: REAL_64; a_covar: POINTER): INTEGER_32 is
 		-- gsl_multifit_covar
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_multifit_fdfsolver_alloc (a_t: POINTER; a_n: NATURAL_32; a_p: NATURAL_32): POINTER is
	...
	gsl_multifit_fdfsolver_iterate (a_s: POINTER): INTEGER_32 is
	...
	gsl_multifit_fdfsolver_set (a_s: POINTER; a_fdf: POINTER; a_x: POINTER): INTEGER_32 is
	...
	gsl_multifit_fsolver_alloc (a_t: POINTER; a_n: NATURAL_32; a_p: NATURAL_32): POINTER is
	...
	gsl_multifit_fsolver_iterate (a_s: POINTER): INTEGER_32 is
	...
	gsl_multifit_fsolver_set (a_s: POINTER; a_f: POINTER; a_x: POINTER): INTEGER_32 is
	...
	gsl_multifit_gradient (a_j: POINTER; a_f: POINTER; a_g: POINTER): INTEGER_32 is
	...
	gsl_multifit_test_delta (a_dx: POINTER; a_x: POINTER; an_epsabs: REAL_64; an_epsrel: REAL_64): INTEGER_32 is
	...
	gsl_multifit_test_gradient (a_g: POINTER; an_epsabs: REAL_64): INTEGER_32 is
