...
feature {} -- External calls
	...
	gsl_vector_ushort_add (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_vector_ushort_add_constant (an_a: POINTER; a_x: REAL_64): INTEGER_32 is
	...
	gsl_vector_ushort_alloc (a_n: NATURAL_32): POINTER is
	...
	gsl_vector_ushort_alloc_from_block (a_b: POINTER; an_offset: NATURAL_32; a_n: NATURAL_32; a_stride: NATURAL_32): POINTER is
	...
	gsl_vector_ushort_alloc_from_vector (a_v: POINTER; an_offset: NATURAL_32; a_n: NATURAL_32; a_stride: NATURAL_32): POINTER is
	...
	gsl_vector_ushort_calloc (a_n: NATURAL_32): POINTER is
	...
	gsl_vector_ushort_const_ptr (a_v: POINTER; an_i: NATURAL_32): POINTER is
	...
	gsl_vector_ushort_div (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_vector_ushort_equal (an_u: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_ushort_fprintf (a_stream: POINTER; a_v: POINTER; a_format: POINTER): INTEGER_32 is
	...
	gsl_vector_ushort_fread (a_stream: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_ushort_fscanf (a_stream: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_ushort_fwrite (a_stream: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_ushort_get (a_v: POINTER; an_i: NATURAL_32): NATURAL_16 is
	...
	gsl_vector_ushort_isneg (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_ushort_isnonneg (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_ushort_isnull (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_ushort_ispos (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_ushort_max_index (a_v: POINTER): NATURAL_32 is
	...
	gsl_vector_ushort_memcpy (a_dest: POINTER; a_src: POINTER): INTEGER_32 is
	...
	gsl_vector_ushort_min_index (a_v: POINTER): NATURAL_32 is
	...
	gsl_vector_ushort_mul (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_vector_ushort_ptr (a_v: POINTER; an_i: NATURAL_32): POINTER is
	...
	gsl_vector_ushort_reverse (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_ushort_scale (an_a: POINTER; a_x: REAL_64): INTEGER_32 is
	...
	gsl_vector_ushort_set (a_v: POINTER; an_i: NATURAL_32; a_x: NATURAL_16) is
	...
	gsl_vector_ushort_set_basis (a_v: POINTER; an_i: NATURAL_32): INTEGER_32 is
	...
	gsl_vector_ushort_sub (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_vector_ushort_swap (a_v: POINTER; a_w: POINTER): INTEGER_32 is
	...
	gsl_vector_ushort_swap_elements (a_v: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_32 is
