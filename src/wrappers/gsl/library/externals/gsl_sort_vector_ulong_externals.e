...
feature {} -- External calls
	...
	gsl_sort_vector_ulong_index (a_p: POINTER; a_v: POINTER): INTEGER is
	...
	gsl_sort_vector_ulong_largest (a_dest: POINTER; a_k: like size_t; a_v: POINTER): INTEGER is
	...
	gsl_sort_vector_ulong_largest_index (a_p: POINTER; a_k: like size_t; a_v: POINTER): INTEGER is
	...
	gsl_sort_vector_ulong_smallest (a_dest: POINTER; a_k: like size_t; a_v: POINTER): INTEGER is
	...
	gsl_sort_vector_ulong_smallest_index (a_p: POINTER; a_k: like size_t; a_v: POINTER): INTEGER is
