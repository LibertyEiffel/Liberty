...
feature {} -- External calls
	...
	gsl_multiset_alloc (a_n: NATURAL_32; a_k: NATURAL_32): POINTER is
 		-- gsl_multiset_alloc
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_multiset_calloc (a_n: NATURAL_32; a_k: NATURAL_32): POINTER is
 		-- gsl_multiset_calloc
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_multiset_fprintf (a_stream: POINTER; a_c: POINTER; a_format: POINTER): INTEGER_32 is
	...
	gsl_multiset_fread (a_stream: POINTER; a_c: POINTER): INTEGER_32 is
 		-- gsl_multiset_fread
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_multiset_fscanf (a_stream: POINTER; a_c: POINTER): INTEGER_32 is
 		-- gsl_multiset_fscanf
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_multiset_fwrite (a_stream: POINTER; a_c: POINTER): INTEGER_32 is
 		-- gsl_multiset_fwrite
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_multiset_get (a_c: POINTER; an_i: NATURAL_32): NATURAL_32 is
 		-- gsl_multiset_get
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_multiset_k (a_c: POINTER): NATURAL_32 is
 		-- gsl_multiset_k
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_multiset_memcpy (a_dest: POINTER; a_src: POINTER): INTEGER_32 is
 		-- gsl_multiset_memcpy
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_multiset_n (a_c: POINTER): NATURAL_32 is
 		-- gsl_multiset_n
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_multiset_next (a_c: POINTER): INTEGER_32 is
 		-- gsl_multiset_next
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_multiset_prev (a_c: POINTER): INTEGER_32 is
 		-- gsl_multiset_prev
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_multiset_valid (a_c: POINTER): INTEGER_32 is
 		-- gsl_multiset_valid
		external "plug_in"
		alias "{
			location: "."
