...
feature {} -- External calls
	...
	gsl_vector_float_add (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_vector_float_add_constant (an_a: POINTER; a_x: REAL_64): INTEGER_32 is
	...
	gsl_vector_float_alloc (a_n: NATURAL_32): POINTER is
	...
	gsl_vector_float_alloc_from_block (a_b: POINTER; an_offset: NATURAL_32; a_n: NATURAL_32; a_stride: NATURAL_32): POINTER is
	...
	gsl_vector_float_alloc_from_vector (a_v: POINTER; an_offset: NATURAL_32; a_n: NATURAL_32; a_stride: NATURAL_32): POINTER is
	...
	gsl_vector_float_calloc (a_n: NATURAL_32): POINTER is
	...
	gsl_vector_float_const_ptr (a_v: POINTER; an_i: NATURAL_32): POINTER is
	...
	gsl_vector_float_div (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_vector_float_equal (an_u: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_float_fprintf (a_stream: POINTER; a_v: POINTER; a_format: POINTER): INTEGER_32 is
	...
	gsl_vector_float_fread (a_stream: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_float_fscanf (a_stream: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_float_fwrite (a_stream: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_float_get (a_v: POINTER; an_i: NATURAL_32): REAL_32 is
	...
	gsl_vector_float_isneg (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_float_isnonneg (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_float_isnull (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_float_ispos (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_float_max_index (a_v: POINTER): NATURAL_32 is
	...
	gsl_vector_float_memcpy (a_dest: POINTER; a_src: POINTER): INTEGER_32 is
	...
	gsl_vector_float_min_index (a_v: POINTER): NATURAL_32 is
	...
	gsl_vector_float_mul (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_vector_float_ptr (a_v: POINTER; an_i: NATURAL_32): POINTER is
	...
	gsl_vector_float_reverse (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_float_scale (an_a: POINTER; a_x: REAL_64): INTEGER_32 is
	...
	gsl_vector_float_set (a_v: POINTER; an_i: NATURAL_32; a_x: REAL_32) is
	...
	gsl_vector_float_set_basis (a_v: POINTER; an_i: NATURAL_32): INTEGER_32 is
	...
	gsl_vector_float_sub (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_vector_float_swap (a_v: POINTER; a_w: POINTER): INTEGER_32 is
	...
	gsl_vector_float_swap_elements (a_v: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_32 is
