...
feature {} -- External calls
	...
	gsl_error (a_reason: POINTER; a_file: POINTER; a_line: INTEGER_32; a_gsl_errno: INTEGER_32) is
 		-- gsl_error
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_stream_printf (a_label: POINTER; a_file: POINTER; a_line: INTEGER_32; a_reason: POINTER) is
 		-- gsl_stream_printf
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_strerror (a_gsl_errno: INTEGER_32): POINTER is
 		-- gsl_strerror
		external "plug_in"
		alias "{
			location: "."
