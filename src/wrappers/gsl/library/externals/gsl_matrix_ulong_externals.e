...
feature {} -- External calls
	...
	gsl_matrix_ulong_add (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_matrix_ulong_add_constant (an_a: POINTER; a_x: REAL_64): INTEGER_32 is
	...
	gsl_matrix_ulong_add_diagonal (an_a: POINTER; a_x: REAL_64): INTEGER_32 is
	...
	gsl_matrix_ulong_alloc (a_n1: NATURAL_32; a_n2: NATURAL_32): POINTER is
	...
	gsl_matrix_ulong_alloc_from_block (a_b: POINTER; an_offset: NATURAL_32; a_n1: NATURAL_32; a_n2: NATURAL_32; a_d2: NATURAL_32): POINTER is
	...
	gsl_matrix_ulong_alloc_from_matrix (a_m: POINTER; a_k1: NATURAL_32; a_k2: NATURAL_32; a_n1: NATURAL_32; a_n2: NATURAL_32): POINTER is
	...
	gsl_matrix_ulong_calloc (a_n1: NATURAL_32; a_n2: NATURAL_32): POINTER is
	...
	gsl_matrix_ulong_const_ptr (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): POINTER is
	...
	gsl_matrix_ulong_div_elements (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_matrix_ulong_equal (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_matrix_ulong_fprintf (a_stream: POINTER; a_m: POINTER; a_format: POINTER): INTEGER_32 is
	...
	gsl_matrix_ulong_fread (a_stream: POINTER; a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_ulong_fscanf (a_stream: POINTER; a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_ulong_fwrite (a_stream: POINTER; a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_ulong_get (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): NATURAL_32 is
	...
	gsl_matrix_ulong_get_col (a_v: POINTER; a_m: POINTER; a_j: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_ulong_get_row (a_v: POINTER; a_m: POINTER; an_i: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_ulong_isneg (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_ulong_isnonneg (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_ulong_isnull (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_ulong_ispos (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_ulong_max (a_m: POINTER): NATURAL_32 is
	...
	gsl_matrix_ulong_memcpy (a_dest: POINTER; a_src: POINTER): INTEGER_32 is
	...
	gsl_matrix_ulong_min (a_m: POINTER): NATURAL_32 is
	...
	gsl_matrix_ulong_mul_elements (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_matrix_ulong_ptr (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): POINTER is
	...
	gsl_matrix_ulong_scale (an_a: POINTER; a_x: REAL_64): INTEGER_32 is
	...
	gsl_matrix_ulong_set (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32; a_x: NATURAL_32) is
	...
	gsl_matrix_ulong_set_all (a_m: POINTER; a_x: NATURAL_32) is
	...
	gsl_matrix_ulong_set_col (a_m: POINTER; a_j: NATURAL_32; a_v: POINTER): INTEGER_32 is
	...
	gsl_matrix_ulong_set_row (a_m: POINTER; an_i: NATURAL_32; a_v: POINTER): INTEGER_32 is
	...
	gsl_matrix_ulong_sub (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_matrix_ulong_swap (a_m1: POINTER; a_m2: POINTER): INTEGER_32 is
	...
	gsl_matrix_ulong_swap_columns (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_ulong_swap_rowcol (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_ulong_swap_rows (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_ulong_transpose (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_ulong_transpose_memcpy (a_dest: POINTER; a_src: POINTER): INTEGER_32 is
	...
	gsl_vector_ulong_alloc_col_from_matrix (a_m: POINTER; a_j: NATURAL_32): POINTER is
	...
	gsl_vector_ulong_alloc_row_from_matrix (a_m: POINTER; an_i: NATURAL_32): POINTER is
