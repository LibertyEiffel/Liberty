...
feature {} -- External calls
	...
	gsl_vector_int_add (an_a: POINTER; a_b: POINTER): INTEGER_32 is
 		-- gsl_vector_int_add
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_int_add_constant (an_a: POINTER; a_x: REAL_64): INTEGER_32 is
	...
	gsl_vector_int_alloc (a_n: NATURAL_32): POINTER is
	...
	gsl_vector_int_alloc_from_block (a_b: POINTER; an_offset: NATURAL_32; a_n: NATURAL_32; a_stride: NATURAL_32): POINTER is
	...
	gsl_vector_int_alloc_from_vector (a_v: POINTER; an_offset: NATURAL_32; a_n: NATURAL_32; a_stride: NATURAL_32): POINTER is
	...
	gsl_vector_int_calloc (a_n: NATURAL_32): POINTER is
	...
	gsl_vector_int_const_ptr (a_v: POINTER; an_i: NATURAL_32): POINTER is
	...
	gsl_vector_int_div (an_a: POINTER; a_b: POINTER): INTEGER_32 is
 		-- gsl_vector_int_div
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_int_equal (an_u: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_int_fprintf (a_stream: POINTER; a_v: POINTER; a_format: POINTER): INTEGER_32 is
	...
	gsl_vector_int_fread (a_stream: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_int_fscanf (a_stream: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_int_fwrite (a_stream: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_int_get (a_v: POINTER; an_i: NATURAL_32): INTEGER_32 is
 		-- gsl_vector_int_get
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_int_isneg (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_int_isnonneg (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_int_isnull (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_int_ispos (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_int_max (a_v: POINTER): INTEGER_32 is
 		-- gsl_vector_int_max
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_int_max_index (a_v: POINTER): NATURAL_32 is
	...
	gsl_vector_int_memcpy (a_dest: POINTER; a_src: POINTER): INTEGER_32 is
	...
	gsl_vector_int_min (a_v: POINTER): INTEGER_32 is
 		-- gsl_vector_int_min
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_int_min_index (a_v: POINTER): NATURAL_32 is
	...
	gsl_vector_int_mul (an_a: POINTER; a_b: POINTER): INTEGER_32 is
 		-- gsl_vector_int_mul
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_int_ptr (a_v: POINTER; an_i: NATURAL_32): POINTER is
 		-- gsl_vector_int_ptr
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_int_reverse (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_int_scale (an_a: POINTER; a_x: REAL_64): INTEGER_32 is
	...
	gsl_vector_int_set (a_v: POINTER; an_i: NATURAL_32; a_x: INTEGER_32) is
 		-- gsl_vector_int_set
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_int_set_all (a_v: POINTER; a_x: INTEGER_32) is
	...
	gsl_vector_int_set_basis (a_v: POINTER; an_i: NATURAL_32): INTEGER_32 is
	...
	gsl_vector_int_sub (an_a: POINTER; a_b: POINTER): INTEGER_32 is
 		-- gsl_vector_int_sub
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_int_swap (a_v: POINTER; a_w: POINTER): INTEGER_32 is
 		-- gsl_vector_int_swap
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_int_swap_elements (a_v: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_32 is
