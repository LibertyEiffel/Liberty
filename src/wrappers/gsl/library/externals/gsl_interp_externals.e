...
feature {} -- External calls
	...
	gsl_interp_accel_find (an_a: POINTER; a_x_array: POINTER; a_size: NATURAL_32; a_x: REAL_64): NATURAL_32 is
	...
	gsl_interp_accel_reset (an_a: POINTER): INTEGER_32 is
	...
	gsl_interp_alloc (a_t: POINTER; a_n: NATURAL_32): POINTER is
 		-- gsl_interp_alloc
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_interp_bsearch (a_x_array: POINTER; a_x: REAL_64; an_index_lo: NATURAL_32; an_index_hi: NATURAL_32): NATURAL_32 is
 		-- gsl_interp_bsearch
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_interp_eval (an_obj: POINTER; a_xa: POINTER; a_ya: POINTER; a_x: REAL_64; an_a: POINTER): REAL_64 is
 		-- gsl_interp_eval
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_interp_eval_deriv (an_obj: POINTER; a_xa: POINTER; a_ya: POINTER; a_x: REAL_64; an_a: POINTER): REAL_64 is
	...
	gsl_interp_eval_deriv2 (an_obj: POINTER; a_xa: POINTER; a_ya: POINTER; a_x: REAL_64; an_a: POINTER): REAL_64 is
	...
	gsl_interp_eval_deriv2_e (an_obj: POINTER; a_xa: POINTER; a_ya: POINTER; a_x: REAL_64; an_a: POINTER; a_d2: POINTER): INTEGER_32 is
	...
	gsl_interp_eval_deriv_e (an_obj: POINTER; a_xa: POINTER; a_ya: POINTER; a_x: REAL_64; an_a: POINTER; a_d: POINTER): INTEGER_32 is
	...
	gsl_interp_eval_e (an_obj: POINTER; a_xa: POINTER; a_ya: POINTER; a_x: REAL_64; an_a: POINTER; a_y: POINTER): INTEGER_32 is
 		-- gsl_interp_eval_e
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_interp_eval_integ (an_obj: POINTER; a_xa: POINTER; a_ya: POINTER; an_a: REAL_64; a_b: REAL_64; an_acc: POINTER): REAL_64 is
	...
	gsl_interp_eval_integ_e (an_obj: POINTER; a_xa: POINTER; a_ya: POINTER; an_a: REAL_64; a_b: REAL_64; an_acc: POINTER; a_result: POINTER): INTEGER_32 is
	...
	gsl_interp_init (an_obj: POINTER; a_xa: POINTER; a_ya: POINTER; a_size: NATURAL_32): INTEGER_32 is
 		-- gsl_interp_init
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_interp_min_size (an_interp: POINTER): NATURAL_32 is
 		-- gsl_interp_min_size
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_interp_type_min_size (a_t: POINTER): NATURAL_32 is
