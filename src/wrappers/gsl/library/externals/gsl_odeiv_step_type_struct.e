...
feature {} -- Low-level setters
	...
	gsl_odeiv_step_type_struct_set_can_use_dydt_in (a_structure: POINTER; a_value: INTEGER_32) is
	...
	gsl_odeiv_step_type_struct_set_gives_exact_dydt_out (a_structure: POINTER; a_value: INTEGER_32) is
...
feature {} -- Low-level queries
	...
	gsl_odeiv_step_type_struct_get_can_use_dydt_in (a_structure: POINTER): INTEGER_32 is
	...
	gsl_odeiv_step_type_struct_get_gives_exact_dydt_out (a_structure: POINTER): INTEGER_32 is
