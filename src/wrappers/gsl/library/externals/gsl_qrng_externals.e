...
feature {} -- External calls
	...
	gsl_qrng_alloc (a_t: POINTER; a_dimension: NATURAL_32): POINTER is
 		-- gsl_qrng_alloc
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_qrng_get (a_q: POINTER; a_x: POINTER): INTEGER_32 is
 		-- gsl_qrng_get
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_qrng_memcpy (a_dest: POINTER; a_src: POINTER): INTEGER_32 is
 		-- gsl_qrng_memcpy
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_qrng_size (a_q: POINTER): NATURAL_32 is
 		-- gsl_qrng_size
		external "plug_in"
		alias "{
			location: "."
