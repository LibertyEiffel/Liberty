...
feature {} -- External calls
	...
	gsl_matrix_short_add (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_matrix_short_add_constant (an_a: POINTER; a_x: REAL_64): INTEGER_32 is
	...
	gsl_matrix_short_add_diagonal (an_a: POINTER; a_x: REAL_64): INTEGER_32 is
	...
	gsl_matrix_short_alloc (a_n1: NATURAL_32; a_n2: NATURAL_32): POINTER is
	...
	gsl_matrix_short_alloc_from_block (a_b: POINTER; an_offset: NATURAL_32; a_n1: NATURAL_32; a_n2: NATURAL_32; a_d2: NATURAL_32): POINTER is
	...
	gsl_matrix_short_alloc_from_matrix (a_m: POINTER; a_k1: NATURAL_32; a_k2: NATURAL_32; a_n1: NATURAL_32; a_n2: NATURAL_32): POINTER is
	...
	gsl_matrix_short_calloc (a_n1: NATURAL_32; a_n2: NATURAL_32): POINTER is
	...
	gsl_matrix_short_const_ptr (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): POINTER is
	...
	gsl_matrix_short_div_elements (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_matrix_short_equal (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_matrix_short_fprintf (a_stream: POINTER; a_m: POINTER; a_format: POINTER): INTEGER_32 is
	...
	gsl_matrix_short_fread (a_stream: POINTER; a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_short_fscanf (a_stream: POINTER; a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_short_fwrite (a_stream: POINTER; a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_short_get (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_16 is
	...
	gsl_matrix_short_get_col (a_v: POINTER; a_m: POINTER; a_j: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_short_get_row (a_v: POINTER; a_m: POINTER; an_i: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_short_isneg (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_short_isnonneg (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_short_isnull (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_short_ispos (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_short_memcpy (a_dest: POINTER; a_src: POINTER): INTEGER_32 is
	...
	gsl_matrix_short_mul_elements (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_matrix_short_ptr (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): POINTER is
	...
	gsl_matrix_short_scale (an_a: POINTER; a_x: REAL_64): INTEGER_32 is
	...
	gsl_matrix_short_set (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32; a_x: INTEGER_16) is
	...
	gsl_matrix_short_set_col (a_m: POINTER; a_j: NATURAL_32; a_v: POINTER): INTEGER_32 is
	...
	gsl_matrix_short_set_row (a_m: POINTER; an_i: NATURAL_32; a_v: POINTER): INTEGER_32 is
	...
	gsl_matrix_short_sub (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_matrix_short_swap (a_m1: POINTER; a_m2: POINTER): INTEGER_32 is
	...
	gsl_matrix_short_swap_columns (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_short_swap_rowcol (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_short_swap_rows (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_short_transpose (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_short_transpose_memcpy (a_dest: POINTER; a_src: POINTER): INTEGER_32 is
	...
	gsl_vector_short_alloc_col_from_matrix (a_m: POINTER; a_j: NATURAL_32): POINTER is
	...
	gsl_vector_short_alloc_row_from_matrix (a_m: POINTER; an_i: NATURAL_32): POINTER is
