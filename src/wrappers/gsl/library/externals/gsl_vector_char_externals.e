...
feature {} -- External calls
	...
	gsl_vector_char_add (an_a: POINTER; a_b: POINTER): INTEGER_32 is
 		-- gsl_vector_char_add
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_char_add_constant (an_a: POINTER; a_x: REAL_64): INTEGER_32 is
	...
	gsl_vector_char_alloc (a_n: NATURAL_32): POINTER is
	...
	gsl_vector_char_alloc_from_block (a_b: POINTER; an_offset: NATURAL_32; a_n: NATURAL_32; a_stride: NATURAL_32): POINTER is
	...
	gsl_vector_char_alloc_from_vector (a_v: POINTER; an_offset: NATURAL_32; a_n: NATURAL_32; a_stride: NATURAL_32): POINTER is
	...
	gsl_vector_char_calloc (a_n: NATURAL_32): POINTER is
	...
	gsl_vector_char_const_ptr (a_v: POINTER; an_i: NATURAL_32): POINTER is
	...
	gsl_vector_char_div (an_a: POINTER; a_b: POINTER): INTEGER_32 is
 		-- gsl_vector_char_div
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_char_equal (an_u: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_char_fprintf (a_stream: POINTER; a_v: POINTER; a_format: POINTER): INTEGER_32 is
	...
	gsl_vector_char_fread (a_stream: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_char_fscanf (a_stream: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_char_fwrite (a_stream: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_char_get (a_v: POINTER; an_i: NATURAL_32): CHARACTER is
 		-- gsl_vector_char_get
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_char_isneg (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_char_isnonneg (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_char_isnull (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_char_ispos (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_char_max_index (a_v: POINTER): NATURAL_32 is
	...
	gsl_vector_char_memcpy (a_dest: POINTER; a_src: POINTER): INTEGER_32 is
	...
	gsl_vector_char_min_index (a_v: POINTER): NATURAL_32 is
	...
	gsl_vector_char_mul (an_a: POINTER; a_b: POINTER): INTEGER_32 is
 		-- gsl_vector_char_mul
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_char_ptr (a_v: POINTER; an_i: NATURAL_32): POINTER is
 		-- gsl_vector_char_ptr
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_char_reverse (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_char_scale (an_a: POINTER; a_x: REAL_64): INTEGER_32 is
	...
	gsl_vector_char_set (a_v: POINTER; an_i: NATURAL_32; a_x: CHARACTER) is
 		-- gsl_vector_char_set
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_char_set_basis (a_v: POINTER; an_i: NATURAL_32): INTEGER_32 is
	...
	gsl_vector_char_sub (an_a: POINTER; a_b: POINTER): INTEGER_32 is
 		-- gsl_vector_char_sub
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_vector_char_swap (a_v: POINTER; a_w: POINTER): INTEGER_32 is
	...
	gsl_vector_char_swap_elements (a_v: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_32 is
