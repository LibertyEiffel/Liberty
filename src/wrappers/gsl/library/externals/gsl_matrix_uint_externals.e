...
feature {} -- External calls
	...
	gsl_matrix_uint_add (an_a: POINTER; a_b: POINTER): INTEGER_32 is
 		-- gsl_matrix_uint_add
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_matrix_uint_add_constant (an_a: POINTER; a_x: REAL_64): INTEGER_32 is
	...
	gsl_matrix_uint_add_diagonal (an_a: POINTER; a_x: REAL_64): INTEGER_32 is
	...
	gsl_matrix_uint_alloc (a_n1: NATURAL_32; a_n2: NATURAL_32): POINTER is
	...
	gsl_matrix_uint_alloc_from_block (a_b: POINTER; an_offset: NATURAL_32; a_n1: NATURAL_32; a_n2: NATURAL_32; a_d2: NATURAL_32): POINTER is
	...
	gsl_matrix_uint_alloc_from_matrix (a_m: POINTER; a_k1: NATURAL_32; a_k2: NATURAL_32; a_n1: NATURAL_32; a_n2: NATURAL_32): POINTER is
	...
	gsl_matrix_uint_calloc (a_n1: NATURAL_32; a_n2: NATURAL_32): POINTER is
	...
	gsl_matrix_uint_const_ptr (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): POINTER is
	...
	gsl_matrix_uint_div_elements (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_matrix_uint_equal (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_matrix_uint_fprintf (a_stream: POINTER; a_m: POINTER; a_format: POINTER): INTEGER_32 is
	...
	gsl_matrix_uint_fread (a_stream: POINTER; a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_uint_fscanf (a_stream: POINTER; a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_uint_fwrite (a_stream: POINTER; a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_uint_get (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): NATURAL_32 is
 		-- gsl_matrix_uint_get
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_matrix_uint_get_col (a_v: POINTER; a_m: POINTER; a_j: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_uint_get_row (a_v: POINTER; a_m: POINTER; an_i: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_uint_isneg (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_uint_isnonneg (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_uint_isnull (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_uint_ispos (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_uint_max (a_m: POINTER): NATURAL_32 is
 		-- gsl_matrix_uint_max
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_matrix_uint_memcpy (a_dest: POINTER; a_src: POINTER): INTEGER_32 is
	...
	gsl_matrix_uint_min (a_m: POINTER): NATURAL_32 is
 		-- gsl_matrix_uint_min
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_matrix_uint_mul_elements (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_matrix_uint_ptr (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): POINTER is
 		-- gsl_matrix_uint_ptr
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_matrix_uint_scale (an_a: POINTER; a_x: REAL_64): INTEGER_32 is
	...
	gsl_matrix_uint_set (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32; a_x: NATURAL_32) is
 		-- gsl_matrix_uint_set
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_matrix_uint_set_all (a_m: POINTER; a_x: NATURAL_32) is
	...
	gsl_matrix_uint_set_col (a_m: POINTER; a_j: NATURAL_32; a_v: POINTER): INTEGER_32 is
	...
	gsl_matrix_uint_set_row (a_m: POINTER; an_i: NATURAL_32; a_v: POINTER): INTEGER_32 is
	...
	gsl_matrix_uint_sub (an_a: POINTER; a_b: POINTER): INTEGER_32 is
 		-- gsl_matrix_uint_sub
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_matrix_uint_swap (a_m1: POINTER; a_m2: POINTER): INTEGER_32 is
	...
	gsl_matrix_uint_swap_columns (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_uint_swap_rowcol (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_uint_swap_rows (a_m: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_32 is
	...
	gsl_matrix_uint_transpose (a_m: POINTER): INTEGER_32 is
	...
	gsl_matrix_uint_transpose_memcpy (a_dest: POINTER; a_src: POINTER): INTEGER_32 is
	...
	gsl_vector_uint_alloc_col_from_matrix (a_m: POINTER; a_j: NATURAL_32): POINTER is
	...
	gsl_vector_uint_alloc_row_from_matrix (a_m: POINTER; an_i: NATURAL_32): POINTER is
