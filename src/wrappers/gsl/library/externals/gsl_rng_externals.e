...
feature {} -- External calls
	...
	gsl_rng_default_seed: NATURAL_32 is
	...
	set_gsl_rng_default_seed (a_value: NATURAL_32) is
	...
	gsl_rng_fread (a_stream: POINTER; a_r: POINTER): INTEGER_32 is
 		-- gsl_rng_fread
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_rng_fwrite (a_stream: POINTER; a_r: POINTER): INTEGER_32 is
 		-- gsl_rng_fwrite
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_rng_get (a_r: POINTER): NATURAL_32 is
 		-- gsl_rng_get
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_rng_max (a_r: POINTER): NATURAL_32 is
 		-- gsl_rng_max
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_rng_memcpy (a_dest: POINTER; a_src: POINTER): INTEGER_32 is
 		-- gsl_rng_memcpy
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_rng_min (a_r: POINTER): NATURAL_32 is
 		-- gsl_rng_min
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_rng_set (a_r: POINTER; a_seed: NATURAL_32) is
 		-- gsl_rng_set
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_rng_size (a_r: POINTER): NATURAL_32 is
 		-- gsl_rng_size
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_rng_uniform (a_r: POINTER): REAL_64 is
 		-- gsl_rng_uniform
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_rng_uniform_int (a_r: POINTER; a_n: NATURAL_32): NATURAL_32 is
 		-- gsl_rng_uniform_int
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_rng_uniform_pos (a_r: POINTER): REAL_64 is
 		-- gsl_rng_uniform_pos
		external "plug_in"
		alias "{
			location: "."
