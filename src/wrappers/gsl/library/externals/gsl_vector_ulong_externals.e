...
feature {} -- External calls
	...
	gsl_vector_ulong_add (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_vector_ulong_add_constant (an_a: POINTER; a_x: REAL_64): INTEGER_32 is
	...
	gsl_vector_ulong_alloc (a_n: NATURAL_32): POINTER is
	...
	gsl_vector_ulong_alloc_from_block (a_b: POINTER; an_offset: NATURAL_32; a_n: NATURAL_32; a_stride: NATURAL_32): POINTER is
	...
	gsl_vector_ulong_alloc_from_vector (a_v: POINTER; an_offset: NATURAL_32; a_n: NATURAL_32; a_stride: NATURAL_32): POINTER is
	...
	gsl_vector_ulong_calloc (a_n: NATURAL_32): POINTER is
	...
	gsl_vector_ulong_const_ptr (a_v: POINTER; an_i: NATURAL_32): POINTER is
	...
	gsl_vector_ulong_div (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_vector_ulong_equal (an_u: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_ulong_fprintf (a_stream: POINTER; a_v: POINTER; a_format: POINTER): INTEGER_32 is
	...
	gsl_vector_ulong_fread (a_stream: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_ulong_fscanf (a_stream: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_ulong_fwrite (a_stream: POINTER; a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_ulong_get (a_v: POINTER; an_i: NATURAL_32): NATURAL_32 is
	...
	gsl_vector_ulong_isneg (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_ulong_isnonneg (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_ulong_isnull (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_ulong_ispos (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_ulong_max (a_v: POINTER): NATURAL_32 is
	...
	gsl_vector_ulong_max_index (a_v: POINTER): NATURAL_32 is
	...
	gsl_vector_ulong_memcpy (a_dest: POINTER; a_src: POINTER): INTEGER_32 is
	...
	gsl_vector_ulong_min (a_v: POINTER): NATURAL_32 is
	...
	gsl_vector_ulong_min_index (a_v: POINTER): NATURAL_32 is
	...
	gsl_vector_ulong_mul (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_vector_ulong_ptr (a_v: POINTER; an_i: NATURAL_32): POINTER is
	...
	gsl_vector_ulong_reverse (a_v: POINTER): INTEGER_32 is
	...
	gsl_vector_ulong_scale (an_a: POINTER; a_x: REAL_64): INTEGER_32 is
	...
	gsl_vector_ulong_set (a_v: POINTER; an_i: NATURAL_32; a_x: NATURAL_32) is
	...
	gsl_vector_ulong_set_all (a_v: POINTER; a_x: NATURAL_32) is
	...
	gsl_vector_ulong_set_basis (a_v: POINTER; an_i: NATURAL_32): INTEGER_32 is
	...
	gsl_vector_ulong_sub (an_a: POINTER; a_b: POINTER): INTEGER_32 is
	...
	gsl_vector_ulong_swap (a_v: POINTER; a_w: POINTER): INTEGER_32 is
	...
	gsl_vector_ulong_swap_elements (a_v: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): INTEGER_32 is
