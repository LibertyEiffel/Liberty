...
feature {} -- External calls
	...
	gsl_root_fdfsolver_iterate (a_s: POINTER): INTEGER_32 is
	...
	gsl_root_fdfsolver_root (a_s: POINTER): REAL_64 is
	...
	gsl_root_fdfsolver_set (a_s: POINTER; a_fdf: POINTER; a_root: REAL_64): INTEGER_32 is
	...
	gsl_root_fsolver_iterate (a_s: POINTER): INTEGER_32 is
	...
	gsl_root_fsolver_root (a_s: POINTER): REAL_64 is
	...
	gsl_root_fsolver_set (a_s: POINTER; a_f: POINTER; a_x_lower: REAL_64; a_x_upper: REAL_64): INTEGER_32 is
	...
	gsl_root_fsolver_x_lower (a_s: POINTER): REAL_64 is
	...
	gsl_root_fsolver_x_upper (a_s: POINTER): REAL_64 is
	...
	gsl_root_test_delta (a_x1: REAL_64; a_x0: REAL_64; an_epsabs: REAL_64; an_epsrel: REAL_64): INTEGER_32 is
 		-- gsl_root_test_delta
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_root_test_interval (a_x_lower: REAL_64; a_x_upper: REAL_64; an_epsabs: REAL_64; an_epsrel: REAL_64): INTEGER_32 is
	...
	gsl_root_test_residual (a_f: REAL_64; an_epsabs: REAL_64): INTEGER_32 is
