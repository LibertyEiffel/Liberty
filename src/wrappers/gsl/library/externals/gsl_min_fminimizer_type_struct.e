...
feature {} -- Low-level setters
	...
	gsl_min_fminimizer_type_struct_set_size (a_structure: POINTER; a_value: like size_t) is
...
feature {} -- Low-level queries
	...
	gsl_min_fminimizer_type_struct_get_size (a_structure: POINTER): like size_t is
