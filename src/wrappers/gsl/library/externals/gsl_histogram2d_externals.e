...
feature {} -- External calls
	...
	gsl_histogram2d_accumulate (a_h: POINTER; a_x: REAL_64; a_y: REAL_64; a_weight: REAL_64): INTEGER_32 is
	...
	gsl_histogram2d_add (a_h1: POINTER; a_h2: POINTER): INTEGER_32 is
 		-- gsl_histogram2d_add
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_histogram2d_alloc (a_nx: NATURAL_32; a_ny: NATURAL_32): POINTER is
	...
	gsl_histogram2d_calloc (a_nx: NATURAL_32; a_ny: NATURAL_32): POINTER is
	...
	gsl_histogram2d_calloc_range (a_nx: NATURAL_32; a_ny: NATURAL_32; a_xrange: POINTER; a_yrange: POINTER): POINTER is
	...
	gsl_histogram2d_calloc_uniform (a_nx: NATURAL_32; a_ny: NATURAL_32; a_xmin: REAL_64; a_xmax: REAL_64; a_ymin: REAL_64; a_ymax: REAL_64): POINTER is
	...
	gsl_histogram2d_cov (a_h: POINTER): REAL_64 is
 		-- gsl_histogram2d_cov
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_histogram2d_div (a_h1: POINTER; a_h2: POINTER): INTEGER_32 is
 		-- gsl_histogram2d_div
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_histogram2d_equal_bins_p (a_h1: POINTER; a_h2: POINTER): INTEGER_32 is
	...
	gsl_histogram2d_find (a_h: POINTER; a_x: REAL_64; a_y: REAL_64; an_i: POINTER; a_j: POINTER): INTEGER_32 is
	...
	gsl_histogram2d_fprintf (a_stream: POINTER; a_h: POINTER; a_range_format: POINTER; a_bin_format: POINTER): INTEGER_32 is
	...
	gsl_histogram2d_fread (a_stream: POINTER; a_h: POINTER): INTEGER_32 is
	...
	gsl_histogram2d_fscanf (a_stream: POINTER; a_h: POINTER): INTEGER_32 is
	...
	gsl_histogram2d_fwrite (a_stream: POINTER; a_h: POINTER): INTEGER_32 is
	...
	gsl_histogram2d_get (a_h: POINTER; an_i: NATURAL_32; a_j: NATURAL_32): REAL_64 is
 		-- gsl_histogram2d_get
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_histogram2d_get_xrange (a_h: POINTER; an_i: NATURAL_32; a_xlower: POINTER; a_xupper: POINTER): INTEGER_32 is
	...
	gsl_histogram2d_get_yrange (a_h: POINTER; a_j: NATURAL_32; a_ylower: POINTER; a_yupper: POINTER): INTEGER_32 is
	...
	gsl_histogram2d_increment (a_h: POINTER; a_x: REAL_64; a_y: REAL_64): INTEGER_32 is
	...
	gsl_histogram2d_max_val (a_h: POINTER): REAL_64 is
	...
	gsl_histogram2d_memcpy (a_dest: POINTER; a_source: POINTER): INTEGER_32 is
	...
	gsl_histogram2d_min_val (a_h: POINTER): REAL_64 is
	...
	gsl_histogram2d_mul (a_h1: POINTER; a_h2: POINTER): INTEGER_32 is
 		-- gsl_histogram2d_mul
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_histogram2d_nx (a_h: POINTER): NATURAL_32 is
 		-- gsl_histogram2d_nx
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_histogram2d_ny (a_h: POINTER): NATURAL_32 is
 		-- gsl_histogram2d_ny
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_histogram2d_pdf_alloc (a_nx: NATURAL_32; a_ny: NATURAL_32): POINTER is
	...
	gsl_histogram2d_pdf_init (a_p: POINTER; a_h: POINTER): INTEGER_32 is
	...
	gsl_histogram2d_pdf_sample (a_p: POINTER; a_r1: REAL_64; a_r2: REAL_64; a_x: POINTER; a_y: POINTER): INTEGER_32 is
	...
	gsl_histogram2d_scale (a_h: POINTER; a_scale: REAL_64): INTEGER_32 is
	...
	gsl_histogram2d_set_ranges (a_h: POINTER; a_xrange: POINTER; a_xsize: NATURAL_32; a_yrange: POINTER; a_ysize: NATURAL_32): INTEGER_32 is
	...
	gsl_histogram2d_set_ranges_uniform (a_h: POINTER; a_xmin: REAL_64; a_xmax: REAL_64; a_ymin: REAL_64; a_ymax: REAL_64): INTEGER_32 is
	...
	gsl_histogram2d_shift (a_h: POINTER; a_shift: REAL_64): INTEGER_32 is
	...
	gsl_histogram2d_sub (a_h1: POINTER; a_h2: POINTER): INTEGER_32 is
 		-- gsl_histogram2d_sub
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_histogram2d_sum (a_h: POINTER): REAL_64 is
 		-- gsl_histogram2d_sum
		external "plug_in"
		alias "{
			location: "."
	...
	gsl_histogram2d_xmax (a_h: POINTER): REAL_64 is
	...
	gsl_histogram2d_xmean (a_h: POINTER): REAL_64 is
	...
	gsl_histogram2d_xmin (a_h: POINTER): REAL_64 is
	...
	gsl_histogram2d_xsigma (a_h: POINTER): REAL_64 is
	...
	gsl_histogram2d_ymax (a_h: POINTER): REAL_64 is
	...
	gsl_histogram2d_ymean (a_h: POINTER): REAL_64 is
	...
	gsl_histogram2d_ymin (a_h: POINTER): REAL_64 is
	...
	gsl_histogram2d_ysigma (a_h: POINTER): REAL_64 is
