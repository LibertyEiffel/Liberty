...
feature -- Validity
	is_valid_value (a_value: INTEGER): BOOLEAN is
		do
			Result := ((a_value = zext_attribute_low_level)  or else
				...
				(a_value = alignment_low_level)  or else
				...
				(a_value = stack_alignment_low_level) )
		end
