...
feature {ANY} -- Queries
	...
	is_basic_block_val: BOOLEAN is
		do
			Result := (value=basic_block_val_low_level)
		end

	is_block_address_val: BOOLEAN is
		do
	...
	is_fixed_stack_pseudo_source_value_val: BOOLEAN is
		do
