...
feature {ANY} -- Queries
	...
	is_global_constant: BOOLEAN
		do
			Result:=llvmis_global_constant(handle).to_boolean
		end

feature {ANY} -- Commands
	set_initializer (a_constant_value: LLVM_VALUE)
