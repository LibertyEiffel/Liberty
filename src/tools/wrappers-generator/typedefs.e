...
feature {ANY} 
	file: OUTPUT_STREAM 
	-- The file the typedefs will be outputted upon
	...
	emit_variable_sized_typedefs is 
	...
	emit_standard_typedefs is
		do
			...
			%	-- All those queries are empty by design, meant to be used as anchored declarations%N%N%
 			...
 			%	int8_t: INTEGER_#(1) is do end%N%
 			%	uint8_t: NATURAL_#(2) is do end%N%
 			%	int16_t: INTEGER_#(3) is do end%N%
 			%	uint16_t: NATURAL_#(4) is do end%N%
 			%	int32_t: INTEGER_#(5) is do end%N%
 			%	uint32_t: NATURAL_#(6) is do end%N%
 			%	int64_t: INTEGER_#(7) is do end%N%
 			%	uint64_t: NATURAL_#(8) is do end%N%
 			%%N"
			# & int8_t_size # & uint8_t_size
			# & int16_t_size # & uint16_t_size
			# & int32_t_size # & uint32_t_size
			# & int64_t_size # & uint64_t_size)
			...
			file.put_string("	-- Integer types capable of holding object pointers%N%
 			...
 			%	intptr_t: INTEGER_#(1) is do end%N%
 			%	uintptr_t: NATURAL_#(2) is do end%N%
			...
			file.put_string("	-- Minimum-width integer types%N%
 			...
 			%	int_least8_t: INTEGER_#(1) is do end%N%
 			%	uint_least8_t: NATURAL_#(2) is do end%N%
 			%	int_least16_t: INTEGER_#(3) is do end%N%
 			%	uint_least16_t: NATURAL_#(4) is do end%N%
 			%	int_least32_t: INTEGER_#(5) is do end%N%
 			%	uint_least32_t: NATURAL_#(6) is do end%N%
 			%	int_least64_t: INTEGER_#(7) is do end%N%
 			%	uint_least64_t: NATURAL_#(8) is do end%N%
 			%%N"
			# & int_least8_t_size # & uint_least8_t_size
 			# & int_least16_t_size # & uint_least16_t_size
 			# & int_least32_t_size # & uint_least32_t_size
 			# & int_least64_t_size # & uint_least64_t_size) 
			file.put_string("	-- Fastest minimum-width integer types%N%
 			...
 			%	int_fast8_t: INTEGER_#(1) is do end%N%
 			%	uint_fast8_t: NATURAL_#(2) is do end%N%
 			%	int_fast16_t: INTEGER_#(3) is do end%N%
 			%	uint_fast16_t: NATURAL_#(4) is do end%N%
 			%	int_fast32_t: INTEGER_#(5) is do end%N%
 			%	uint_fast32_t: NATURAL_#(6) is do end%N%
 			%	int_fast64_t: INTEGER_#(7) is do end%N%
 			%	uint_fast64_t: NATURAL_#(8) is do end%N%
 			%%N"
			# & int_fast8_t_size # & uint_fast8_t_size
 			# & int_fast16_t_size # & uint_fast16_t_size
 			# & int_fast32_t_size # & uint_fast32_t_size
 			# & int_fast64_t_size # & uint_fast64_t_size )
			file.put_string("	-- Greatest-width integer types%N%
 			...
 			%	intmax_t: INTEGER_#(1) is do end%N%
 			%	uintmax_t: NATURAL_#(2) is do end%N%
			%%N" # & intmax_t_size # & uintmax_t_size)
		end

feature {} -- Actual size queries
	long_int_size: INTEGER is
		external "C inline"
		alias "(8 * sizeof(long int))"
		end

	long_unsigned_int_size: INTEGER is
		external "C inline"
		alias "(8 * sizeof(long unsigned int))"
		end

	size_t_size: INTEGER is 
		external "C inline use <stddef.h>"
		alias "(8 * sizeof(size_t))"
		end

	ssize_t_size: INTEGER is 
		external "C inline use <stddef.h>"
		alias "(8 * sizeof(ssize_t))"
		end

	ptrdiff_t_size: INTEGER is 
		external "C inline use <stddef.h>"
		alias "(8 * sizeof(ptrdiff_t))"
		end

	int8_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(int8_t))"
		end

	uint8_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(uint8_t))"
		end

	int16_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(int16_t))"
		end

	uint16_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(uint16_t))"
		end

	int32_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(int32_t))"
		end

	uint32_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(uint32_t))"
		end

	int64_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(int64_t))"
		end

	uint64_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(uint64_t))"
		end

	intptr_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(intptr_t))"
		end

	uintptr_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(uintptr_t))"
		end

	int_least8_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(int_least8_t))"
		end

	uint_least8_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(uint_least8_t))"
		end

	int_least16_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(int_least16_t))"
		end

	uint_least16_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(uint_least16_t))"
		end

	int_least32_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(int_least32_t))"
		end

	uint_least32_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(uint_least32_t))"
		end

	int_least64_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(int_least64_t))"
		end

	uint_least64_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(uint_least64_t))"
		end

	int_fast8_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(int_fast8_t))"
		end

	uint_fast8_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(uint_fast8_t))"
		end

	int_fast16_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(int_fast16_t))"
		end

	uint_fast16_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(uint_fast16_t))"
		end

	int_fast32_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(int_fast32_t))"
		end

	uint_fast32_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(uint_fast32_t))"
		end

	int_fast64_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(int_fast64_t))"
		end

	uint_fast64_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(uint_fast64_t))"
		end

	intmax_t_size: INTEGER is 
		external "C inline use <stdint.h>"
		alias "(8 * sizeof(intmax_t))"
		end

	uintmax_t_size: INTEGER is 
		external "C inline use <stdint.h>"
