...
--
class LIBERTY_ACTUAL_TYPE_IMPL
...
feature {LIBERTY_TYPE_BUILDER_TOOLS}
	...
	add_parent (a_parent: LIBERTY_ACTUAL_TYPE_IMPL; conformant: BOOLEAN) is
		do
			torch.burn
			if conformant then
				if conformant_parents = no_parents then
					create {FAST_ARRAY[LIBERTY_ACTUAL_TYPE_IMPL]} conformant_parents.with_capacity(2)
				end
				...
				if non_conformant_parents = no_parents then
					create {FAST_ARRAY[LIBERTY_ACTUAL_TYPE_IMPL]} non_conformant_parents.with_capacity(2)
				end
...
feature {LIBERTY_TYPE_BUILDER}
	conformant_parents: COLLECTION[LIBERTY_ACTUAL_TYPE_IMPL]
	non_conformant_parents: COLLECTION[LIBERTY_ACTUAL_TYPE_IMPL]
...
feature {}
	...
	visit: PROCEDURE[TUPLE[LIBERTY_TYPE_VISITOR, LIBERTY_ACTUAL_TYPE_IMPL]]

	no_parents: COLLECTION[LIBERTY_ACTUAL_TYPE_IMPL] is
		once
			create {FAST_ARRAY[LIBERTY_ACTUAL_TYPE_IMPL]} Result.with_capacity(0)
		end
...
end -- class LIBERTY_ACTUAL_TYPE_IMPL
