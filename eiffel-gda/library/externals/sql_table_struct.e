...
feature {} -- Low-level setters
	...
	low_level_set_join_type (a_structure: POINTER; a_value: INTEGER_32) is
		external "C struct sql_table set join_type use <libgda/libgda.h>"
		end

	low_level_set_join_cond (a_structure: POINTER; a_value: POINTER) is
...
feature {} -- Low-level queries
	...
	get_join_type (a_structure: POINTER): INTEGER_32 is
		external "C struct sql_table get join_type use <libgda/libgda.h>"
		end

	get_join_cond (a_structure: POINTER): POINTER is
