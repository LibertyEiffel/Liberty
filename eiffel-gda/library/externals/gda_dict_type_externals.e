...
feature {} -- External calls
	...
	gda_dict_type_set_g_type (a_dict_type: POINTER; a_type: INTEGER) is
			-- void gda_dict_type_set_g_type (GdaDictType *dt, GType
			-- gda_type);
		external "C use <libgda/libgda.h>"
		end

	gda_dict_type_get_g_type (a_dict_type: POINTER): INTEGER is
