...
feature {} -- Low-level setters
	low_level_set_op (a_structure: POINTER; a_value: POINTER) is
		external "C struct GdaBlob set op use <libgda/libgda.h>"
		end
...
feature {} -- Low-level queries
	...
	get_op (a_structure: POINTER): POINTER is
		external "C struct GdaBlob get op use <libgda/libgda.h>"
		end
