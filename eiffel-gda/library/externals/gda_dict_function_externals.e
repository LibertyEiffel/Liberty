...
feature {} -- External calls
	...
	gda_dict_function_set_arg_dict_types (a_function, some_arg_types: POINTER) is
			-- void gda_dict_function_set_arg_dict_types (GdaDictFunction
			-- *func, const GSList *arg_types);
		external "C use <libgda/libgda.h>"
		end

	gda_dict_function_get_arg_dict_types (a_function: POINTER): POINTER is
	...
	gda_dict_function_accepts_arg_dict_types (a_function, some_arg_types: POINTER): INTEGER is
			-- gboolean gda_dict_function_accepts_arg_dict_types (GdaDictFunction
			-- *func, const GSList *arg_types);
		external "C use <libgda/libgda.h>"
		end

	gda_dict_function_set_ret_dict_type (a_func, a_dt: POINTER) is
