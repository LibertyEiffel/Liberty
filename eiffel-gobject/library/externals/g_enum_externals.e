...
feature {} -- External calls
	...
	g_enum_class_type_name (class) is
		external "C macro use <glib-object.h>"
		alias "G_ENUM_CLASS_TYPE_NAME"
		end

	g_type_is_enum (type) is
		external "C macro use <glib-object.h>"
		alias "G_TYPE_IS_ENUM"
		end

	g_enum_class (class) is
		external "C macro use <glib-object.h>"
		alias "G_ENUM_CLASS"
		end

	g_is_enum_class (class) is
		external "C macro use <glib-object.h>"
	...
	g_enum_get_value_by_name (an_enum_class: POINTER, a_const_name: POINTER)  is -- GEnumValue*
		external "C macro use <glib-object.h>"
		end
	
	g_enum_get_value_by_nick (an_enum_class: POINTER, a_const_nick: POINTER)  is -- GEnumValue*
		external "C macro use <glib-object.h>"
		end
