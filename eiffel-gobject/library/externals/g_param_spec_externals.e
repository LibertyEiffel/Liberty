...
feature
	...
	g_param_value_convert (spec,src,dest: POINTER; strict_validation: INTEGER) is
		external "C"
		end

	g_param_values_cmp (spec,value1,value2: POINTER) is
		external "C"
		end
...
-- quark : 	a GQuark, naming the user data pointer
	...
	g_param_spec_internal (gtype: INTEGER; name,nick,blurb: POINTER; flags: INTEGER): POINTER is
		external "C"
		end
...
feature {NONE} -- character parameter specification
	...
	g_param_spec_char (name, nick, blurb: POINTER;
							 min_c,max_c,default_char,flags: INTEGER_8): POINTER is
		external "C"
		end
...
feature {NONE} -- integer parameter specification
	...
	g_param_spec_int (name,nick,blurb: POINTER;
							min_i, max_i, def_i, flags: INTEGER) is
		external "C"
		end
...
feature {NONE} -- integer parameter specification
	...
	g_param_spec_long (name, nick, blurb: POINTER;
